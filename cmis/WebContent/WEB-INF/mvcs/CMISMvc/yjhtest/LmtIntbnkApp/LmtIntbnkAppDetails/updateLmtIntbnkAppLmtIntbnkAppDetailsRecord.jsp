...
<body class="page_content">
	<emp:form id="submitForm" action="updateLmtIntbnkAppLmtIntbnkAppDetailsRecord.do" method="POST">
		<emp:gridLayout id="LmtIntbnkAppDetailsGroup" title="同业授信申请明细" maxColumn="2">
			...
			<emp:text id="LmtIntbnkAppDetails.crd_item_id" label="授信明细" maxlength="30" required="true" readonly="true" />
		...
		<div align="center">
			<br>
			<emp:button id="submit" label="淇敼" op="update_LmtIntbnkAppDetails"/>
