...
<script type="text/javascript">
	...
	function onChange(){
		...
		var froze_amt_hq  = LmtAppFrozeUnfroze.froze_amt_hq._getValue();/*已冻结金额*/
...
<body class="page_content" onload="onLoad()">
	...
	<emp:form id="submitForm" action="addLmtAppFrozeUnfrozeRecord.do" method="POST">
		...
		<emp:gridLayout id="LmtAppFrozeUnfrozeGroup" title="登记信息" maxColumn="2">
			...
			<emp:text id="LmtAppFrozeUnfroze.input_id" label="登记人" maxlength="20"    readonly="true" hidden="true"/>
			<emp:text id="LmtAppFrozeUnfroze.input_br_id" label="登记机构" maxlength="20"    readonly="true" hidden="true"/>
