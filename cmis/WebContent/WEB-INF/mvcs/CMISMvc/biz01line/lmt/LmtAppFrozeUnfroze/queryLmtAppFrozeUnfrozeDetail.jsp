...
<% 
	...
	String viewflag = "";
	if(context.containsKey("viewflag")){
		viewflag = (String)context.getDataValue("viewflag");
	}
%>
<emp:page>
<html>
...
<script type="text/javascript">
	...
	function doReturn() {
		...
		if(viewflag == 'yes'){
			var url = '<emp:url action="queryLmtAppFrozeUnfrozeDetailList.do"/>&limit_code='+LmtAppFrozeUnfroze.limit_code._getValue();
		}else{
...
<body class="page_content" onload="onLoad()">
	...
	<emp:gridLayout id="LmtAppFrozeUnfrozeGroup" title="冻结申请信息" maxColumn="2">
			...
			<emp:text id="LmtAppFrozeUnfroze.froze_unfroze_amt" label="冻结金额" maxlength="16" required="true" onblur="onChange()" dataType="Currency" readonly="true" cssElementClass="emp_currency_text_readonly"/>
