...
<form  method="POST" action="#" id="queryForm">
	...
	<emp:gridLayout id="CtrLoanContGroup" title="输入合同查询条件" maxColumn="3">
...
<b>合同信息列表</b>
	...
	<emp:table icollName="LmtUseContList" pageMode="false" url="pageSearchLmtUseInfoDetails.do" reqParams="agr_no=${context.agr_no}&biz_area_no=${context.biz_area_no}&limit_code=${context.limit_code}">
