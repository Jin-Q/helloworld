...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importLmtIntbankAcc.do'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：需以系统内提供的同业授信客户额度导入模板为模板，导入同业授信客户额度信息。）</td>
		</tr>
	 	</table>
	</form>	
</body>
