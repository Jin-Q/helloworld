...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateLmtIntbankDetailRecord.do" method="POST">
		<emp:gridLayout id="LmtIntbankDetailGroup" maxColumn="2" title="同业客户授信明细">
			<emp:text id="LmtIntbankDetail.cus_id" label="客户码" maxlength="32" required="true" readonly="true" />
