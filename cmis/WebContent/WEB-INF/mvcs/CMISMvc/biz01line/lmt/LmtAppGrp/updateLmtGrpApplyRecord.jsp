...
<script type="text/javascript">
	...
	function onLoad(){
		...
		var app_status = LmtAppGrp.approve_status._getValue();
		if(app_status!='000'){
			LmtAppGrp.manager_id_displayname._obj._renderReadonly(true);
			LmtAppGrp.manager_br_id_displayname._obj._renderReadonly(true);
		}
	}
	...
	function doSubmitLmtGrpApp(){
		var handleSuccess = function(o) {
			...
			if (o.responseText !== undefined) {
				...
				if("Y"==message){
					alert("保存成功！");
					document.getElementById("button_submitLmtGrpApp").disabled = "";
				}
			}
		};
		var handleFailure = function(o) {
		...
		if(result){
			...
			document.getElementById("button_submitLmtGrpApp").disabled = "true";
...
<body class="page_content" onload="onLoad()">
	<emp:tabGroup mainTab="main_tabs" id="main_tab">
		<emp:tab label="集团授信基本信息" id="main_tabs" needFlush="true" initial="true">
			<emp:form id="submitForm" action="updateLmtGrpApplyRecord.do" method="POST">
				<emp:gridLayout id="LmtAppGrpGroup" maxColumn="2" title="集团授信申请">
					<emp:text id="LmtAppGrp.serno" label="业务编号" maxlength="40" required="true" readonly="true" colSpan="2"/>
				...
				<div align="center">
					<br>
					<emp:button id="submitLmtGrpApp" label="修改" op="update"/>
