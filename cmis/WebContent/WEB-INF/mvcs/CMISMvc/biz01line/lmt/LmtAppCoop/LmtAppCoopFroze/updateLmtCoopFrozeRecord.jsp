...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryLmtCoopFrozenList.do"/>?type=app';
		url = EMPTools.encodeURI(url);
		window.location=url;
	};
	/*--user code end--*/
...
<body class="page_content" onload="onLoad()">
	<emp:tabGroup mainTab="main_tabs" id="main_tab">
		<emp:tab label="合作方额度冻结解冻申请" id="main_tabs" needFlush="true" initial="true">
			<emp:form id="submitForm" action="updateLmtAppJointCoopRecord.do" method="POST">
				<emp:gridLayout id="LmtAppJointCoopGroup" maxColumn="2" title="合作方授信申请">
					...
					<emp:text id="LmtAppJointCoop.unfroze_amt" label="解冻金额" maxlength="18" dataType="Currency" onblur="checkUnFrozeAmt()" colSpan="2"/>
