					...
					if(flag == "success"){
						...
						if(INTER_FLT_RATE == "0.0"){
							PubBailInfo.up_rate._obj.element.value=0.00;
	  					    ...
	  					    PubBailInfo.up_rate._setValue(INTER_FLT_RATE);
	  	  				}
...
<body class="page_content" onload="onload()">
	<emp:tabGroup mainTab="base_tab" id="mainTab" >
       <emp:tab label="保证金信息" id="base_tab" needFlush="true" initial="true" >
	     <emp:gridLayout id="PubBailInfoGroup" title="保证金信息表" maxColumn="2">
		    ...
		    <emp:text id="PubBailInfo.cont_no" label="合同编号" maxlength="40" required="false" hidden="false"/>
		...
		<emp:tab label="保证金交易明细信息" url="queryIqpBailSubDisList4BailAcc.do?cont_no=${context.PubBailInfo.cont_no}"  id="org_tab" initial="false" needFlush="true">
		</emp:tab>
		</emp:tabGroup>
	<div align="center">
		<br>
