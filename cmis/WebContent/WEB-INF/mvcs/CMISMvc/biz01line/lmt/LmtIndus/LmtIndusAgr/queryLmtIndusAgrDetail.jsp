...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryLmtIndusAgrList.do"/>';
...
<body class="page_content" onload="doload()">
	...
	<emp:gridLayout id="LmtIndusAgrGroup" title="行业授信协议信息" maxColumn="2">
			<emp:text id="LmtIndusAgr.serno" label="业务编号" maxlength="40" required="true" colSpan="2" />
			...
			<emp:pop id="LmtIndusAgr.belg_org" label="所属机构"  
			...
			returnMethod="setProds" required="true" colSpan="2" cssElementClass="emp_field_text_long_readonly"/>
			...
			<emp:text id="LmtIndusAgr.indus_amt" label="行业总额(元)" maxlength="18" required="false" dataType="Currency" cssElementClass="emp_currency_text_readonly"/>
			<emp:text id="LmtIndusAgr.single_amt" label="单户限额(元)" maxlength="18" required="false" dataType="Currency" cssElementClass="emp_currency_text_readonly"/>
			<emp:text id="LmtIndusAgr.bal_amt" label="行业余额" maxlength="18" required="false" colSpan="2" dataType="Currency" cssElementClass="emp_currency_text_readonly"/>
			<emp:date id="LmtIndusAgr.start_date" label="授信起始日" required="false" />
			<emp:date id="LmtIndusAgr.end_date" label="授信到期日" required="false" />
			<emp:select id="LmtIndusAgr.is_list_mana" label="是否名单制管理" required="true" dictname="STD_ZX_YES_NO" />
