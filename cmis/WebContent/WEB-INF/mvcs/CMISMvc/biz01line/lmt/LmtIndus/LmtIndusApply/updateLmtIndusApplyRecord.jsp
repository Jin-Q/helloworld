...
<script type="text/javascript">
	...
	function doUpdateLmtIndusApply() {
		var form = document.getElementById("submitForm");
		var result = LmtIndusApply._checkAll();
		if(result){
...
<body class="page_content" onload="doload()">
	<emp:tabGroup mainTab="main_tabs" id="main_tabs">
		...
		<emp:form id="submitForm" action="updateLmtIndusApplyRecord.do" method="POST">
		<emp:gridLayout id="LmtIndusApplyGroup" title="行业授信申请信息" maxColumn="2">
			<emp:text id="LmtIndusApply.serno" label="业务编号" maxlength="40"   required="true"  readonly="true" cssElementClass="emp_field_common_serno" />
			...
			<emp:select id="LmtIndusApply.cur_type" label="授信币种" required="true" readonly="true" dictname="STD_ZX_CUR_TYPE" colSpan="2"/>
			...
			<emp:date id="LmtIndusApply.start_date" label="申请日期" required="true" readonly="true"/>
			...
			<emp:select id="LmtIndusApply.apply_type" label="申请类型" required="false" dictname="STD_ZB_LMT_APPLY_TYPE" hidden="true"/>
		</emp:gridLayout>
		...
		<div align="center">
			<br>
			<emp:button id="updateLmtIndusApply" label="保存" op="update"/>
