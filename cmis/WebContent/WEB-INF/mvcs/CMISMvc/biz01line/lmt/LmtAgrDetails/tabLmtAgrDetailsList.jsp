...
<script type="text/javascript">
	...
	function doViewLmtAgrDetails() {
		...
		if (paramStr != null) {
			var url = '<emp:url action="getLmtAgrDetailsViewPage.do"/>?'+paramStr+"&subConndition=${context.subConndition}";
...
<body class="page_content">
	...
	<emp:table icollName="LmtAgrDetailsList" pageMode="true" url="pageLmtAgrDetailsQuery.do">
