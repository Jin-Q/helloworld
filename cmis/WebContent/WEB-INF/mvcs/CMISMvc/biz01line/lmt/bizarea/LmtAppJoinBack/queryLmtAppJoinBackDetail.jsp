...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryLmtAppJoinBackList.do"/>';
...
<body class="page_content" onload="doOnload()">
	<emp:tabGroup mainTab="main_tabs" id="main_tabs">
		...
		<emp:gridLayout id="LmtAppJoinBackGroup" title="入圈/退圈申请表" maxColumn="2">
			...
			<emp:text id="LmtAppJoinBack.agr_no" label="圈商编号" maxlength="40" required="true" />
			...
			<emp:text id="LmtAgrBizArea.start_date" label="授信起始日期" maxlength="10" required="false" />
			<emp:text id="LmtAgrBizArea.end_date" label="授信到期日期" maxlength="10" required="false" />
		</emp:gridLayout>
		...
		<emp:gridLayout id="LmtAppJoinBackGroup" title="机构信息" maxColumn="2">
			<emp:pop id="LmtAppJoinBack.manager_id" label="责任人" url="getValueQuerySUserPopListOp.do?restrictUsed=false" returnMethod="setManagerId" hidden="true" required="true"/>
			...
			<emp:pop id="LmtAppJoinBack.manager_br_id_displayname" label="责任机构" required="true" url="querySOrgPop.do?restrictUsed=false" returnMethod="getOrganName2"/>
			<emp:text id="LmtAppJoinBack.input_id_displayname" label="登记人" required="false" defvalue="$currentUserName"/>
			<emp:text id="LmtAppJoinBack.input_br_id_displayname" label="登记机构" required="false" defvalue="$organName"/>
			
			<emp:text id="LmtAppJoinBack.input_date" label="登记日期" maxlength="10" required="false" defvalue="$OPENDAY" />
