...
<script type="text/javascript">
	...
	function doViewLmtAppIndiv() {
		...
		var cus_id = LmtAppIndivList._obj.getParamValue('cus_id');
		if (paramStr != null) {
			var url = '<emp:url action="getLmtAppIndivViewPage.do"/>?'+paramStr+'&op=view&cus_id='+cus_id;
			url = EMPTools.encodeURI(url);
			window.location = url;
		} else {
			alert('请先选择一条记录！');
...
<body class="page_content">
	...
	<div align="left">
		<emp:button id="getAddLmtAppIndivPage" label="新增" op="add"/>
		...
		<emp:button id="subLmtAppIndiv" label="提交" op="update"/>
