...
<script type="text/javascript">
	...
	function doSelect(){
		...
		if (data != null && data.length !=0) {
            ...
            var guar_amt = data[0].guar_amt._getValue();
            if('<%=rel%>' == "sxRel"){
            	var url = '<emp:url action="getRLmtGuarContAddPage.do"/>?limit_code=${context.limit_code}&guar_amt='+guar_amt+'&cus_id=${context.cus_id}&guar_cont_no='+guar_cont_no;
            }else{     
            	var url = '<emp:url action="getGrtLoanRGurAddPage.do"/>?isCreditChange=${context.isCreditChange}&cont_no=${context.cont_no}&serno=${context.serno}&cus_id=${context.cus_id}&guar_cont_no='+guar_cont_no;   
            }  
...
<body class="page_content">
	...
	<emp:table icollName="GrtGuarContList" pageMode="true" url="pageGrtGuarContTabQuery.do" reqParams="cus_id=${context.cus_id}">
