...
<script type="text/javascript">
	...
	function doSelect(){
		...
		if (data != null && data.length !=0) {
			...
			var guar_amt = data[0].guar_amt._getValue(); 
			if('<%=rel%>' =="sxRel"){
				var url = '<emp:url action="getYBRLmtGuarContAddPage.do"/>?limit_code=${context.limit_code}&cus_id=${context.cus_id}&guar_cont_no='+guar_cont_no+'&guar_amt='+guar_amt;
			}else {  
				var url = '<emp:url action="getYBGrtLoanRGurAddPage.do"/>?isCreditChange=${context.isCreditChange}&cont_no=${context.cont_no}&serno=${context.serno}&cus_id=${context.cus_id}&guar_cont_no='+guar_cont_no;   
			}  
...
<body class="page_content">
	...
	<emp:table icollName="GrtGuarContList" pageMode="true" url="pageYbGrtGuarContTabQueryForLmt.do">
