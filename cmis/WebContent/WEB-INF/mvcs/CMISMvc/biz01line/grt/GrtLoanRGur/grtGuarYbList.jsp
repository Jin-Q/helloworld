...
<script type="text/javascript">
	...
	function doSelect(){
		...
		if (data != null && data.length !=0) {
            ...
            var guar_amt = data[0].guar_amt._getValue();
            var url = '<emp:url action="getYBGrtLoanRGurAddPage.do"/>?isFromLmt=is&guar_cont_type=${context.guar_cont_type}&limit_acc_no=${context.limit_acc_no}&limit_credit_no=${limit_credit_no}&serno=${context.serno}&cus_id=${context.cus_id}&guar_cont_no='+guar_cont_no;   
