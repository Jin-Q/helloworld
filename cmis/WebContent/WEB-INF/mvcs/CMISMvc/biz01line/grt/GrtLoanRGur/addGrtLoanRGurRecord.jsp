...
<body class="page_content" onload="load();">
	...
	<emp:form id="submitForm" action="addGrtLoanRGurRecord.do?isCreditChange=${context.isCreditChange}"  method="POST">	
		<emp:gridLayout id="GrtLoanRGurGroup" title="业务和担保合同关联信息" maxColumn="2">
			...
			<emp:text id="GrtLoanRGur.guar_amt" label="本次担保金额" maxlength="18" required="true" dataType="Currency" onblur="checkCur();"/> 
		    ...
		    <emp:text id="GrtLoanRGur.grt_type" label="担保类型"  defvalue="ZGE" required="false" hidden="true"/> 
		</emp:gridLayout>              
