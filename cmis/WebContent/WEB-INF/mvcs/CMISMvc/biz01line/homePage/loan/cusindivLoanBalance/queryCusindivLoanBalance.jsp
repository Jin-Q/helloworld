...
Event.onDOMReady(function() {
	var xml = CusIndivLoanBalance._getValue();    
...
<body class="page_content">
	...
	<emp:text id="CusIndivLoanBalance" label="CusIndivLoanBalance"  defvalue="${context.CusIndivLoanBalance}" hidden="true"></emp:text> 
	<div id="chartdiv">
		this is pic !
	</div>
</body>
