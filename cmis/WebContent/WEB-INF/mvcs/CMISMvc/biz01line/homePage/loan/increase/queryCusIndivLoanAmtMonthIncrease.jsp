...
<html>
<head>
<title>个人贷款本月增长额FLASH图形展示</title>
...
Event.onDOMReady(function() {
	var xml = CusIndivLoanAmtIncrease._getValue();  
...
<body class="page_content">
	...
	<emp:text id="CusIndivLoanAmtIncrease" label="CusIndivLoanAmtIncrease"  defvalue="${context.CusIndivLoanAmtIncrease}" hidden="true"></emp:text>
	<div id="chartdiv">
		this is pic !
	</div>
</body>
