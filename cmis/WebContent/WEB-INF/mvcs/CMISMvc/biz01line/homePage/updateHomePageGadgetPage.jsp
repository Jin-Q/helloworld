...
<script type="text/javascript">
	...
	function doAdd(){
		...
		form.action="<emp:url action='updateHomePageGadget.do'/>&operator=update";
		form.method = "POST"; 
...
<body class="page_content" onload="">
	...
	<emp:form id="submitForm" action="" method="POST">
		...
		<div align="center">
		<emp:gridLayout id="RegistGadgetGroup" title="Gadget编辑页面" maxColumn="1">
				...
				<emp:text id="HomepageGadget.gadget_width" label="工具宽度" required="true" defvalue="100%" hidden="true"/>
				...
				<!-- TODO 所有人查看:ALL  可根据岗位设置权限，多个岗位以,分割   应做成POP框选择 -->
				<!-- emp:text id="HomepageGadget.gadget_dutys" label="工具添加权限" required="true" / -->
				<emp:pop id="HomepageGadget.gadget_dutys" label="工具添加权限" hidden="true" required="false"  colSpan="2" url="astmesQueryMultiSDutyPop.do"   returnMethod="set_duty_ids" cssElementClass="emp_field_text_input_blue"/>
