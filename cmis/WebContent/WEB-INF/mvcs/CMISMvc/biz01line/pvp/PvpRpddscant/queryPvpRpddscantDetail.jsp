...
<script type="text/javascript">
	function doReturn1() { 
        if('<%=flag%>'=="pvpLoan"){
        	var url = '<emp:url action="queryPvpRpddscantHistoryList.do"/>?op=view&menuId=PvpRpddscantHistory';
        }else{
        	var url = '<emp:url action="queryPvpRpddscantList.do"/>?op=update&menuId=PvpRpddscant';
        }
...
<body class="page_content" onload="doOnLoad()">
		...
		<emp:tab label="转贴现合同信息" id="subTab" url="getCtrRpddscntContViewPage.do?cont_no=${context.PvpLoanApp.cont_no}&menuIdTab=queryCtrRpddscntContHistoryList&op=view&pvp=pvp" initial="false" needFlush="true"/>
	</emp:tabGroup>
	<div align="center" id="showbutton" style="display: 'none'">
	<div align="center">
		<br>
