...
<body class="page_content" onload="doOnLoad();">
	<emp:form id="submitForm" action="updatePvpRpddscantRecord.do" method="POST">
	  <emp:tabGroup mainTab="base_tab" id="mainTab" >
		...
		<emp:tab label="转贴现合同信息" id="subTab" url="getCtrRpddscntContViewPage.do?cont_no=${context.PvpLoanApp.cont_no}&menuId=queryCtrRpddscntContHistoryList&op=view&pvp=pvp" initial="false" needFlush="true"/>
	</emp:tabGroup>
