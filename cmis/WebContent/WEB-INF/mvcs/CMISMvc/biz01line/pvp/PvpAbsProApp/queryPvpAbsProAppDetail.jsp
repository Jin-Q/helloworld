...
<body class="page_content" onload="doOnLoad()">
	...
	<emp:gridLayout id="PvpAbsProAppGroup" title="证券化预封包申请表" maxColumn="2">
			...
			<emp:text id="PvpAbsProApp.input_id" label="操作人员" required="false" />
			<emp:text id="PvpAbsProApp.input_br_id" label="操作机构" required="false" />
			<emp:text id="PvpAbsProApp.update_date" label="修改日期" required="false" />
			<emp:text id="PvpAbsProApp.prc_status" label="处理状态" hidden="true" />
	</emp:gridLayout>
	...
	<emp:tab label="明细信息" id="proListtab" needFlush="true" url="queryIqpAbsProListList.do?batch_no=${context.PvpAbsProApp.batch_no}&pre_package_serno=${context.PvpAbsProApp.pre_package_serno}&op=view"></emp:tab>
	</emp:tabGroup>
</body>
</html>
</emp:page>
