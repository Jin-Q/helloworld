...
<script type="text/javascript">
	...
	function doGetUpdatePvpLoanAppPage() {
		...
		if (paramStr != null) {
			var url = '<emp:url action="getPvpAssetProUpdatePage.do"/>?'+paramStr;
	...
	function doGetAddPvpLoanAppPage() {
		var url = '<emp:url action="getPvpAssetProAddPage.do"/>?menuId=xzzczqhcz';
		url = EMPTools.encodeURI(url);
		window.location = url;
	};
	...
	function doDeletePvpLoanApp() {
		...
		if (paramStr != null){ 
			...
			if(confirm("是否确认要删除？")){
				...
				var url = '<emp:url action="deletePvpAssetProRecord.do"/>?'+paramStr;
				url = EMPTools.encodeURI(url); 
...
<body class="page_content">
	...
	<emp:table icollName="PvpLoanAppList" pageMode="true" url="pagePvpAssetProQuery.do">
