	...
	<emp:form id="submitForm" action="updatePvpRpddscantRecord.do" method="POST">
	  <emp:tabGroup mainTab="base_tab" id="mainTab" > 
         ...
         <emp:gridLayout id="" maxColumn="2" title="金额信息">
		    <emp:text id="PvpLoanApp.cont_amt" label="项目金额" maxlength="18" required="false" dataType="Currency" readonly="true"/>
		...
		<emp:tab label="资产证券化项目信息" id="subTab" url="getCtrAssetProContViewPage.do?cont_no=${context.PvpLoanApp.cont_no}&menuId=zczqhxmcx&op=view&flag=notHave" initial="false" needFlush="true"/>
	</emp:tabGroup>
