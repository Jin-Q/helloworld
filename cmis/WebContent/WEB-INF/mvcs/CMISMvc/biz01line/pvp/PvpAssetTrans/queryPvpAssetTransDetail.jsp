...
<body class="page_content" >
		...
		<emp:tab label="资产流转合同信息" id="subTab" url="getCtrAssetTransContViewPage.do?cont_no=${context.PvpLoanApp.cont_no}&menuIdTab=ZCLZHTCX&op=view&flag=notHave" initial="false" needFlush="true"/>
	</emp:tabGroup>
	<div align="center">
	<br>
