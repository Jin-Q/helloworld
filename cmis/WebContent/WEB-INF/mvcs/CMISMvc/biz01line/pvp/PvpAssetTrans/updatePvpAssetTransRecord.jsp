...
<body class="page_content">
	<emp:form id="submitForm" action="updatePvpRpddscantRecord.do" method="POST">
	  <emp:tabGroup mainTab="base_tab" id="mainTab" > 
		...
		<emp:tab label="资产流转合同信息" id="subTab" url="getCtrAssetTransContViewPage.do?cont_no=${context.PvpLoanApp.cont_no}&menuId=ZCLZHTCX&op=view&flag=notHave" initial="false" needFlush="true"/>
	</emp:tabGroup>
