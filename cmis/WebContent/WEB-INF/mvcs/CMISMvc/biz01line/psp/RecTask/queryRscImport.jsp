...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importRscTaskInfoExcelData.do?module_id=12345&func_id=123411&data_id=3332221&content=${param.content}&allow-doc=xls&allow-size=10&allow-num=1&isSelection=false&isMultiple=false&isModule=false&isFunction=false'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：需以系统内提供的导入模板为模板，导入风险认定信息。）</td>
		</tr>
	 	</table>
	</form>	
</body>
