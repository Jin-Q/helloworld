...
<script type="text/javascript">
	...
	function doOnLoad(){
		var action = '<%=url%>';
		var check_type = '${context.PspCheckTask.check_type}';
		var task_type = '${context.PspCheckTask.task_type}';
		var url = '<emp:url action="' + action + '"/>';
		url = url + "&PspCheckTask.check_type="+check_type+"&PspCheckTask.task_type="+task_type;
