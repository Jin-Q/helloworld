...
<body class="page_content" onload="doload()">
	...
	<emp:form id="submitForm" action="updatePspZxqkLoanRecordFortc.do" method="POST">
			<emp:text id="PspZxqkLoan.pk_id" label="主键" required="false" hidden="true"/>
			...
			<emp:text id="PspZxqkLoan.cus_id_bzr" label="保证人客户号"  hidden="true"/>
			<emp:text id="PspSitecheckCom.cus_idbzr" label="客户号" hidden="true" defvalue="${context.cus_idbzr}" />
		<emp:gridLayout id="PspZxqkLoanGroup" title="征信情况" maxColumn="2">
			<emp:select id="PspZxqkLoan.cus_type" label="客户类型"  required="true" defvalue="02" readonly="true" dictname="STD_ZB_JBR_TYPE" />	
			<emp:text id="PspZxqkLoan.cus_id_displayname" label="保证人名称" required="false" readonly="true" />
		</emp:gridLayout>
		...
		<emp:gridLayout id="PspZxqkLoanGroup" title="保证人" maxColumn="2"  >
			...
			<emp:text id="PspZxqkLoan.bzr_name" label="保证人姓名" required="true" hidden="true" />
