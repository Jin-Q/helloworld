...
<script type="text/javascript">
	...
	function changeCus(){
		...
		PspZxqkLoan.jqgr_jsqzje._setValue("");
		...
		PspZxqkLoan.dwrz_jsqzje._setValue("");
...
<body class="page_content" onload="doload()">
	...
	<emp:form id="submitForm" action="updatePspZxqkLoanRecord.do" method="POST">
		...
		<emp:gridLayout id="PspZxqkLoanGroup" title="征信情况" maxColumn="2">
			<emp:select id="PspZxqkLoan.cus_type" label="客户类型"  required="true"  dictname="STD_ZB_JBR_TYPE" onchange="changeCusType();changeCus()" readonly="true"/>	
		</emp:gridLayout>
		...
		<emp:gridLayout id="PspSitecheckComGroup" title="借款企业关键个人" maxColumn="2"  >
			...
			<emp:radio id="PspZxqkLoan.jqgr_sfyqb" label="是否逾期、欠息或不良" required="true" dictname="STD_ZX_YES_NO" layout="false" colSpan="2" onclick="convert_jqgr()"/>
		...
		<emp:gridLayout id="PspSitecheckComGroup" title="保证人" maxColumn="2"  >
			...
			<emp:text id="PspZxqkLoan.dwdb_jsqzje" label="较上期增加（或减少）额"  required="true" dataType="Currency" colSpan="2"/>
