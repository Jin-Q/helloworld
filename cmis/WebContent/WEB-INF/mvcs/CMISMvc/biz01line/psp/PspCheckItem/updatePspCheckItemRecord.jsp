...
<body class="page_content" onload="onload()">
	...
	<emp:form id="submitForm" action="updatePspCheckItemRecord.do" method="POST">
		<emp:gridLayout id="PspCheckItemGroup" maxColumn="2" title="检查项目表">
			<emp:text id="PspCheckItem.item_id" label="项目编号" maxlength="40" required="true" readonly="true" />
			...
			<emp:text id="PspCheckItem.imp_item_id" label="目标项目编号（多项以|隔开）" required="false" hidden="true"/>
