...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePspOrderAnalyRecord.do" method="POST">
		<emp:gridLayout id="PspOrderAnalyGroup" maxColumn="2" title="订单明细">
			...
			<emp:select id="PspOrderAnaly.check_freq" label="检查频率" required="true" dictname="STD_ZB_PSP_CHECK_UNIT" readonly="true" colSpan="2"/>
		</emp:gridLayout>
		<emp:gridLayout id="PspIostoreDocGroup" title="登记信息" maxColumn="2">
			...
			<emp:text id="PspOrderAnaly.pk_id" label="主键" maxlength="32" required="true" readonly="true" hidden="true"/>
