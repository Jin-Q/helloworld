...
<script type="text/javascript">
	...
	function doLoad(){
		...
		var task_freq = PspTaskCheckSet.task_freq._getValue();
		if("" == task_freq || null ==task_freq){
...
<body class="page_content" onload="doLoad()">
	 ...
	 <emp:gridLayout id="PspTaskCheckSetGroup" title="贷后检查任务设置" maxColumn="2">
			...
			<emp:select id="PspTaskCheckSet.cus_type" label="客户类型" required="true" dictname="STD_ZB_PSP_CUS_TYPE" />
			...
			<emp:checkbox id="PspTaskCheckSet.risk_type" label="风险分类" required="false" dictname="STD_ZB_FIVE_SORT" layout="false" colSpan="2" disabled="true"/>
			<emp:checkbox id="PspTaskCheckSet.cdt_eval" label="信用等级" required="false" dictname="STD_ZB_CREDIT_GRADE" layout="false" colSpan="2" disabled="true"/>
			<emp:checkbox id="PspTaskCheckSet.trade_ter" label="担保方式" required="false" dictname="STD_ZB_ASSURE_MEANS" layout="false" colSpan="2" disabled="true"/>
			...
			<emp:select id="PspTaskCheckSet.amt_area" label="贷款余额" readonly="false" dictname="STD_ZB_CHECK_AREA" disabled="true"/>
			...
			<emp:select id="PspTaskCheckSet.task_freq_unit2" label="任务频率单位" required="true" dictname="STD_ZB_CHECK_UNIT" hidden="true"/>
			<emp:select id="PspTaskCheckSet.task_freq_unit1" label="任务频率" required="true" dictname="STD_ZB_CHECK_UNIT" hidden="true"/>
			...
			<emp:select id="PspTaskCheckSet.task_freq_unit" label="任务频率单位" required="true" dictname="STD_ZB_CHECK_UNIT" hidden="true"/>
		</emp:gridLayout>
