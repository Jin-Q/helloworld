...
<%
	String check_mode = request.getParameter("check_mode");
%>
<emp:page>
<html>
<head>
...
<script type="text/javascript">
	...
	function doLoad(){
		...
		var check_mode='<%=check_mode%>';
		PspTaskCheckSet.check_mode._setValue(check_mode);
		if("00"==check_mode){//首次
			...
			PspTaskCheckSet.task_freq_unit._setValue("");
			PspTaskCheckSet.is_special._setValue("");
...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="addPspTaskCheckSetRecord.do" method="POST">
		...
		<emp:gridLayout id="PspTaskCheckSetGroup" title="贷后检查任务设置" maxColumn="2">
			...
			<emp:textarea id="PspTaskCheckSet.memo" label="备注" maxlength="200" hidden="true" colSpan="2" />
