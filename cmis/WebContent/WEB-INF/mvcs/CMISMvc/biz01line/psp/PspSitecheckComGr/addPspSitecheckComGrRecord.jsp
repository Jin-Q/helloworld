...
<script type="text/javascript">
	...
	function doload(){
		...
		var options = PspSitecheckComGr.visit_type._obj.element.options;
	    for ( var i = options.length - 1; i >= 0; i--) {
	   	    if(options[i].value=='03'||options[i].value=='04'){
	  			options.remove(i);
	   	    }
	    }
	...
	function changeVisitType(){
		...
		if(visit_type=="01" ){
			...
			PspSitecheckComGr.cus_type._setValue("");	
...
<body class="page_content" onload="doload()">
	...
	<emp:form id="submitForm" action="addPspSitecheckComGrRecord.do" method="POST">
