...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updatePspDunningTaskDivisRecord.do" method="POST">
		<emp:gridLayout id="PspDunningTaskDivisGroup" title="催收任务分配" maxColumn="2">
			...
			<emp:date id="PspDunningTaskDivis.task_create_date" label="任务生成日期" required="true" onblur="checkCreateDate(PspDunningTaskDivis.task_create_date)"/>
		...
		<div align="center">
			<br>
			<emp:button id="updPspDun" label="修改" op="update"/>
