...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePspFeeDetailRecord.do" method="POST">
		<emp:gridLayout id="PspFeeDetailGroup" title="水电费明细" maxColumn="2">
			<emp:date id="PspFeeDetail.last_regi_date" label="缴纳起始日期" />
			...
			<emp:select id="PspFeeDetail.check_freq" label="检查频率" required="true" dictname="STD_ZB_PSP_CHECK_UNIT" readonly="true" colSpan="2"/>
