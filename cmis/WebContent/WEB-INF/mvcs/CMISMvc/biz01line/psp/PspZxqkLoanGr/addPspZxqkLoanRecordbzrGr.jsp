...
<body class="page_content" onload="doload()">
	...
	<emp:form id="submitForm" action="updatePspZxqkLoanRecordFortc.do" method="POST">
			...
			<emp:text id="PspSitecheckCom.cus_idbzr" label="客户号" hidden="true" defvalue="${context.cus_idbzr}" required="false" />
		<emp:gridLayout id="PspZxqkLoanGroup" title="保证人" maxColumn="2"  >
			<emp:text id="PspZxqkLoan.cus_id_displayname" label="保证人名称" required="false" readonly="true" colSpan="2"/>
			...
			<emp:text id="PspZxqkLoan.credit_bank_num" label="授信合作银行数量" required="true"  dataType="Int" colSpan="2"/>
