...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePspTaxDetailRecord.do" method="POST">
		<emp:gridLayout id="PspTaxDetailGroup" title="税费明细" maxColumn="2">
			...
			<emp:select id="PspTaxDetail.check_freq" label="检查频率" required="true" dictname="STD_ZB_PSP_CHECK_UNIT" readonly="true" colSpan="2"/>
