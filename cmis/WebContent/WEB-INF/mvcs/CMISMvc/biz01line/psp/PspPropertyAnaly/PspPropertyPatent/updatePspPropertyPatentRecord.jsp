...
<script type="text/javascript">
	...
	function doSub(){
		...
		if(PspPropertyAnaly._checkAll()&PspPropertyPatent._checkAll()){
			PspPropertyAnaly._toForm(form);
			PspPropertyPatent._toForm(form);
...
<body class="page_content" >
	...
	<emp:form id="submitForm" action="updatePspPropertyAnalyRecord.do" method="POST">
		...
		<emp:gridLayout id="PspPropertyPatentGroup" title="固定资产分析" maxColumn="2">
			...
			<emp:text id="PspPropertyPatent.property_id" label="资产编号" maxlength="32" required="true" hidden="true" />
			...
			<emp:text id="PspPropertyPatent.patent_name" label="专利证书名称" maxlength="100" required="false" />
			<emp:text id="PspPropertyPatent.patent_owner" label="发明人" maxlength="50" required="false" />
			<emp:text id="PspPropertyPatent.patent_no" label="专利号" maxlength="40" required="false" />
			<emp:date id="PspPropertyPatent.auth_date" label="授权公告日" required="false" />
			<emp:text id="PspPropertyPatent.patent_unit" label="证书核发单位" maxlength="100" required="false" />
		</emp:gridLayout>
