...
<script type="text/javascript">
	...
	function doSub(){
		...
		if(PspPropertyAnaly._checkAll()&PspPropertyTraffic._checkAll()){
			PspPropertyAnaly._toForm(form);
			PspPropertyTraffic._toForm(form);
...
<body class="page_content" >
	...
	<emp:form id="submitForm" action="updatePspPropertyAnalyRecord.do" method="POST">
		...
		<emp:gridLayout id="PspPropertyTrafficGroup" title="固定资产分析" maxColumn="2">
			...
			<emp:text id="PspPropertyTraffic.property_id" label="资产编号" maxlength="32" required="true" hidden="true" />
			...
			<emp:text id="PspPropertyTraffic.model_no" label="型号或品牌" maxlength="50" required="false" />
			<emp:date id="PspPropertyTraffic.pur_date" label="购置时间" required="false" />
			<emp:text id="PspPropertyTraffic.pur_price" label="购置价格" maxlength="16" required="false" dataType="Currency" />
		</emp:gridLayout>
