...
<script type="text/javascript">
	...
	function doSub(){
		...
		if(PspPropertyAnaly._checkAll()&PspPropertyForestright._checkAll()){
			PspPropertyAnaly._toForm(form);
			PspPropertyForestright._toForm(form);
...
<body class="page_content" >
	...
	<emp:form id="submitForm" action="updatePspPropertyAnalyRecord.do" method="POST">
		
		<emp:gridLayout id="PspPropertyForestrightGroup" title="固定资产分析" maxColumn="2">
			...
			<emp:text id="PspPropertyForestright.property_id" label="资产编号" maxlength="32" required="true" hidden="true" />
			...
			<emp:text id="PspPropertyForestright.location" label="坐落" maxlength="100" required="false" />
			<emp:text id="PspPropertyForestright.land_no" label="宗地号" maxlength="40" required="false" />
			<emp:text id="PspPropertyForestright.land_area" label="面积" maxlength="8" required="false" dataType="Int" />
			<emp:text id="PspPropertyForestright.forest_class" label="林班" maxlength="5" required="false" />
			<emp:text id="PspPropertyForestright.sm_class" label="小班" maxlength="5" required="false" />
			<emp:text id="PspPropertyForestright.tree_type" label="主要树种" maxlength="5" required="false" />
			<emp:text id="PspPropertyForestright.forest_type" label="林种" maxlength="5" required="false" />
			<emp:text id="PspPropertyForestright.use_term" label="使用期限" maxlength="3" required="false" dataType="Int" />
			<emp:date id="PspPropertyForestright.end_date" label="终止日期" required="false" />
		</emp:gridLayout>
