...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePspWageContaccRecord.do" method="POST">
		<emp:gridLayout id="PspWageContaccGroup" title="工资对账单" maxColumn="2">
			...
			<emp:pop id="PspWageContacc.acctsvcr_no" label="开户行行号" url="getPrdBankInfoPopList.do?status=1" returnMethod="getAcctsvcrNo" hidden="true" buttonLabel="选择" />
			...
			<emp:select id="PspWageContacc.check_freq" label="检查频率" required="true" dictname="STD_ZB_PSP_CHECK_UNIT" readonly="true" colSpan="2"/>
