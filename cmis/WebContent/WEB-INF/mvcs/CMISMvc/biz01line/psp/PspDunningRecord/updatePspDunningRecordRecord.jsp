...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updatePspDunningRecordRecord.do" method="POST">
		<emp:gridLayout id="PspDunningRecordGroup" maxColumn="2" title="催收纪录及回执登记">
			<emp:text id="PspDunningRecord.serno" label="催收函编号" maxlength="40" required="true" readonly="true" colSpan="2"/>
			...
			<emp:text id="PspDunningRecord.cus_id" label="催收客户码" maxlength="30" required="true" readonly="true"/>
			...
			<emp:text id="PspDunningRecord.input_id_displayname" label="登记人"   required="true" readonly="true"/>
			<emp:text id="PspDunningRecord.input_br_id_displayname" label="登记机构"   required="true" readonly="true" />
			...
			<emp:date id="PspDunningRecord.input_date" label="登记日期" required="true" readonly="true"/>
			<emp:text id="PspDunningRecord.task_serno" label="关联借据编号" maxlength="40" hidden="true"/>
		</emp:gridLayout>
		
		<div align="center">
			<br>
			<emp:button id="updRecord" label="修改" />
