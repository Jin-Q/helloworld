...
<script type="text/javascript">
	...
	function doNext() {
		if(!IqpDrfpoMana._checkAll()){
			...
			var url = '<emp:url action="updateDpoDrfpoManaRecord.do"/>';
			url = EMPTools.encodeURI(url);
...
<emp:tabGroup mainTab="mainTab" id="mainTabs">
	<emp:tab label="基本信息" id="mainTab" needFlush="true">
		<emp:form id="submitForm" action="updateDpoDrfpoManaRecord.do" method="POST">
			<emp:gridLayout id="IqpDrfpoManaGroup" title="票据池管理" maxColumn="2">
				...
				<emp:pop id="IqpDrfpoMana.cus_id" label="客户码" required="true" url="queryAllCusPop.do?restrictUsed=false&cusTypCondition=cus_status='20' and BELG_LINE IN('BL100','BL200')&returnMethod=returnCus" buttonLabel="选择"/>
