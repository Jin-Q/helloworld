...
<body class="page_content">
	...
	<emp:gridLayout id="CtrAssetTransContGroup" maxColumn="2" title="资产流转协议">
			...
			<emp:date id="CtrAssetTransCont.ser_date" label="签订日期"  required="true" readonly="true" />
			...
			<emp:date id="CtrAssetTransCont.end_date" label="到期日期" required="false" />
			<emp:date id="CtrAssetTransCont.inure_date" label="生效日期" required="false" />
