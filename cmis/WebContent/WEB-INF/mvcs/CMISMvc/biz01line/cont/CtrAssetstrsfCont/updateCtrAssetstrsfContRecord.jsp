...
<script type="text/javascript">
	...
	function doSub(){
		if(!CtrAssetstrsfCont._checkAll()){
			return;
		}
		...
		var url = '<emp:url action="updateCtrAssetstrsfContRecord.do"/>';
		url = EMPTools.encodeURI(url);
...
<body class="page_content" onload="doOnLoad()">
  <emp:tabGroup mainTab="mainTab" id="mainTab">
   <emp:tab label="基本信息" id="mainTab">
	<emp:form id="submitForm" action="updateCtrAssetstrsfContRecord.do" method="POST">
		<emp:gridLayout id="CtrAssetstrsfContGroup" maxColumn="2" title="资产转受让合同">
					...
					<emp:pop id="CtrAssetstrsfCont.toorg_no" label="交易对手行号" url="getPrdBankInfoPopList.do?status=1" returnMethod="getOrgNo" required="true" buttonLabel="选择" readonly="true"/>
					...
					<!--modified by wangj 需求编号：ED150612003 ODS系统取数需求  begin-->
					<emp:pop id="CtrAssetstrsfCont.tooorg_no" label="交易对手开户行行号" url="getPrdBankInfoPopList.do?status=1" returnMethod="getTooorgNo" required="true" buttonLabel="选择" readonly="true"/>
					<!--modified by wangj 需求编号：ED150612003 ODS系统取数需求  end-->
					...
					<!--modified by wangj 需求编号：ED150612003 ODS系统取数需求  begin-->
					<emp:pop id="CtrAssetstrsfCont.acctsvcr_no" label="开户行行号" url="getPrdBankInfoPopList.do?status=1" returnMethod="getAcctsvcrNo" required="true" buttonLabel="选择" readonly="true" />
					<!--modified by wangj 需求编号：ED150612003 ODS系统取数需求  end-->
				...
				<emp:gridLayout id="" maxColumn="2" title="额度信息">
					<emp:select id="CtrAssetstrsfCont.limit_ind" label="授信额度使用标志" required="true" onchange="isUseLimt()" dictname="STD_INTBANK_LIMIT_IND" colSpan="2" readonly="true"/>	   
		    		<emp:pop id="CtrAssetstrsfCont.limit_acc_no" label="授信台账编号"  url="selectLmtAgrDetails.do" returnMethod="getLmtAmt" required="false" readonly="true" buttonLabel="选择" popParam="height=700, width=1200, top=80, left=80, toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no"/>
				</emp:gridLayout>
