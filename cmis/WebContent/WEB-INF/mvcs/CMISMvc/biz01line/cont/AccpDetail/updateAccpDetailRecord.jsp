...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateAccpDetailRecord.do" method="POST">
		<emp:gridLayout id="AccpDetailGroup" maxColumn="2" title="承兑汇票申请明细">
			<emp:text id="AccpDetail.serno" label="业务编号" maxlength="40" required="true" readonly="true" />
