...
<body class="page_content">
	...
	<emp:gridLayout id="CtrLimitLmtRelGroup" title="额度合同占用授信关联表" maxColumn="2">
			...
			<emp:text id="CtrLimitLmtRel.limit_serno" label="额度合同业务编号" maxlength="40"  required="false" hidden="false"/>
			<emp:text id="CtrLimitLmtRel.limit_cont_no" label="额度合同合同编号" maxlength="40" required="false" hidden="true" colSpan="2"/>
			<emp:pop id="CtrLimitLmtRel.lmt_code_no" label="授信额度编号" url="queryLmtAgrDetailsPop.do" returnMethod="getLmtMsg"  required="true" />
