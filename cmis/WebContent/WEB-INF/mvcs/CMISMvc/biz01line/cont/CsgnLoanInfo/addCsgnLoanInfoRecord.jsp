...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addCsgnLoanInfoRecord.do" method="POST">
		
		<emp:gridLayout id="CsgnLoanInfoGroup" title="委托贷款关联信息" maxColumn="2">
			<emp:text id="CsgnLoanInfo.serno" label="业务编号" maxlength="40" required="true" />
