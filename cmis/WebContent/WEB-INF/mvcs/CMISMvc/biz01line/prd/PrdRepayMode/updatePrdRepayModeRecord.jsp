...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePrdRepayModeRecord.do" method="POST">
		<emp:gridLayout id="PrdRepayModeGroup" maxColumn="2" title="还款方式">
			<emp:text id="PrdRepayMode.repay_mode_id" label="还款方式代码" maxlength="60" required="true" readonly="true" />
