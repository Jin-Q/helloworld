...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePrdRepayPlanRecord.do" method="POST">
		<emp:gridLayout id="PrdRepayPlanGroup" maxColumn="2" title="还款方式策略">
			<emp:text id="PrdRepayPlan.serno" label="序号" maxlength="30" required="true" readonly="true" />
