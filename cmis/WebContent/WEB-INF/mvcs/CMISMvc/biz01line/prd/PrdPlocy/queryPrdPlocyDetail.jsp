...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryPrdPlocyList.do"/>';
...
<body class="page_content">
	...
	<emp:gridLayout id="PrdPlocyGroup" title="政策资料管理" maxColumn="2">
			...
			<emp:text id="PrdPlocy.inputid" label="登记人员" maxlength="20" required="false" />
			<emp:text id="PrdPlocy.inputdate" label="登记日期" maxlength="10" required="false" />
			<emp:text id="PrdPlocy.orgid" label="登记机构" maxlength="20" required="false" />
