...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importPrdLiborMaintainList.do'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：需以系统内提供的LIBOR导入模板为模板，导入LIBOR利率信息。）</td>
		</tr>
	 	</table>
	</form>	
</body>
