...
<script type="text/javascript">
	...
	function doReturn(){
		var url = '<emp:url action="queryPrdLiborMaintainList.do"/>?'+'menuId=PrdLiborMaintain';
...
<%} %>
			<TABLE align="center" width="300px">
        		<TR align="center">
          			<TD>
          				<span class="page_welcome_red"><font color="green"><a id="returnlink" onclick="doReturn()" href="">回到列表页面</a></font></span>
          			</TD>
        		</TR>
        		<TR><TD>&nbsp;</TD></TR>
      		</TABLE>
