...
<script src="<emp:file fileName='scripts/dtreeCatalog.js'/>" type="text/javascript" language="javascript"></script>
...
<script type="text/javascript">
	...
	function doOnLoad(){
		...
		var url = '<emp:url action="getPrdJSONTree.do"/>';
	...
	function dynamicAppendNode(pNode){
		...
		if(dynamic == "false"){
			...
			var url = '<emp:url action="getPrdJSONTree.do"/>?parentNodeId='+pid;
			url = EMPTools.encodeURI(url);
			EMPTools.ajaxRequest('GET', url, callback);
		}
	};
	...
	function doSelect(methodName){
		...
		*/
		...
		//var methodName="window.parent.<%=request.getParameter("returnMethod")%>";	
