...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updatePrdBankInfoRecord.do" method="POST">
		<emp:gridLayout id="PrdBankInfoGroup" maxColumn="2" title="银行信息">
			<emp:text id="PrdBankInfo.bank_no" label="行号" maxlength="40" required="true" readonly="true" />
