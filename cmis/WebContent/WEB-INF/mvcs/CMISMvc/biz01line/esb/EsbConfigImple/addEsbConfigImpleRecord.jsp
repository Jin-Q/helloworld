...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addEsbConfigImpleRecord.do" method="POST">
		<emp:gridLayout id="EsbConfigImpleGroup" title="接口交易配置表" maxColumn="2">
			...
			<emp:select id="EsbConfigImple.status" label="状态"  hidden="true" defvalue="0" dictname="STD_PRD_STATE" required="false" />
		</emp:gridLayout>
