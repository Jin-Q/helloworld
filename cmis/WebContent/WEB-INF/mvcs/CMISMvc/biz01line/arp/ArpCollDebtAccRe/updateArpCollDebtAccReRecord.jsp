...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateArpCollDebtAccReRecord.do" method="POST">
		<emp:gridLayout id="ArpCollDebtAccReGroup" maxColumn="2" title="抵债物关联表(台账)">
			<emp:text id="ArpCollDebtAccRe.serno" label="业务编号" maxlength="40" required="true" readonly="true" />
			<emp:text id="ArpCollDebtAccRe.debt_acc_no" label="抵债台账编号" maxlength="40" required="false" />
			<emp:text id="ArpCollDebtAccRe.guaranty_no" label="押品编号" maxlength="40" required="true" readonly="true" />
