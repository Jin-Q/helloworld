...
function doNext(){
	if(!ArpCollDebtAcc._checkAll()){
		return;
	}
	if(confirm("抵入后无法取消，是否确认抵入!")){
		...
		var handleSuccess = function(o){
			if(o.responseText !== undefined) {
				...
				if(flag == "success"){
					alert("已成功抵入!");
					debt_acc_no = ArpCollDebtAcc.debt_acc_no._getValue();
					var url = '<emp:url action="getArpCollDebtAccViewPage.do"/>?op=view&debt_acc_no='+debt_acc_no;
...
<emp:tabGroup mainTab="main_tabs" id="main_tab">
	...
	<emp:form id="submitForm" action="updateArpCollDebtAccRecord.do" method="POST">
