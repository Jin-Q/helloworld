...
<script type="text/javascript">
	...
	function doReturn() {
		...
		url = '<emp:url action="queryArpLawLawsuitDetailList.do"/>?serno='+ArpLawLawsuitDetail.serno._getValue()+menuIds;
		url = EMPTools.encodeURI(url);
		window.location=url;
	};
	function doSubmits(){
		doPubUpdate(ArpLawLawsuitDetail);
	};
	/*--user code end--*/
...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updateArpLawLawsuitDetailRecord.do" method="POST">
		<emp:gridLayout id="ArpLawLawsuitDetailGroup" maxColumn="2" title="诉讼明细信息">
