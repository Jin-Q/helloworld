...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryArpLawDebtorInfoList.do"/>?serno=<%=serno%>';
...
<body class="page_content" onload="doLoad()" >
	...
	<emp:form id="submitForm" action="addArpLawMemberInfoRecord.do" method="POST">
		...
		<emp:gridLayout id="ArpLawMemberInfoGroup" title="债务人员信息" maxColumn="2">
			...
			<emp:text id="ArpLawMemberInfo.serno" label="业务编号" maxlength="40" required="true" defvalue="<%=serno%>" hidden="true" />
			...
			<emp:text id="ArpLawMemberInfo.cus_id_displayname" label="客户名" required="true" 
