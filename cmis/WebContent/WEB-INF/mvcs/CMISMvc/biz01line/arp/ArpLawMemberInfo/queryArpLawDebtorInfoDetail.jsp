...
<script type="text/javascript">
	...
	function doReturn() {
		url = '<emp:url action="queryArpLawDebtorInfoList.do"/>?serno='+ArpLawMemberInfo.serno._getValue();
...
<body class="page_content" >
	...
	<emp:gridLayout id="ArpLawMemberInfoGroup" title="债务人员信息" maxColumn="2">
			<emp:text id="ArpLawMemberInfo.pk_serno" label="流水号" maxlength="40" required="false" hidden="true" />
			<emp:text id="ArpLawMemberInfo.serno" label="业务编号" maxlength="40" required="true" hidden="true" />
			<emp:select id="ArpLawMemberInfo.member_type" label="人员类别" required="true" 
			defvalue="002" dictname="STD_ZB_MEMBER_TYPE" hidden="true" />
			<emp:text id="ArpLawMemberInfo.cus_id" label="客户码" required="true"  colSpan="2" />
			<emp:text id="ArpLawMemberInfo.cus_name" label="客户名" required="true" 
