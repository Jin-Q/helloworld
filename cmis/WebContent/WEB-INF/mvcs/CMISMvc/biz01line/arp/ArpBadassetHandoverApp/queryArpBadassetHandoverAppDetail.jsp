...
<script type="text/javascript">
	...
	function doload(){
		...
		var approve_status = ArpBadassetHandoverApp.approve_status._getValue();
		if(approve_status == '997'){
			ArpBadassetHandoverApp.app_date._obj._renderHidden(false);
			ArpBadassetHandoverApp.over_date._obj._renderHidden(false);
		}
...
<body class="page_content" onload="doload()">
	<emp:tabGroup mainTab="main_tabs" id="main_tabs">
		...
		<emp:gridLayout id="ArpBadassetHandoverAppGroup" maxColumn="2" title="移交信息">	
			<emp:text id="ArpBadassetHandoverApp.serno" label="业务编号" maxlength="40"  required="true"/>
			...
			<emp:text id="ArpBadassetHandoverApp.rcv_org_displayname" label="接收机构" required="true" />
			<emp:text id="ArpBadassetHandoverApp.rcv_person_displayname" label="接收人员" required="true"  />
