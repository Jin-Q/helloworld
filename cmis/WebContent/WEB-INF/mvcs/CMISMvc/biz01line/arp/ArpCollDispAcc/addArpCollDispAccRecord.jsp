...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addArpCollDispAccRecord.do" method="POST">
		
		<emp:gridLayout id="ArpCollDispAccGroup" title="抵债物处置台账" maxColumn="2">
			<emp:text id="ArpCollDispAcc.serno" label="业务编号" maxlength="40" required="true" />
			<emp:text id="ArpCollDispAcc.asset_disp_no" label="资产处置编号" maxlength="40" required="true" />
