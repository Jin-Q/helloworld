...
<script type="text/javascript">
	...
	function doNext(){
		if(!MortCargoPledge._checkAll()){
			...
			<%if (action.equals("zh")){%>
		       var url = '<emp:url action="updateMortCargoPledgeRecord.do"/>?action=zh';//货物置换时修改后的货物记录存储在货物置换清单中
		    <%}else{%>
			   var url = '<emp:url action="updateMortCargoPledgeRecord.do"/>';
		    <%}%>
...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateMortCargoPledgeRecord.do" method="POST">
