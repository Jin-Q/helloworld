...
<script type="text/javascript">
    ...
    function doReturn() {
        ...
        var menuId='<%=menuId%>';
		var act = '<%=act%>'
		var url = '<emp:url action="queryMortGuarantyCertiInfoIgnoreList.do"/>?menuIdTab=mort_maintain&guaranty_no='+guaranty_no;
...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="addMortGuarantyCertiInfoRecord.do" method="POST">
		...
		<emp:gridLayout id="MortGuarantyCertiInfoGroup" title="抵质押物权证信息" maxColumn="2">
			...
			<emp:text id="MortGuarantyCertiInfo.warrant_appro_unit" label="权利凭证核发单位" maxlength="100" required="true" />
			<emp:date id="MortGuarantyCertiInfo.warrant_appro_date" label="权利凭证核发日期" required="true" />
