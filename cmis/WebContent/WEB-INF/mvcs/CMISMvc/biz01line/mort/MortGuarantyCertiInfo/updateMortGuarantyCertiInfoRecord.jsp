...
<script type="text/javascript">
	...
	function doOnchange(){//主权证信息不允许修改权证类别
		if(MortGuarantyCertiInfo.is_main_warrant._getValue()=="1"){
			MortGuarantyCertiInfo.warrant_cls._obj._renderDisabled(true);
			MortGuarantyCertiInfo.warrant_type_con._obj._renderReadonly(true)
		}else{
			MortGuarantyCertiInfo.warrant_cls._obj._renderDisabled(true);
			MortGuarantyCertiInfo.warrant_type_con._obj._renderReadonly(true);
			MortGuarantyCertiInfo.warrant_type_other._obj._renderReadonly(true);
		}
	}
	function doset(){
...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updateMortGuarantyCertiInfoRecord.do" method="POST">
		<emp:gridLayout id="MortGuarantyCertiInfoGroup" title="抵质押物权证信息" maxColumn="2">
			<emp:text id="MortGuarantyCertiInfo.guaranty_no" label="押品编号" maxlength="40" required="true" hidden="true"/>
			...
			<emp:text id="MortGuarantyCertiInfo.warrant_no" label="权证编号" maxlength="100" required="true"  readonly="true" onchange="doCheck()"/>
