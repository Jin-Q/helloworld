...
<body class="page_content">
	<emp:form id="submitForm" action="addQryTempletQryResultRecord.do" method="POST">
		<emp:gridLayout id="QryResultGroup" title="查询返回值配置表" maxColumn="2">
			...
			<emp:text id="QryResult.result_no" label="返回值编号" maxlength="20" required="true"  hidden="true" defvalue="系统自动生成"/>
