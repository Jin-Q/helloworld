...
<body class="page_content">
	<emp:form id="submitForm" action="updateQryTempletQryParamRecord.do" method="POST">
		<emp:gridLayout id="QryParamGroup" title="查询条件参数配置表" maxColumn="2">
			...
			<emp:text id="QryParam.param_no" label="条件参数编号" maxlength="20" required="true" readonly="true" />
