...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpAverageAssetAppRecord.do" method="POST">
		<emp:gridLayout id="IqpAverageAssetAppGroup" title="基本信息" maxColumn="2">
			<emp:pop id="IqpAverageAssetApp.bill_no" label="借据编号" url="AccViewPop.do?cusTypCondition=table_model in('AccLoan','AccPad') and status='1' and end_date>='${context.OPENDAY}'&returnMethod=returnAcc" required="true" />
