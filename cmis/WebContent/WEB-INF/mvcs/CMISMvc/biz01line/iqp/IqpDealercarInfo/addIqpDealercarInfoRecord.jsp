		...
		IqpDealercarInfo._toForm(form); 
			var handleSuccess = function(o){
				if(o.responseText !== undefined) {
					...
					if(flag == "success"){
						alert("新增成功!");
						var url = '<emp:url action="queryIqpDealercarInfoList.do"/>?op=update&serno=${context.serno}'; 
...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpDealercarInfoRecord.do" method="POST">
		  
		<emp:gridLayout id="IqpDealercarInfoGroup" title="车辆信息" maxColumn="2">          
			<emp:text id="IqpDealercarInfo.serno" label="业务编号" defvalue="${context.serno}" maxlength="40" hidden="true" />
