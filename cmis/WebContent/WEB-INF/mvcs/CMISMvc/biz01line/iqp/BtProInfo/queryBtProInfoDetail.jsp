...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryBtProInfoList.do"/>';
...
<body class="page_content">
	...
	<emp:gridLayout id="BtProInfoGroup" title="Bt项目融资项目信息" maxColumn="2">
			<emp:text id="BtProInfo.serno" label="业务编号" maxlength="40" required="true" />
			<emp:select id="BtProInfo.pro_cls" label="项目类别" required="false" />
