    ...
    function checkFistPerc(value){
        ...
        if(fst_perc!=null&&fst_perc!=''){
        	if(fst_perc<0 || fst_perc>100){
                ...
                HousePurInfo.fst_pyr_perc._setValue("");
             } 
        }
    };		
	/*--user code end--*/
...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addHousePurInfoRecord.do" method="POST">
		...
		<emp:gridLayout id="HousePurInfoGroup" title="厂房按揭购置信息" maxColumn="2">
			...
			<emp:text id="HousePurInfo.fst_pyr_perc" label="首付款比例" onchange="checkFistPerc(value)" maxlength="10" required="false" dataType="Percent" />
