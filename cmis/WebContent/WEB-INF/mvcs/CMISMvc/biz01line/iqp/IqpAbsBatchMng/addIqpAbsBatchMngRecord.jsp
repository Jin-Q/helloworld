...
<body class="page_content">
	<emp:form id="submitForm" action="addIqpAbsBatchMngRecord.do" method="POST">
		
		<emp:gridLayout id="IqpAbsBatchMngGroup" title="新增证券化资产批次信息" maxColumn="2">
			<emp:text id="IqpAbsBatchMng.batch_name" label="证券化批次名称" maxlength="80" required="true" colSpan="2"/>
			...
			<emp:text id="IqpAbsBatchMng.batch_no" label="批次号" maxlength="18" required="false" hidden="true"/>
		</emp:gridLayout>
