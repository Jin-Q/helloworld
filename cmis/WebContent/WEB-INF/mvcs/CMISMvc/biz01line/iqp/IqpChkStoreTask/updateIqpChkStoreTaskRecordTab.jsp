	...
	<emp:form id="submitForm" action="updateIqpChkStoreTaskRecordRecord.do" method="POST">
		<table width="100%" align="center" border="1" class="searchTb">
			...
			<tr height="21">
				...
				<td colspan="3">抽查比例:<emp:text id="IqpChkStoreTaskRecord.check_rate" label="抽查比例" cssElementClass="emp_field_text_input2" required="false" dataType="Percent" readonly="true"/></td>
				<td></td>
			</tr>
			<tr height="21">
