...
<body class="page_content" onload="onload()">
	...
	<emp:form id="submitForm" action="updateIqpAppendTermsRecord.do?serno=${context.serno}&modiflg=${context.modiflg}&modify_rel_serno=${context.modify_rel_serno}" method="POST">
		<emp:gridLayout id="IqpAppendTermsGroup" maxColumn="2" title="费用信息">
			...
			<!--/**added by wangj 2015/05/12  需求编号:XD141222087,法人账户透支需求变更  end**/-->
			<emp:select id="IqpAppendTerms.is_cycle_chrg" label="是否周期性收费" required="true" onchange="checkIsCycleChrg()" colSpan="2" dictname="STD_ZX_YES_NO" />
