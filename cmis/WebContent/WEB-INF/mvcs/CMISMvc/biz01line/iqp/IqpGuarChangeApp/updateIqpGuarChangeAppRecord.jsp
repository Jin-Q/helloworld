...
<script type="text/javascript">
	...
	function doSubWfiFlow(){
			var serno = IqpGuarChangeApp.serno._getValue();    
			var cus_id = IqpGuarChangeApp.cus_id._getValue(); 
			var prd_id_displayname = IqpGuarChangeApp.prd_id_displayname._getValue(); 
			var cus_id_displayname = IqpGuarChangeApp.cus_id_displayname._getValue();
			var approve_status = IqpGuarChangeApp.approve_status._getValue(); 
			...
			WfiJoin.amt._setValue(IqpGuarChangeApp.cont_amt._getValue());
			initWFSubmit(false);	 
	};
	function onload(){
...
<body class="page_content" onload="onload()" onload="doview()">
	
	<emp:form id="submitForm" action="updateIqpGuarChangeAppRecord.do" method="POST">
	 <emp:tabGroup mainTab="base_tab" id="mainTab" > 
	   <emp:tab label="担保变更申请基本信息" id="base_tab" needFlush="true" initial="true" >  
		...
		<emp:gridLayout id="IqpGuarChangeAppGroup" title="担保修改信息" maxColumn="2">
			...
			<emp:select id="IqpGuarChangeApp.new_assure_main_details" label="修改后担保方式细分" required="true" readonly="true" dictname="STD_ZB_ASSUREDET_TYPE" />
