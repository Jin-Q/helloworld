...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpBuscontInfoRecord.do" method="POST">
		<emp:gridLayout id="IqpBuscontInfoGroup" maxColumn="2" title="贸易合同信息">
		<emp:text id="IqpBuscontInfo.tcont_no" label="贸易合同编号" maxlength="40" required="false" hidden="false" readonly="true" />
		...
		<div align="center">
			<br>
			<emp:button id="upRecord" label="保存"/>
