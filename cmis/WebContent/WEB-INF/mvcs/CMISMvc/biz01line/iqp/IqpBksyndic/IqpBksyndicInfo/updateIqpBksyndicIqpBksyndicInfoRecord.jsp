...
function checkRate(){
	...
	var pk1 = IqpBksyndicInfo.pk1._getValue();
	...
	var url = '<emp:url action="upCheckIqpBksyndicIqpBksyndicInfo.do"/>?serno='+serno+'&prtcpt_amt_rate='+amt_rate+'&pk1='+pk1;
...
<body class="page_content">
	<emp:form id="submitForm" action="updateIqpBksyndicIqpBksyndicInfoRecord.do" method="POST">
		<emp:gridLayout id="IqpBksyndicInfoGroup" title="银团信息" maxColumn="2">
			...
			<emp:select id="IqpBksyndicInfo.prtcpt_role" label="参与角色" required="true" dictname="STD_PART_ORG_TYPE"  readonly="true"/> 
