...
<body class="page_content">
	...
	<emp:gridLayout id="IqpExpInfoGroup" title="快递信息" maxColumn="2">
			...
			<emp:text id="IqpExpInfo.express_cprt" label="快递公司" maxlength="40" required="true" />
			<emp:text id="IqpExpInfo.invc_no" label="发票号" maxlength="80" required="true" />
			<emp:text id="IqpExpInfo.invc_amt" label="发票金额" maxlength="18" required="true" dataType="Currency" cssElementClass="emp_currency_text_readonly"/>
