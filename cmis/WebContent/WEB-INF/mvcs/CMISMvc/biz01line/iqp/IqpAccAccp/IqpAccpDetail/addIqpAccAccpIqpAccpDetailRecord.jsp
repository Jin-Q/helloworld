...
<%
    ...
    context.put("is_elec_bill",is_elec_bill);
%>
<emp:page>
<html>
<head>
...
<body class="page_content">
	<emp:form id="submitForm" action="addIqpAccAccpIqpAccpDetailRecord.do?is_elec_bill=${context.is_elec_bill}" method="POST">
		<emp:gridLayout id="IqpAccpDetailGroup" title="承兑汇票申请明细"  maxColumn="2">
			...
			<emp:text id="IqpAccpDetail.pk1" label="承兑汇票申请明细流水号" maxlength="40" readonly="true" hidden="true" required="false" />
		    <emp:text id="IqpAccpDetail.serno" label="业务编号" maxlength="40" hidden="true" required="true" />
		</emp:gridLayout>  
