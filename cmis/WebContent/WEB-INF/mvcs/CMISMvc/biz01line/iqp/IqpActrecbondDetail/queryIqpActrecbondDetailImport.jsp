...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importIqpActrecbondDetail.do?po_no=${param.po_no}&type=${param.type}'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：需以系统内提供的应收账款明细导入模板为模板，导入应收账款明细信息。）</td>
		</tr>
	 	</table>
	</form>	
</body>
