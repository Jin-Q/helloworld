...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpActrecbondDetailRecord.do" method="POST">
		<emp:gridLayout id="IqpActrecbondDetailGroup" title="应收账款明细" maxColumn="2">
			...
			<emp:text id="IqpActrecbondDetail.invc_no" label="权证号" maxlength="40" required="true" readonly="true"/>
			
			<emp:text id="IqpActrecbondDetail.invc_amt" label="权证金额" maxlength="18" required="true" dataType="Currency"/>
			<emp:text id="IqpActrecbondDetail.cont_no" label="贸易合同编号" maxlength="40" required="true" readonly="true"/>
