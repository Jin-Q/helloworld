...
<script type="text/javascript">
	...
	function reLoad(){
		var url = '<emp:url action="getIqpExtensionAppViewPage.do"/>?menuIdTab=iqp_extension_app&restrictUsed=false&serno=${context.IqpExtensionApp.serno}&op=view&hidden_button='+hidden_button;
		url = EMPTools.encodeURI(url);
		window.location = url;
	};
	/** 查看客户信息按钮begin **/
	...
	function ImageAction(image_action){
		var data = new Array();
		data['serno'] = IqpExtensionApp.serno._getValue();	//展期取原业务流水号
		data['cus_id'] = IqpExtensionApp.cus_id._getValue();	//客户码
		data['prd_id'] = IqpExtensionApp.prd_id._getValue();	//展期业务品种传：'IqpExtension'+原业务编号
