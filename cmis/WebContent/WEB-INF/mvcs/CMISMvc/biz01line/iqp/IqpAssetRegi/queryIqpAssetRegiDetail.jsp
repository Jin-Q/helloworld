...
<body class="page_content">
	...
	<emp:gridLayout id="IqpAssetRegiGroup" title="登记资产状况" maxColumn="2">
			<emp:text id="IqpAssetRegi.serno" label="业务编号" maxlength="40" required="true" />
			<emp:text id="IqpAssetRegi.bill_no" label="借据编号" maxlength="40" required="false" />
			<emp:select id="IqpAssetRegi.asset_status" label="资产状态" required="false" dictname="STD_ZB_ASSET_REGI_STATUS"/>
	</emp:gridLayout>
	<emp:gridLayout id="IqpAssetRegiAppGroup" title="资产登记信息" maxColumn="2">
			<emp:select id="IqpAssetRegiApp.regi_type" label="业务类别" required="true" dictname="STD_ZB_REGI_TYPE" readonly="true"/>
			<emp:pop id="IqpAssetRegiApp.bill_no" label="借据编号" url="AccViewPop.do?cusTypCondition=table_model in('AccLoan','AccPad') and status='1'&returnMethod=returnAcc" required="true" readonly="true"/>
