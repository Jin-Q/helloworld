...
<script type="text/javascript">
   ...
   function doSubmitWF(){
	...
	/** 保证金追加通知书打印 **/
	function doPrintRateChange(){
		var paramStr = IqpRateChangeAppList._obj.getParamStr(['serno']);
		if (paramStr != null) {
			var approve_status = IqpRateChangeAppList._obj.getParamValue(['approve_status']);
			if(approve_status == '997'){
				var url = '<emp:url action="getReportShowPage.do"/>&reportId=iqp/iqpRateChangeNotices.raq&'+paramStr;
				url = EMPTools.encodeURI(url);
...
<body class="page_content">
	...
	<div align="left">
		...
		<emp:button id="printRateChange" label="打印" op="print"/>
	</div>
