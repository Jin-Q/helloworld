...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpEquipInfoRecord.do" method="POST">
		
		<emp:gridLayout id="IqpEquipInfoGroup" title="设备信息" maxColumn="2">
			...
			<emp:text id="IqpEquipInfo.serno" label="业务编号" maxlength="40" defvalue="${context.serno}" required="false" hidden="true"/>
		</emp:gridLayout>
		<div align="center">
			<br>
