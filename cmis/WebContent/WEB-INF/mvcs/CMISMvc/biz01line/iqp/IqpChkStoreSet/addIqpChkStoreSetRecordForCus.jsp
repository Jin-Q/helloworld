...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpChkStoreSetRecord.do" method="POST">
		...
		<emp:gridLayout id="IqpChkStoreSetGroup" title="出质人" maxColumn="2">
			<emp:select id="IqpChkStoreSet.task_set_type" label="任务维度" required="true" readonly="true" defvalue="01" dictname="STD_ZB_INSURE_MODE"/>
			<emp:pop id="IqpChkStoreSet.cus_name" label="出质人" required="true" buttonLabel="选择" url="queryAllCusPop.do?returnMethod=returnCus&cusTypCondition=belg_line in ('BL100','BL200') and cus_status='20'" />
