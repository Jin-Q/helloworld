...
<body class="page_content" onload="getAuth()">
	 <emp:tabGroup mainTab="base_tab" id="mainTab" >
	   <emp:tab label="监管协议基本信息" id="base_tab" needFlush="true" initial="true" >
	   <emp:gridLayout id="IqpOverseeAgrGroup" title="监管协议" maxColumn="2">
			<emp:text id="IqpOverseeAgr.oversee_agr_no" label="监管协议号"  required="true" colSpan="2"/>
			...
			<emp:text id="IqpOverseeAgr.bail_acct" label="保证金账号" required="false" />
			<emp:text id="IqpOverseeAgr.bail_acct_name" label="保证金户名"  required="false" />		
			<emp:text id="IqpOverseeAgr.oversee_store" label="监管仓库" required="false" />
			<emp:select id="IqpOverseeAgr.insure_mode" label="投保方式" required="false" dictname="STD_ZB_INSURE_MODE" />
			<emp:text id="IqpOverseeAgr.vigi_line" label="警戒线"  required="false" dataType="Percent" cssElementClass="emp_currency_text_readonly"/>
			<emp:text id="IqpOverseeAgr.stor_line" label="平仓线" required="false" dataType="Percent" cssElementClass="emp_currency_text_readonly"/>
			<emp:text id="IqpOverseeAgr.froze_line" label="冻结线" required="false" dataType="Percent" colSpan="2" cssElementClass="emp_currency_text_readonly"/>
			<emp:select id="IqpOverseeAgr.oversee_mode" label="监管方式" required="false" dictname="STD_ZB_OVERSEE_TYPE" onblur="getAuth()"/>
			<emp:text id="IqpOverseeAgr.low_auth_value" label="最低核准价值"  required="false" dataType="Currency" cssElementClass="emp_currency_text_readonly"/>
			<emp:textarea id="IqpOverseeAgr.memo" label="备注"  required="false" colSpan="2" />			
			<emp:select id="IqpOverseeAgr.status" label="状态" required="false" dictname="STD_ZB_OVERAGR_STATUS" hidden="false"/>
			...
			<emp:text id="IqpOverseeAgr.input_id" label="登记人"  required="false" hidden="true"/>
			<emp:text id="IqpOverseeAgr.input_br_id" label="登记机构"  required="false" hidden="true"/>	
			...
			<emp:text id="IqpOverseeAgr.net_agr_no" label="网络协议编号"  hidden="true"/>
	</emp:gridLayout>
	 </emp:tab>
