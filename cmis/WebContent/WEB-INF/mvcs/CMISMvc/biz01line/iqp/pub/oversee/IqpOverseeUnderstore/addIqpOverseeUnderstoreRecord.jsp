...
<%
	...
	String oversee_org_id = request.getParameter("oversee_org_id");
%>
...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpOverseeUnderstoreRecord.do" method="POST">		
		<emp:gridLayout id="IqpOverseeUnderstoreGroup" title="下属仓库" maxColumn="2">
			...
			<emp:text id="IqpOverseeUnderstore.input_id" label="登记人" maxlength="32" required="false" hidden="true" defvalue="$currentUserId"/>
			<emp:text id="IqpOverseeUnderstore.input_br_id" label="登记机构" maxlength="32" required="false" hidden="true" defvalue="$organNo"/>
			<emp:date id="IqpOverseeUnderstore.input_date" label="登记日期" required="false" hidden="true" defvalue="$OPENDAY"/>
			<emp:text id="IqpOverseeUnderstore.serno" label="流水号" maxlength="32" required="false" hidden="true" defvalue="<%=serno%>"/>
			<emp:pop id="IqpOverseeUnderstore.store_addr" label="仓库地址" url="showDicTree.do?dicTreeTypeId=STD_GB_AREA_ALL" hidden="true"/>
			<emp:text id="IqpOverseeUnderstore.oversee_org_id" label="监管机构编号" maxlength="32" required="false" hidden="true" defvalue="<%=oversee_org_id%>"/>
		</emp:gridLayout>
