...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpCoreConNetRecord.do" method="POST">
		
		<emp:gridLayout id="IqpCoreConNetGroup" title="客户概况分析" maxColumn="2">
			<emp:text id="IqpCoreConNet.serno" label="业务编号" maxlength="32" hidden="true" />
			<emp:select id="IqpCoreConNet.app_type" label="申请类型"  dictname="STD_ZB_NET_APP_TYPE" defvalue="01" hidden="true"/>
		...
		<emp:gridLayout id="CoopGroup" title="业务合作方案" maxColumn="2">
			...
			<emp:select id="IqpCoreConNet.approve_status" label="申请状态" defvalue="000" dictname="WF_APP_STATUS" hidden="true" />
			<emp:select id="IqpCoreConNet.flow_type" label="流程类型" hidden="true" defvalue="${context.flow_type}" dictname="STD_ZB_FLOW_TYPE"/>
			<emp:text id="IqpCoreConNet.net_agr_no" label="网络协议编号" maxlength="32" hidden="true" />
		</emp:gridLayout>
		
		<div align="center">
			<br>
			<emp:button id="addIqpCoreConNet" label="确定" op="add"/>
