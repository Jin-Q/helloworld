...
<body class="page_content">			
   <emp:tabGroup mainTab="base_tab" id="mainTab" >
		...
		<emp:gridLayout id="LmtGroup" title="授信业务情况" maxColumn="2">
			...
			<emp:text id="IqpNetMagInfo.buyer_rebuy_amt" label="买方回购担保额度" maxlength="18" required="true" dataType="Currency" cssElementClass="emp_currency_text_readonly"/>
			<emp:text id="IqpNetMagInfo.fin_bail_perc" label="融资保证金比例" maxlength="10" required="true" dataType="Percent" cssElementClass="emp_currency_text_readonly"/>
			</emp:gridLayout>
