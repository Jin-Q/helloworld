...
<script type="text/javascript">
	...
	function doLoad(){
		var type='<%=type%>'
		if(type=='main'){
			IqpOverseeAssent.assent_type._setValue('01');
			...
			IqpOverseeAssent.assent_type._setValue('02');
...
<body class="page_content" onload="doLoad()">	
	<emp:form id="submitForm" action="addIqpOverseeAssentRecord.do" method="POST">		
		<emp:gridLayout id="IqpOverseeAssentGroup" title="资产明细" maxColumn="2">
			...
			<emp:text id="IqpOverseeAssent.serno" label="业务流水号" maxlength="32" required="false" hidden="true" defvalue="<%=serno%>"/>
		</emp:gridLayout>
