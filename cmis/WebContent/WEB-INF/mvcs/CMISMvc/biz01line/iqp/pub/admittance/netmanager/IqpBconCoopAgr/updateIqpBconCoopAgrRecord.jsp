...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updateIqpBconCoopAgrRecord.do" method="POST">
		<emp:gridLayout id="IqpBconCoopAgrGroup" maxColumn="2" title="银企合作协议">
			...
			<emp:pop id="IqpBconCoopAgr.psale_cont" label="年度购销合同" url="queryIqpPsaleContPop.do" returnMethod="setPsale" required="true"/>
