			...
			if(IqpAppPsaleCont._checkAll()){
				...
				var handleSuccess = function(o){
					if(o.responseText !== undefined) {
						...
						if(flag == "success"){
							alert("保存成功!");
							//var url = '<emp:url action="queryIqpAppPsaleContList.do"/>?serno=${context.serno}&mem_cus_id=${context.mem_cus_id}&mem_manuf_type=${context.mem_manuf_type}&cus_id=${context.cus_id}';                                                 
...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpAppPsaleContRecord.do" method="POST">
		<emp:gridLayout id="IqpAppPsaleContGroup" maxColumn="2" title="购销合同信息">
...
<emp:pop id="IqpAppPsaleCont.commo_name_displayname" label="商品名称" required="false" hidden="true" url="showCatalogManaTree.do?isMin=Y" returnMethod="setCatalogPath"/>
	...
	<emp:tabGroup id="IqpAppPsaleCont_tabs" mainTab="IqpAppPsaleContGood_tab">
		<emp:tab id="IqpAppPsaleContGood_tab" label="商品明细" url="queryIqpAppPsaleContGoodList.do" reqParams="op=${context.op}&psale_cont=${context.IqpAppPsaleCont.psale_cont}&serno=${context.IqpAppPsaleCont.serno}" initial="true"/>
	</emp:tabGroup>
