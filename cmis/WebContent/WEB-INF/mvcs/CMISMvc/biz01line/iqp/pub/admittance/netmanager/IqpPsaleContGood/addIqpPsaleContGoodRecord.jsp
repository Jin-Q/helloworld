...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpPsaleContGoodRecord.do" method="POST">
		
		<emp:gridLayout id="IqpPsaleContGoodGroup" title="购销合同商品结果表" maxColumn="2">
			<emp:text id="IqpPsaleContGood.psale_cont" label="购销合同编号" maxlength="40" required="true" />
			<emp:text id="IqpPsaleContGood.commo_name" label="商品名称" maxlength="100" required="true" />
