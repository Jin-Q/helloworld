...
<script type="text/javascript">
	...
	function getCusInfo4over(data){
	   IqpOverseeAgr.oversee_con_id._setValue(data.cus_id._getValue());
	   IqpOverseeAgr.oversee_con_id_displayname._setValue(data.cus_name._getValue());
	}
...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updateIqpOverseeAgrRecord.do" method="POST">
	  <emp:tabGroup mainTab="base_tab" id="mainTab" >
	   <emp:tab label="监管协议基本信息" id="base_tab" needFlush="true" initial="true" >
		<emp:gridLayout id="IqpOverseeAgrGroup" maxColumn="2" title="监管协议">
			<emp:text id="IqpOverseeAgr.oversee_agr_no" label="监管协议号" maxlength="32" required="true" colSpan="2" readonly="true"/>
			...
			<emp:select id="IqpOverseeAgr.status" label="状态" required="false" dictname="STD_ZB_OVERAGR_STATUS" hidden="false" readonly="true"/>
