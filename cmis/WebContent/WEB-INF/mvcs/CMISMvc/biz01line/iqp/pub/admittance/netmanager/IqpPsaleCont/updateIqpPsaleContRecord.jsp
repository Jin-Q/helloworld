...
<script type="text/javascript">
   ...
   function getCusInfo4barg(data){
	...
	function doReturn(){
		var buyer_cus_id=IqpPsaleCont.buyer_cus_id._getValue();
		var barg_cus_id=IqpPsaleCont.barg_cus_id._getValue();
	...
	if(start!=null && start !="" && end!=null && end !=""){
	 ...
	 function doUpdate(){
		if(IqpPsaleCont._checkAll()){
			...
			var net_agr_no=IqpPsaleCont.net_agr_no._getValue();
...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpPsaleContRecord.do" method="POST">
		<emp:gridLayout id="IqpPsaleContGroup" maxColumn="2" title="年度购销合同">
			...
			<emp:text id="IqpPsaleCont.qnt" label="购买商品数量" maxlength="16" required="true" />
			<emp:text id="IqpPsaleCont.unit_price" label="购买商品单价" maxlength="18" required="true" dataType="Currency" onblur="clcTotal()"/>
			<emp:text id="IqpPsaleCont.total" label="购买商品总价" maxlength="18" required="true" dataType="Currency" readonly="true" cssElementClass="emp_currency_text_readonly"/>
			...
			<emp:text id="IqpPsaleCont.psale_cont" label="购销合同码" maxlength="32" required="true" hidden="true"/>
		</emp:gridLayout>
