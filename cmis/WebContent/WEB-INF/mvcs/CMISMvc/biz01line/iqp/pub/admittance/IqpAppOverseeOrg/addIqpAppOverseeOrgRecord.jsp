...
<script type="text/javascript">
	...
	function doAddIqpAppOverseeOrg(){
		...
		if(IqpAppOverseeOrg._checkAll()){
			...
			var handleSuccess = function(o){
				if(o.responseText !== undefined) {
					...
					if(flag == "success"){
						alert("保存成功！");
						var url = '<emp:url action="getIqpAppOverseeOrgUpdatePage.do"/>&serno='+serno+"&op=update";
						url = EMPTools.encodeURI(url);
						window.location = url;
					}else {
						alert("保存失败！");
...
<body class="page_content" onload="doLoad()">
	<emp:form id="submitForm" action="addIqpAppOverseeOrgRecord.do" method="POST">
		...
		<div align="center">
			<br>
			<emp:button id="addIqpAppOverseeOrg" label="确定" op="add"/>
