...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpDepotAgrRecord.do" method="POST">
		...
		<emp:gridLayout id="IqpDepotAgrGroup" title="保兑仓协议" maxColumn="2">
			...
			<emp:pop id="IqpDepotAgr.psale_cont_no" label="购销合同" url="queryIqpPsaleContPop.do?net_agr_no=${context.net_agr_no}" returnMethod="setPsale" required="false" />
			...
			<emp:pop id="IqpDepotAgr.desgoods_plan_no" label="订货计划" url="queryIqpDesbuyPlanPop.do?net_agr_no=${context.net_agr_no}" returnMethod="setDesgood" required="false" />	
