...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importIqpBillDetail.do?batch_no=${param.batch_no}&bill_type=${param.bill_type}&biz_type=${param.biz_type}'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：需以系统内提供的转贴现转入模板为模板，导入转贴现转入信息。）</td>
		</tr>
	 	</table>
	</form>	
</body>
