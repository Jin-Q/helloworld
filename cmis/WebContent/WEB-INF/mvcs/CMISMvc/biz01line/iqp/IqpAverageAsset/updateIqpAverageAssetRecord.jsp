...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpAverageAssetRecord.do" method="POST">
		<emp:gridLayout id="IqpAverageAssetGroup" maxColumn="2" title="资产卖出表">
			<emp:text id="IqpAverageAsset.serno" label="业务流水号" maxlength="40" required="true" readonly="true" />
