...
<script type="text/javascript">
    ...
    function doSelect(){
		var data = IqpAverageAssetList._obj.getSelectedData();	
...
<body class="page_content">
	...
	<emp:table icollName="IqpAverageAssetList" pageMode="true" url="pageIqpAverageAssetPopQuery.do">
		...
		<emp:text id="table_model" label="业务类型名称" hidden="true"/>
