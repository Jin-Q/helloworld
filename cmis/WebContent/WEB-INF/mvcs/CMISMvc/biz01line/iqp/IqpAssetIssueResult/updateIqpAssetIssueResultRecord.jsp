...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpAssetIssueResultRecord.do" method="POST">
		<emp:gridLayout id="IqpAssetIssueResultGroup" maxColumn="2" title="发行信息">
			...
			<emp:date id="IqpAssetIssueResult.act_issue_date" label="实际发行首日" required="true" readonly="true" />
			<emp:date id="IqpAssetIssueResult.end_date" label="法定到期日" required="true" readonly="true" />
