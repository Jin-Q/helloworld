...
List<WFICommentVO> list = (List<WFICommentVO>)context.getDataValue("CreditWFICommentList");
int size = list.size();
...
window.onload = function() {
	//调整iframe高度
	parent.document.getElementById("advice_wf_three").style.height = document.body.scrollHeight;
}
