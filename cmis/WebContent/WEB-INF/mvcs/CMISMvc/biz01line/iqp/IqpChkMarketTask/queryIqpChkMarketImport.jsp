...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importIqpChkMarketTask.do'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：以盯市任务导出的excel为模板，导入未处理的盯市任务，批量进行价格调整。）</td>
		</tr>
	 	</table>
	</form>	
</body>
