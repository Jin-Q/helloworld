...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addIqpAssetOrgRecord.do" method="POST">
		
		<emp:gridLayout id="IqpAssetOrgGroup" title="参与机构信息" maxColumn="2">
			<emp:text id="IqpAssetOrg.asset_org_id" label="机构代码" maxlength="40" required="false" hidden="true"/>
