...
<script type="text/javascript">
	...
	function doSave(flg){
		...
		if(IqpTrustFeeInfo._checkAll()){
			...
			var url = '<emp:url action="updateIqpTrustFeeInfoRecord.do"/>';
			url = EMPTools.encodeURI(url);
	...
	/** add by lisj 2015-10-13 需求编号：XD150409029 信贷保函及资产模块改造需求 begin**/
	function doCalBaileePayAmt(flg){
...
<body class="page_content" onload="doOnLoad()">
	<emp:form id="submitForm" action="#" method="POST">
		<emp:gridLayout id="IqpTrustFeeInfoGroup" maxColumn="2" title="信托贷款费用信息">
			<emp:text id="IqpTrustFeeInfo.serno" label="业务流水号" maxlength="40" required="true" colSpan="2" readonly="true"/>
		...
		<div align="center">
		<br>
			<emp:button id="calBaileePayAmt" label="修改"/>
		</div>
	</emp:form>
</body>
</html>
