...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateIqpAssetTakeoverRecord.do" method="POST">
		<emp:gridLayout id="IqpAssetTakeoverGroup" maxColumn="2" title="资产转让">
			<emp:text id="IqpAssetTakeover.serno" label="业务编号" maxlength="40" required="true" readonly="true" />
