...
<script type="text/javascript">
	...
	function doTempAddFncStatBs(){
		...
		var action = '<emp:url action="tempAddFncStatBs.do"/>';
	...
	function doUpdateFncStatBs(){
		var form = document.getElementById('submitForm');
		var action = '<emp:url action="addOrupdateFncStatBs.do"/>';
    ...
    function doCheckButton(){
		...
		var param = "cus_id="+cus_id+"&stat_prd_style="+stat_prd_style+"&stat_prd="+stat_prd
		+"&fnc_conf_typ=01&stat_style="+stat_style+"&fnc_type="+fnc_type;
        
    	var stockURL = '<emp:url action="queryFncStatBsEdit.do"/>&'+param;
