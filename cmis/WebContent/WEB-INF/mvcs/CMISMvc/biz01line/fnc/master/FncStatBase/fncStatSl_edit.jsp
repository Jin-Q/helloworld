...
<script type="text/javascript"><!--
	...
	function getParam(){
		...
		"&fnc_conf_data_col="+fnc_conf_data_col+"&fnc_name="+fnc_name
		+"&style_id="+style_id+"&state_flg="+state_flg
	...
	function doTempAddFncStatSl(){
		...
		var action = '<emp:url action="tempAddFncStatSl.do"/>&'+param;
	...
	function doUpdateFncStatSl(){
		var param = getParam();
		var form = document.getElementById('submitForm');
		var action = '<emp:url action="addOrupdateFncStatSl.do"/>&'+param;
...
<body  class="page_content">
  <emp:form id="submitForm" action="" method="POST">  </emp:form>
	...
	<div align="center">
		<emp:button id="tempAddFncStatSl" label="暂存"/>&nbsp;&nbsp;
		<emp:button id="updateFncStatSl" label="完成"/>
	</div>
