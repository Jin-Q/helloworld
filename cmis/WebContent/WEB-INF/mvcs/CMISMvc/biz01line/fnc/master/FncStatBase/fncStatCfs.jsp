...
<script type="text/javascript">
	...
	function doOnLoad() {
		...
		//var tempFlg = flg.substring(0,2);//获得资产，损益表的状态,是否为22
	...
	function doUpdateFncStatCfs (){
		var form = document.getElementById('submitForm');
		var action = '<emp:url action="updateFncStatCfs.do"/>';
	...
	function doCheckButton(){
		...
		+"&fnc_conf_typ=03&stat_style="+stat_style+"&fnc_type="+fnc_type;
        
    	var stockURL = '<emp:url action="queryFncStatCfsEdit.do"/>&'+param;
