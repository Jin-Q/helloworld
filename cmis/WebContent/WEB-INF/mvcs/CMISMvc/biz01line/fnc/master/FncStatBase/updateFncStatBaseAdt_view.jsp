...
<body class="page_content" onload="doOnLoad()">
	...
	<div id="FncStatBaseGroup" class="emp_group_div">
		<emp:gridLayout id="FncStatBaseGroup" maxColumn="1" title="公司客户报表">
			...
			<emp:select id="FncStatBase.stat_is_audit" label="是否经过审计" required="true" readonly="true" dictname="STD_ZX_YES_NO"/>
			<emp:select id="FncStatBase.stat_is_adjt" label="是否经过调整" colSpan="2" required="true" dictname="STD_ZX_YES_NO" readonly="true"/>
			<emp:textarea id="FncStatBase.stat_adt_conc" label="审计结论" maxlength="200" colSpan="2" required="false" readonly="true"/>
			<emp:textarea id="FncStatBase.stat_adj_rsn" label="财务报表调整原因" maxlength="200" required="false" readonly="true"/>
			<emp:text id="FncStatBase.stat_adt_entr" label="审计单位" maxlength="60" colSpan="2"  required="false" readonly="true" cssElementClass="emp_field_text_input_0"/>
