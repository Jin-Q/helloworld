...
<body class="page_content" >
	<emp:tabGroup mainTab="mainInfo" id="养殖情况调查表">
		<emp:tab label="养殖情况调查表" id="mainInfo" >
	<emp:form id="submitForm" action="saveBreedInvestigation.do" method="POST">
	...
	<div class='emp_gridlayout_title'>
		<emp:label text="过去一年养殖情况" ></emp:label>
	</div>
	<emp:table icollName="MainInfoList" pageMode="false" url='' >
			...
			<emp:text id="mon_7" label="种类7" flat="false" />
	</emp:table>
	
	<br/>
	<div class='emp_gridlayout_title'>
		<emp:label text="主要养殖成本（元/只）"></emp:label>
	</div>
	...
	<br/>
	<div class='emp_gridlayout_title'>
		<emp:label text="未来一年预计养殖收入情况"></emp:label>
	</div>
	...
	<div align="center" >
		...
		<emp:tab id="docInfo" label="调查报告" url="rqReport/reportShowPage.jsp" reqParams="reportId=dcbg_wx_yzqk.raq&serno=$TableInfo.serno;&pageMark=no" initial="true" needFlush="true"/>	
	</emp:tabGroup>
</body>
</html>
</emp:page>
