...
<body  class="page_content" onload="doOnLoad()">
	<form id="submitForm" action="<emp:url action='addFncConfTemplateRecord.do'/>" method="POST">
	</form>

		<emp:gridLayout id="FncConfTemplateGroup" maxColumn="2" title="财务报表列表">
			<emp:text id="FncConfTemplate.fnc_id" label="报表编号" maxlength="6" required="true" dataType="CodeNo"/>
			...
			<emp:select id="FncConfTemplate.fnc_bs_style_id" label="资产负债表样式编号" required="false" />
			<emp:select id="FncConfTemplate.fnc_pl_style_id" label="损益表(收入支出总表)" required="false" />
			<emp:select id="FncConfTemplate.fnc_cf_style_id" label="现金流量(事业支出明细表)" required="false" />
	...
	<div align="center">
			<br>
		<emp:button id="addFncConfTemplate" label="保存" op="add"/>
