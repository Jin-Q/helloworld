...
<script type="text/javascript">
	...
	function doUpdateFncConfDefFormat() {
...
<body class="page_content" onload="doOnLoad()">
	<form id="submitForm" action="<empext:url url='updateFncConfDefFormatRecord.do'/>" method="POST">
	</form>
	<div id="FncConfDefFormatGroup" class="emp_group_div">
		<empext:gridLayout maxColumn="2" title="报表配置定义表">
			<empext:text id="FncConfDefFormat.style_id" label="报表样式编号" maxlen="6" required="true" readonly="true" />
			<empext:text id="FncConfDefFormat.item_id" label="项目编号" maxlen="9" required="true" readonly="true" />
	...
	<div align="center">
		<br>
		<empext:button id="updateFncConfDefFormat" label="保存" />
		<empext:button id="return" label="返回"/>
		<empext:button id="reset" label="重置"/>
	</div>
</body>
</html>
</empext:page>
