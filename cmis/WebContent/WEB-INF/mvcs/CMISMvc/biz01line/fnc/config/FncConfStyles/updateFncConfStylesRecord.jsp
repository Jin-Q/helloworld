...
<script type="text/javascript">
	...
	function doUpdateFncConfStyles() {
	...
	function selectDataCol(){
		var fnc_conf_typ = FncConfStyles.fnc_conf_typ._obj.element.value;
		var fnc_data_col=FncConfStyles.fnc_conf_data_col._obj.element.value;
		//alert("FncConfStyles.fnc_conf_data_col._obj.element.value="+FncConfStyles.fnc_conf_data_col._obj.element.value);
		var tmptId = FncConfStyles.fnc_conf_data_col._obj.element;	
		//alert("fnc_conf_typ="+fnc_conf_typ);
		var options = FncConfStyles.fnc_conf_data_col._obj.element.options;
		...
		for ( var i = options.length - 1; i >= 0; i--) {
			...
			//alert(tmptId.options[i].value+"***"+fnc_data_col);	
				if(tmptId.options[i].value==fnc_data_col){
					tmptId.options[i].selected=true;
				}
			}
...
<body class="page_content" onload="doOnLoad()">
	<emp:form id="submitForm" action="updateFncConfStylesRecord.do" method="POST">
	...
	<div align="center">
		<br>
		<emp:button id="updateFncConfStyles" label="保存" op="update"/>
