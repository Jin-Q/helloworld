...
<body  class="page_content" onload="doOnLoad()">
	<form id="submitForm" action="<emp:url action='addFncConfStylesRecord.do'/>" method="POST">
	</form>
	
		<div id="FncConfStylesGroup" class="emp_group_div">
		<emp:gridLayout id="FncConfStylesGroup" maxColumn="2" title="报表样式列表">
			<emp:text id="FncConfStyles.style_id" label="报表样式编号" maxlength="6" required="true" dataType="CodeNo"/>
			<emp:select id="FncConfStyles.fnc_conf_typ" label="所属报表种类" required="true" dictname="STD_ZB_FNC_TYP" onchange="selectFncName()"/>
			...
			<emp:select id="FncConfStyles.fnc_conf_data_col" label="数据列数" required="true"  />	
			...
			<!--emp:text id="FncConfStyles.fnc_conf_data_col" label="数据列数" maxlength="38" required="true" /-->
			<!--emp:text id="FncConfStyles.fnc_conf_cotes" label="栏位" maxlength="38" required="true" /-->
	...
	<div align="center">
			<br>
		<emp:button id="addFncConfStyles" label="保存" op="add"/>
