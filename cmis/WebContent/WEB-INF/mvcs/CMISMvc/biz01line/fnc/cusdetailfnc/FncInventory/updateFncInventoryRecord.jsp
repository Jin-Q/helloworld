...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateFncInventoryRecord.do" method="POST">
		<emp:gridLayout id="FncInventoryGroup" maxColumn="2" title="主要存货明细表">
			...
			<emp:text id="FncInventory.fnc_ym" label="年月" maxlength="6" required="true" onblur="checkZero(this.value)" />
