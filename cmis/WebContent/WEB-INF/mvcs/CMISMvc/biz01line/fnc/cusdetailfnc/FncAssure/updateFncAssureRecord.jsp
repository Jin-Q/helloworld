...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateFncAssureRecord.do" method="POST">
		<emp:gridLayout id="FncAssureGroup" maxColumn="2" title="主要对外担保及表外业务明细">
		<emp:pop id="FncAssure.cus_id" label="客户码" url="selectCusInfoPop.do?type=com"  readonly="true" returnMethod="returnCus" required="true" />
			<emp:text id="FncAssure.cus_name" label="客户名称" maxlength="80" required="true" readonly="true" />
			<emp:pop id="FncAssure.rel_cus_id" label="对方客户码" url="selectCusInfoPop.do?type=all" readonly="true" returnMethod="returnRelCus" required="true" />
			<emp:text id="FncAssure.rel_cus_name" label="对方客户名称" maxlength="60" readonly="true" required="true" />
