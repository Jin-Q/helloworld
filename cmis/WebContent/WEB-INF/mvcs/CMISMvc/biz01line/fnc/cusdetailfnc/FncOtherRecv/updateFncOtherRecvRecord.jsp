...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateFncOtherRecvRecord.do" method="POST">
		<emp:gridLayout id="FncOtherRecvGroup" maxColumn="2" title="其他应收款项明细">
			...
			<emp:text id="FncOtherRecv.fnc_sum_amt" label="应付款余额合计" maxlength="18" required="false" dataType="Currency" onchange="checkT()"/>
