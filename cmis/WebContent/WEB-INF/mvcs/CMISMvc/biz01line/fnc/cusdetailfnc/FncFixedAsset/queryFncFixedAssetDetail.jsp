...
<body class="page_content">
	...
	<emp:gridLayout id="FncFixedAssetGroup" title="主要固定资产明细表" maxColumn="2">
			<emp:pop id="FncFixedAsset.cus_id" label="客户码" url="selectCusInfoPop.do?type=com" returnMethod="returnCus" required="true" readonly="true" />
