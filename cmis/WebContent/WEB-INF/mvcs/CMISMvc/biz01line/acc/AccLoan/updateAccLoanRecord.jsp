...
<body class="page_content">
	<emp:form id="submitForm" action="updateAccLoanRecord.do" method="POST">
	 <emp:tabGroup mainTab="base_tab" id="mainTab" >
	  <emp:tab label="台账基本信息" id="base_tab" needFlush="true" initial="true" >
		<emp:gridLayout id="AccLoanGroup" maxColumn="2" title="台账基本信息">
			<emp:text id="AccLoan.serno" label="业务编号" maxlength="40" required="true" readonly="true" />
		...
		<emp:gridLayout id="AccLoanGroup" maxColumn="2" title="登记机构">	
