...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addAccPadRecord.do" method="POST">
		
		<emp:gridLayout id="AccPadGroup" title="垫款台帐" maxColumn="2">
			<emp:text id="AccPad.serno" label="业务编号" maxlength="40" required="true" />
