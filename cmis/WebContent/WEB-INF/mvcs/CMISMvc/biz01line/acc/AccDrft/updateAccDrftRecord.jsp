...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateAccDrftRecord.do" method="POST">
		<emp:gridLayout id="AccDrftGroup" maxColumn="2" title="票据流水台帐">
			<emp:text id="AccDrft.serno" label="业务编号" maxlength="40" required="true" readonly="true" />
