...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateAccAccpRecord.do" method="POST">
		<emp:gridLayout id="AccAccpGroup" maxColumn="2" title="银承台帐">
			<emp:text id="AccAccp.serno" label="业务编号" maxlength="40" required="true" readonly="true" />
