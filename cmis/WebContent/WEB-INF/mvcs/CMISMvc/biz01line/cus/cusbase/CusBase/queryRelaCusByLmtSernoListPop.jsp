...
<body class="page_content">
	...
	<emp:table icollName="CusBaseList" pageMode="true" url="pageRelaCusByLmtSernoQuery.do?lmt_serno=${context.lmt_serno}">
		...
		<emp:select id="cus_attr" label="客户属性" dictname="STD_ZB_CUS_ATTR" />
	</emp:table>
	<div align="left">
			<br>
