...
<body class="page_content">
	<emp:form id="submitForm" action="addCusHandoverCfgCusHandoverDetailRecord.do" method="POST">
		<emp:gridLayout id="CusHandoverDetailGroup" title="客户移交配置信息表" maxColumn="2">
			...
			<emp:text id="CusHandoverDetail.sub_serno" label="主键" maxlength="40" readonly="true" required="false" hidden="true"/>
