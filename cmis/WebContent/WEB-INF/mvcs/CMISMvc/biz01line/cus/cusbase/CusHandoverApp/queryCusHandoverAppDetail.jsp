	...
	<emp:tab label="客户移交" id="tab1" needFlush="true" initial="true">
		<emp:form id="submitForm" action="addCusHandoverAppRecord.do" method="POST">
			...
			<emp:gridLayout id="CusHandoverAppGroup" title="客户移交申请" maxColumn="2">
				<emp:text id="CusHandoverApp.serno" label="申请流水号" maxlength="40" required="true" colSpan="2" />
				<emp:select id="CusHandoverApp.org_type" label="接收机构与移出机构关系"
					required="true" dictname="STD_ZB_ORG_TYPE" colSpan="2" onblur="CheakOrgType()" />
				<emp:select id="CusHandoverApp.handover_scope" label="移交范围" required="true" dictname="STD_ZB_HAND_SCOPE" />
				<emp:select id="CusHandoverApp.handover_mode" label="移交方式" required="true" dictname="STD_ZB_HAND_TYPE" />
				<emp:pop id="CusHandoverApp.area_code" label="区域编码" required="false" colSpan="2" hidden="true"
					url="showDicTree.do?dicTreeTypeId=STD_GB_T2260" returnMethod="onReturnStateCode" />
				<emp:text id="CusHandoverApp.area_name" label="区域名称" maxlength="100" required="false" hidden="true" colSpan="2" />
				...
				<emp:pop id="CusHandoverApp.supervise_br_id_displayname" label="监交机构" url="null" required="false" hidden="true" />
				<emp:pop id="CusHandoverApp.supervise_id_displayname" label="监交人" url="null" required="false" hidden="true" />
			...
			<emp:gridLayout id="CusHandoverAppGroup2" title="登记信息" maxColumn="2">
				...
				<emp:text id="CusHandoverApp.input_id_displayname" label="登记人"  required="true" defvalue="$currentUserId" />
				<emp:text id="CusHandoverApp.input_br_id_displayname" label="登记机构"  required="true" defvalue="$organNo" />
