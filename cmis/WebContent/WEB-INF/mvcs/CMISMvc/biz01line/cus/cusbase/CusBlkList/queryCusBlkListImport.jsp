...
<script type="text/javascript">
	...
	<form id="improtForm" name="improtForm" action="<emp:url action='importCusBlkListTask.do'/>"  method="POST" enctype="multipart/form-data">
		<table align="center">
		<br>
		<br>
		<br>
		...
		<table align="center">
		<tr>
			<td>(说明：需以系统内提供的共享客户导入模板为模板，导入共享客户信息。）</td>
		</tr>
	 	</table>
	</form>	
</body>
