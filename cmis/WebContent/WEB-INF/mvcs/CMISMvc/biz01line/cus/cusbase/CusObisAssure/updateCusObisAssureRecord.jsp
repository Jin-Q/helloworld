...
<script type="text/javascript">
	function doUpdateCusObisAssure() {
	...
	function doReturn() {
		var cus_id  =CusObisAssure.cus_id._obj.element.value;
...
<body class="page_content" onload="doOnLoad()">
	...
	<emp:form id="submitForm" action="updateCusObisAssureRecord.do" method="POST">
		<emp:gridLayout id="CusObisAssureGroup" maxColumn="2" title="他行交易－他行担保">
			<emp:text id="CusObisAssure.cus_id" label="客户码" maxlength="30" required="true" readonly="true" />
			...
			<emp:text id="CusObisAssure.input_id" label="登记人" maxlength="20" required="true" readonly="true" hidden="true"/>
			<emp:text id="CusObisAssure.input_br_id" label="登记机构" maxlength="20" required="true" readonly="true" hidden="true"/>
			<emp:date id="CusObisAssure.input_date" label="登记日期" required="true" readonly="true" hidden="true"/>
			<emp:text id="CusObisAssure.last_upd_id" label="更新人" maxlength="20" required="false" defvalue="$currentUserId" hidden="true"/>
			<emp:text id="CusObisAssure.last_upd_date" label="更新日期" maxlength="10" required="false" hidden="true" defvalue="$OPENDAY"/>
			<emp:textarea id="CusObisAssure.guar_detail" label="担保业务描述" maxlength="250" required="false" colSpan="2" hidden="false"/>
		</emp:gridLayout>
		
		<div align="center">
			<br>
			<emp:button id="updateCusObisAssure" label="保存" />
