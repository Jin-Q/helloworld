...
<script type="text/javascript">
	...
	function setUpOrgEst(data){
		CusSameOrg.up_org_no._setValue(data.same_org_no._getValue());
	}
...
<body class="page_content" onload="doOnLoad();">
	...
	<emp:form id="submitForm" action="updateCusSameOrgRecord.do" method="POST">
		...
		<%//	<emp:select id="CusSameOrg.same_org_type" label="同业机构类型" required="true" dictname="STD_ZB_INTER_BANK_ORG" /> %>
			...
			<emp:text id="CusSameOrg.com_ins_code" label="组织机构代码" maxlength="10" readonly="true" required="true" onchange="CheckComInsCode()"/>
			<emp:text id="CusSameOrg.swift_no" label="SWIFT编号" maxlength="35" readonly="true" required="false" />
			<emp:text id="CusSameOrg.same_org_no" label="同业机构(行)号" maxlength="40" readonly="true" required="true"/>
			<emp:text id="CusSameOrg.same_org_cnname" label="同业机构(行)名称" maxlength="100" required="true" colSpan="2" cssElementClass="emp_field_cus_addr_input" readonly="true"/>
			<emp:text id="CusSameOrg.same_org_enname" label="同业机构(行)英文名称" maxlength="40" required="false" colSpan="2" cssElementClass="emp_field_cus_addr_input" readonly="true"/>
			...
			<emp:select id="CusSameOrg.reg_cur_type" label="注册/开办资金币种" required="false" dictname="STD_ZX_CUR_TYPE" readonly="true"/>
			<emp:text id="CusSameOrg.reg_cap_amt" label="注册/开办资金(万元)" maxlength="18" required="false" dataType="Currency" onblur="checkCapAmt()"/>
			<emp:text id="CusSameOrg.paid_cap_amt" label="实际到位资金(万元)" maxlength="18" required="true" dataType="Currency" onblur="checkCapAmt()"/>
			<emp:text id="CusSameOrg.assets" label="总资产(万元)" maxlength="18" required="true" dataType="Currency"/>
		...
		<emp:gridLayout id="CusSameOrgGroup2" title="登记信息" maxColumn="2">	
			...
			<emp:text id="CusSameOrg.input_id_displayname" label="登记人"  required="false" defvalue="$loginusername" hidden="false" readonly="true"/>
			<emp:text id="CusSameOrg.input_br_id_displayname" label="登记机构" required="false" defvalue="$organName" hidden="false" readonly="true"/>
		...
		<div align="center">
			<br>
			<emp:button id="updateCusSameOrg" label="修改" op="update"/>
