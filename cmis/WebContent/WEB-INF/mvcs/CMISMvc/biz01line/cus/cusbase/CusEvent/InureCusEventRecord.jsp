...
<body class="page_content"  onload="doOnLoad()">
	...
	<emp:form id="submitForm" action="updateCusEventRecord.do" method="POST">
		<emp:gridLayout id="CusEventGroup" maxColumn="2" title="客户重大事件">
			...
			<emp:select id="CusEvent.event_classify" label="事件分类" required="true" dictname="STD_ZB_EVENT_KIND" colSpan="2"  readonly="true"/>
			...
			<emp:text id="CusEvent.event_amt" label="涉及金额(元)" maxlength="18" required="true" dataType="Currency"  readonly="true" cssElementClass="emp_currency_text_readonly"/>
			...
			<emp:text id="CusEvent.logout_date" label="注销日期" maxlength="10" required="false" readonly="true" hidden="true"/>
			<emp:textarea id="CusEvent.logout_reason" label="注销原因" maxlength="250" required="false" readonly="true" colSpan="2" hidden="true"/>
			...
			<emp:text id="CusEvent.input_date" label="登记日期" required="true"  readonly="true" hidden="true"/>
			...
			<emp:text id="CusEvent.logout_id" label="注销人" maxlength="20" required="false" readonly="true" hidden="true"/>
			<emp:text id="CusEvent.logout_br_id" label="注销机构" maxlength="20" required="false" readonly="true" hidden="true"/>
		</emp:gridLayout>
		
		<div align="center">
			<br>
			<emp:button id="updateCusEvent" label="生效" op="update"/>
