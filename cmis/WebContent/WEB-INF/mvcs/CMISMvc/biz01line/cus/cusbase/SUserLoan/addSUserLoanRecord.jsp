...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addSUserLoanRecord.do" method="POST">
		
		<emp:gridLayout id="SUserLoanGroup" title="S_USER" maxColumn="2">
			<emp:text id="SUserLoan.actorno" label="用户码" maxlength="8" required="true" />
