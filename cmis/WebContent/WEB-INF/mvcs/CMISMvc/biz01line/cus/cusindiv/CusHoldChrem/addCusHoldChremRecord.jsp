			...
			if(o.responseText !== undefined) {
				...
				if(flag=="success"){
					if(confirm("增加成功！是否继续操作？")){
						...
						var url = '<emp:url action="getCusHoldChremAddPage.do"/>&'+paramStr;
...
<body class="page_content">
	<emp:form id="submitForm" action="addCusHoldChremRecord.do" method="POST">
		<emp:gridLayout id="CusHoldChremGroup" title="理财基本信息" maxColumn="2">
			...
			<emp:select id="CusHoldChrem.chrem_type" label="理财类型" required="false" dictname="STD_CHREM_TYPE"/>
			...
			<emp:text id="CusHoldChrem.expect_income_rate" label="预期收益率" maxlength="16" required="true" dataType="Percent" />
		</emp:gridLayout>
		...
		<div align="center">
			<br>
			<emp:button id="addHoldChrem" label="保 存"/>
