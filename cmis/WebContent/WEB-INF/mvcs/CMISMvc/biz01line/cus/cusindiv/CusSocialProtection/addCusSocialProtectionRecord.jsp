...
<script type="text/javascript">
	/*--user code begin--*/
	function doAddCusSocialProtection(){
			...
			if(o.responseText !== undefined) {
				...
				if(flag=="success"){
					if(confirm("增加成功！是否继续操作？")){
						...
						var url = '<emp:url action="getCusSocialProtectionAddPage.do"/>&'+paramStr;
						url = EMPTools.encodeURI(url);
						window.location = url;
				     }else goback();
				}else if(flag=="exists"){
				 	alert("存在【公积金账号】和【单位公积金账号】的数据,新增失败！");
...
<body class="page_content">
	<emp:form id="submitForm" action="addCusSocialProtectionRecord.do" method="POST">
		...
		<div align="center">
			<br>
			<emp:button id="addCusSocialProtection" label="保存"/>
