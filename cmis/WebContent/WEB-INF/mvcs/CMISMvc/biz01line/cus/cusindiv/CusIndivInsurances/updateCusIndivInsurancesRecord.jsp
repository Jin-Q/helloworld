...
<body class="page_content">
	<emp:form id="submitForm" action="updateCusIndivInsurancesRecord.do" method="POST">
		<emp:gridLayout id="CusIndivInsuGroup" maxColumn="2" title="持有保险信息">
			<emp:text id="CusIndivInsu.cus_id" label="客户码" maxlength="30" required="true" readonly="true" />
			<emp:text id="CusIndivInsu.indiv_ins_id" label="保险编号" maxlength="40" required="true" readonly="true" hidden="true"/>
			...
			<emp:text id="CusIndivInsu.input_id_displayname" label="登记人"  required="false" hidden="true"/>
			<emp:text id="CusIndivInsu.input_br_id_displayname" label="登记机构" required="false" hidden="true"/>
			<emp:date id="CusIndivInsu.input_date" label="登记日期" required="false" readonly="true" hidden="true"/>
			<emp:text id="CusIndivInsu.last_upd_id_displayname" label="更新人"  hidden="true" defvalue="$currentUserId"/>
			<emp:date id="CusIndivInsu.last_upd_date" label="更新日期" hidden="true" defvalue="$OPENDAY"/>
            ...
            <emp:text id="CusIndivInsu.last_upd_id" label="更新人" maxlength="20" required="false" defvalue="$currentUserId" hidden="true"/>
		</emp:gridLayout>
		<div align="center">
			<br>
			<emp:button id="updateCusIndivInsu" label="保存"/>
