			...
			if(o.responseText !== undefined) {
				...
				if(flag=="success"){
					if(confirm("增加成功！是否继续操作？")){
						...
						var url = '<emp:url action="getCusHoldFundAddPage.do"/>&'+paramStr;
...
<body class="page_content">
	<emp:form id="submitForm" action="addCusHoldFundRecord.do" method="POST">
		<emp:gridLayout id="CusHoldFundGroup" title="持有基金信息" maxColumn="2">
			...
			<emp:select id="CusHoldFund.fund_type" label="理财类型" required="true" dictname="STD_FUND_TYPE" defvalue="01"/>
		...
		<emp:gridLayout id="CusHoldFundGroup1" title="登记信息" maxColumn="2">
		...
		<div align="center">
			<br>
			<emp:button id="addHoldFund" label="保存"/>
