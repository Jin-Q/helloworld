...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addCusIndivBusinessRecord.do" method="POST">
		...
		<emp:gridLayout id="CusIndivBusinessGroup" title="经营信息" maxColumn="2">
			...
			<emp:text id="CusIndivBusiness.reg_fund" label="注册资金" dataType="Currency" maxlength="18" required="false" onblur="checkFunds()"/>
			<emp:text id="CusIndivBusiness.paid_in_capt" label="实收资本金" dataType="Currency" maxlength="18" required="false" onblur="checkFunds()"/>
			...
			<emp:text id="CusIndivBusiness.org_code" label="组织机构代码" maxlength="40" required="false" onblur="checkCertCode()"/>
			...
			<emp:text id="CusIndivBusiness.phone" label="电话" maxlength="20" required="false" dataType="Phone"/>
