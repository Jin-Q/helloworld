...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addCusOrgInfoMngRecord.do" method="POST">
		<emp:gridLayout id="CusOrgInfoMngGroup" title="评估机构分部信息" maxColumn="2">
			...
			<emp:text id="CusOrgInfoMng.cus_id" label="客户码" maxlength="30" required="true" readonly="true" defvalue="<%=cus_id%>" hidden="true"/>
		...
		<div align="center">
			<br>
			<emp:button id="addCusOrgInfoMng" label="确定"/>
