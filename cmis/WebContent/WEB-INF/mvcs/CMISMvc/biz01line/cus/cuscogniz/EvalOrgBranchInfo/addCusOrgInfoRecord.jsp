...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addCusOrgInfoRecord.do" method="POST">
		...
		<emp:gridLayout id="CusOrgInfoGroup" title="评估机构分部信息" maxColumn="2">
			...
			<emp:text id="CusOrgInfo.app_serno" label="申请表关联流水号" maxlength="40" required="false" hidden="true" defvalue="<%=app_serno%>" />
			<emp:text id="CusOrgInfo.cus_id" label="客户码" maxlength="30" required="true" defvalue="<%=cus_id%>" readonly="true" hidden="true"/>
