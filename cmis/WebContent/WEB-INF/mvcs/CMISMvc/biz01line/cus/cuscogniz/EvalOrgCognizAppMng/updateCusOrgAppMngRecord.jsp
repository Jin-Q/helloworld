...
/**add by lisj 2014-12-15 需求：【XD140918061】新增评估机构管理修改功能 begin**/
	function doOnload(){
	...
	function onReturnRegStateCode(date){
		CusOrgAppMng.extr_eval_addr._obj.element.value=date.id;
		CusOrgAppMng.extr_eval_addr_displayname._obj.element.value=date.label;
	};
	function getOrgID(data){
		CusOrgAppMng.manager_br_id._setValue(data.organno._getValue());
		CusOrgAppMng.manager_br_id_displayname._setValue(data.organname._getValue());
	};
	
	function setconId(data){
		CusOrgAppMng.manager_id_displayname._setValue(data.actorname._getValue());
		CusOrgAppMng.manager_id._setValue(data.actorno._getValue());
		CusOrgAppMng.manager_br_id._setValue(data.orgid._getValue());
		CusOrgAppMng.manager_br_id_displayname._setValue(data.orgid_displayname._getValue());
	};
	...
	/**add by lisj 2014-12-15 需求：【XD140918061】新增评估机构管理修改功能 end**/
</script>
</head>
<body class="page_content" onload="doOnload()">	
 <emp:form id="submitForm" action="updateCusOrgAppMngRecord.do" method="POST">
	<emp:tabGroup id="LmtApp_tabs" mainTab="pro_tab" >
	<emp:tab id="pro_tab" label="评估机构信息" initial="true"  >
	<emp:gridLayout id="CusOrgAppMngGroup" title="评估机构认定" maxColumn="2">
			<emp:text id="CusOrgAppMng.cus_id" label="评估机构客户码" required="true" readonly="true" maxlength="40" colSpan="2" />
			...
			<emp:text id="CusOrgAppMng.extr_eval_org" label="评估机构组织机构代码" maxlength="30" required="true"/>
