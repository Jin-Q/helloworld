...
<body class="page_content">
	...
	<emp:gridLayout id="CusComAccGroup" title="输入查询条件" maxColumn="2">
		<emp:text id="CusComAcc.cus_name" label="客户名称" />
		<emp:text id="CusComAcc.acc_name" label="结算账户名称" />
	</emp:gridLayout>
	<jsp:include page="/queryInclude.jsp" flush="true" />
	
   <button onclick="doSelect()">选取返回</button>
	<emp:table icollName="CusComAccList" pageMode="true" url="pageCusComAccAllQuery.do" reqParams="">
