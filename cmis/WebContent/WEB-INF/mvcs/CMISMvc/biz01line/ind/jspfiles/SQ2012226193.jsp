...
var item;
		...
		if(!judgeRadioChecked(item)){
			...
			return false;
						...
						item=document.getElementsByName('G2013203943.ST001$ST00110');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
		...
		if(!judgeRadioChecked(item)){
			...
			item=document.getElementsByName('G2013203942.ST003$ST00307');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
				
			item=document.getElementsByName('G2012203835.ST003$ST00301');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
				item=document.getElementsByName('G2012203835.ST002$ST00227');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
				item=document.getElementsByName('G2012203835.ST002$ST00228');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
				item=document.getElementsByName('G2012203835.ST002$ST00229');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
				item=document.getElementsByName('G2012203835.ST001$ST00126');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
			item=document.getElementsByName('G2012203825.ST009$ST00918');
		if(!judgeRadioChecked(item)){
			alert("");
			return false;
		}
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2013203943" groupName="偿债能力" seqno="3">
    			<ind:IndItemText indexNo="ST003$ST00308" indexName="速动比率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203834" groupName="盈利能力" seqno="5">
    			<ind:IndItemText indexNo="ST003$ST00306" indexName="销售利润率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2013203942" groupName="发展能力" seqno="7">
				<ind:IndItemRadio indexNo="ST003$ST00307" indexName="纳税增长率" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203835" groupName="管理水平" seqno="8">
				<ind:IndItemRadio indexNo="ST003$ST00301" indexName="地理环境、购物环境及销售渠道" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="位置在繁华商业区且购物环境好或供货、销货渠道稳定"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="位置在一般商业区但经营有特色或位置不在商业区但有稳定的客户群"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="位置不在商业区且购物环境差"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="不得分"/>
	    			</ind:IndItemRadio>
