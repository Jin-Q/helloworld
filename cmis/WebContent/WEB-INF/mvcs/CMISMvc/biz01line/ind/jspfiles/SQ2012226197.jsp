...
//检验组信用历史的指标
	...
	//检验组规模实力的指标
				item=document.getElementsByName('G2012203852.ST008$ST00802');
		if(!judgeRadioChecked(item)){
			alert("指标[净利润纳税比率]未选择，请选择后提交。");
			return false;
		}
				//检验组偿债能力的指标
			item=document.getElementsByName('G2012203853.ST001$ST00110');
		if(!judgeRadioChecked(item)){
	...
	//检验组盈利能力的指标
			//检验组营运能力的指标
			//检验组发展能力的指标
			item=document.getElementsByName('G2012203855.ST001$ST00125');
		if(!judgeRadioChecked(item)){
			alert("指标[纳税增长率]未选择，请选择后提交。");
			return false;
		}
				//检验组管理水平的指标
			item=document.getElementsByName('G2013203956.ST002$ST00227');
		if(!judgeRadioChecked(item)){
			alert("指标[公司组织结构情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2013203956.ST002$ST00228');
		if(!judgeRadioChecked(item)){
			alert("指标[公司内部制度建设、制度实施情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2013203956.ST002$ST00230');
		if(!judgeRadioChecked(item)){
			alert("指标[技术装备情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2013203956.ST001$ST00126');
		if(!judgeRadioChecked(item)){
			alert("指标[企业生产管理现场情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2013203956.ST008$ST00814');
		if(!judgeRadioChecked(item)){
			alert("指标[公司员工情况]未选择，请选择后提交。");
			return false;
		}
	//检验组综合评价的指标
			item=document.getElementsByName('G2012203856.ST009$ST00918');
		if(!judgeRadioChecked(item)){
			alert("指标[合作情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203856.ST002$ST00231');
		if(!judgeRadioChecked(item)){
			alert("指标[领导者素质]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203856.ST008$ST00811');
		if(!judgeRadioChecked(item)){
			alert("指标[国家行业政策]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203856.ST008$ST00813');
		if(!judgeRadioChecked(item)){
			alert("指标[生产经营期限]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203856.ST008$ST00815');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺情况]未选择，请选择后提交。");
			return false;
		}
	//检验组修正/调整项的指标
			item=document.getElementsByName('G2012203857.ST002$ST00237');
		if(!judgeRadioChecked(item)){
			alert("指标[是否多营业执照经营]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203857.ST002$ST00238');
		if(!judgeRadioChecked(item)){
			alert("指标[财务报表是否经过会计事务所审计]未选择，请选择后提交。");
			return false;
		}
					item=document.getElementsByName('G2012203857.ST008$ST00812');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203852" groupName="规模实力" seqno="2">
    			<ind:IndItemText indexNo="ST008$ST00801" indexName="销售收入(万元)" readonly="false" />
	

				<ind:IndItemRadio indexNo="ST008$ST00802" indexName="净利润纳税比率" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="10%(含）以上"/>
	    						...
	    						<ind:IndItemRadioOption indValue="4" indDesc="3%以下"/>
	    						<ind:IndItemRadioOption indValue="5" indDesc="不得分"/>
	    			</ind:IndItemRadio>


    			<ind:IndItemText indexNo="ST008$ST00817" indexName="纳税总额(万元)" readonly="false" />
	

    			<ind:IndItemText indexNo="ST008$ST00819" indexName="利润总额(万元)" readonly="false" />
	

    			<ind:IndItemText indexNo="ST008$ST00820" indexName="实有净资产(万元)" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2012203853" groupName="偿债能力" seqno="3">
    			...
    			<ind:IndItemText indexNo="ST008$ST00803" indexName="流动比率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00804" indexName="速动比率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00805" indexName="利息保障倍数" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00816" indexName="资产负债率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203854" groupName="营运能力" seqno="6">
    			<ind:IndItemText indexNo="ST002$ST00221" indexName="总资产周转率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00806" indexName="存货周转率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00807" indexName="应收账款周转率" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2012203855" groupName="发展能力" seqno="7">
				<ind:IndItemRadio indexNo="ST001$ST00125" indexName="纳税增长率" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="高于15%（含）"/>
	    						...
	    						<ind:IndItemRadioOption indValue="3" indDesc="0（含）-5%"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="低于0"/>
	    						<ind:IndItemRadioOption indValue="5" indDesc="不得分"/>
	    			</ind:IndItemRadio>


    			<ind:IndItemText indexNo="ST008$ST00808" indexName="销售收入增长率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00809" indexName="净利润增长率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST008$ST00810" indexName="净资产增长率" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2013203956" groupName="管理水平" seqno="8">
				...
				<ind:IndItemRadio indexNo="ST001$ST00126" indexName="企业生产管理现场情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="各项均表现良好"/>
				...
				<ind:IndItemRadio indexNo="ST008$ST00814" indexName="公司员工情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="各项均表现良好"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="有2项以上表现良好"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="表现一般"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="不得分"/>
	...
	<ind:IndGroup groupNo="G2012203856" groupName="综合评价" seqno="9">
				...
				<ind:IndItemRadio indexNo="ST008$ST00811" indexName="国家行业政策" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="国家相关政策扶持支持该行业"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="无相关政策措施"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="有相关抑制政策或措施"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="不得分"/>
	    			</ind:IndItemRadio>


				<ind:IndItemRadio indexNo="ST008$ST00813" indexName="生产经营期限" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST008$ST00815" indexName="经营的厂房、土地、店铺情况" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203857" groupName="修正/调整项" seqno="10">
				...
				<ind:IndItemRadio indexNo="ST008$ST00812" indexName="品牌情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="具有全国性品牌（如工商局认定的驰名商标，中国名牌、中国免检商品等）及其以上"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="获得地区性品牌（如省级名牌）或中华老字号称号"/>
