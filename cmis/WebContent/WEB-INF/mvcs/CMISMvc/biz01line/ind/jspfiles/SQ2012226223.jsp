...
//检验组股东的指标
	...
	//检验组发展前景的指标
			item=document.getElementsByName('G2012203916.ST011$ST01108');
		if(!judgeRadioChecked(item)){
			alert("指标[行业投向]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203916.ST019$ST01901');
		if(!judgeRadioChecked(item)){
			alert("指标[购销渠道]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203916.ST019$ST01902');
		if(!judgeRadioChecked(item)){
			alert("指标[地理环境]未选择，请选择后提交。");
			return false;
		}
	//检验组实际资产的指标
		//检验组其它可加减分因素的指标
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203916" groupName="发展前景" seqno="4">
				...
				<ind:IndItemRadio indexNo="ST019$ST01901" indexName="购销渠道" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="获得某一畅销知名品牌、紧缺物质的地区总代理、专营权，且销售资格期限可以超过我行授信期限半年以上"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="购销都很有保障"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="单方面很有保障"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="购销渠道保障一般"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="无保障"/>
	    						<ind:IndItemRadioOption indValue="5" indDesc="不得分"/>
	    			</ind:IndItemRadio>


				<ind:IndItemRadio indexNo="ST019$ST01902" indexName="地理环境" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="零售业：适名度高、地处闹市区"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="零售业：知名度高、地段一般"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="零售业：知名度一般、地段一般"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="零售业：知识度一般、位置较为偏僻"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="批发业：主营产品具有良好成长性低风险、且市场极为畅销利润空间较大"/>
	    						<ind:IndItemRadioOption indValue="5" indDesc="批发业：市场畅销程度一般、利润空间稳定"/>
	    						<ind:IndItemRadioOption indValue="6" indDesc="批发业：产品风险较高、滞销产品或者利润空间较小"/>
	    						<ind:IndItemRadioOption indValue="7" indDesc="不得分"/>
	    			</ind:IndItemRadio>
