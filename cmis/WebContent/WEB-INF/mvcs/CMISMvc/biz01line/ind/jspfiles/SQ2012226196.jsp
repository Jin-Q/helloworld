...
//检验组信用历史的指标
	...
	//检验组规模实力的指标
					item=document.getElementsByName('G2012203847.ST002$ST00208');
		if(!judgeRadioChecked(item)){
	...
	//检验组管理水平的指标
			item=document.getElementsByName('G2012203849.ST002$ST00227');
		if(!judgeRadioChecked(item)){
			alert("指标[公司组织结构情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203849.ST002$ST00228');
		if(!judgeRadioChecked(item)){
			alert("指标[公司内部制度建设、制度实施情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203849.ST002$ST00229');
		if(!judgeRadioChecked(item)){
			alert("指标[公司员工情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203849.ST002$ST00230');
		if(!judgeRadioChecked(item)){
			alert("指标[技术装备情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203849.ST006$ST00607');
		if(!judgeRadioChecked(item)){
			alert("指标[企业生产管理现场情况]未选择，请选择后提交。");
			return false;
		}
	//检验组综合评价的指标
			item=document.getElementsByName('G2012203850.ST021$ST02105');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺产权情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203850.ST002$ST00231');
		if(!judgeRadioChecked(item)){
			alert("指标[领导者素质]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203850.ST002$ST00235');
		if(!judgeRadioChecked(item)){
			alert("指标[生产经营期限]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203850.ST006$ST00608');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺面积情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203850.ST006$ST00611');
		if(!judgeRadioChecked(item)){
			alert("指标[合作情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203850.ST006$ST00612');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203847" groupName="规模实力" seqno="2">
    			...
    			<ind:IndItemText indexNo="ST006$ST00601" indexName="销售收入(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST006$ST00602" indexName="纳税总额(万元)" readonly="false" />
	...
	<ind:IndGroup groupNo="G2012203849" groupName="管理水平" seqno="8">
				...
				<ind:IndItemRadio indexNo="ST006$ST00607" indexName="企业生产管理现场情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="各项均表现良好"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="有2项以上表现良好"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="表现一般"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="制鞋生产企业开工率不足2条生产线"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="不得分"/>
	    			</ind:IndItemRadio>
	...
	<ind:IndGroup groupNo="G2012203850" groupName="综合评价" seqno="9">
				...
				<ind:IndItemRadio indexNo="ST006$ST00608" indexName="经营的厂房、土地、店铺面积情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="自有建筑面积在1万平方米（含）以上且产权完整"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="自有建筑面积在不足1万平方米或产权不完整"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="不得分"/>
	    			</ind:IndItemRadio>
