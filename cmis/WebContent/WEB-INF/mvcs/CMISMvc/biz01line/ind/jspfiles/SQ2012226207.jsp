...
var item;
//检验组信用历史的指标
			item=document.getElementsByName('G2012203871.ST010$ST01001');
		if(!judgeRadioChecked(item)){
			alert("指标[商业信用]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203871.ST001$ST00101');
		if(!judgeRadioChecked(item)){
			alert("指标[银行贷款资产状态（五级分类）]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203871.ST001$ST00103');
		if(!judgeRadioChecked(item)){
			alert("指标[个人信用（法人、实际负责人、主要股东）]未选择，请选择后提交。");
			return false;
		}
	//检验组规模实力的指标
						item=document.getElementsByName('G2012203873.ST001$ST00138');
		if(!judgeRadioChecked(item)){
			alert("指标[净利润纳税比率]未选择，请选择后提交。");
			return false;
		}
	//检验组偿债能力的指标
							item=document.getElementsByName('G2012203875.ST001$ST00110');
		if(!judgeRadioChecked(item)){
	...
	//检验组盈利能力的指标
			...
			//检验组发展能力的指标
			//检验组管理水平的指标
			item=document.getElementsByName('G2012203878.ST010$ST01010');
		if(!judgeRadioChecked(item)){
			alert("指标[股东背景]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203878.ST002$ST00227');
		if(!judgeRadioChecked(item)){
			alert("指标[公司组织结构情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203878.ST002$ST00228');
		if(!judgeRadioChecked(item)){
			alert("指标[公司内部制度建设、制度实施情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203878.ST001$ST00129');
		if(!judgeRadioChecked(item)){
			alert("指标[公司员工情况]未选择，请选择后提交。");
			return false;
		}
	//检验组综合评价的指标
			item=document.getElementsByName('G2012203879.ST010$ST01011');
		if(!judgeRadioChecked(item)){
			alert("指标[我行行业信贷政策导向]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203879.ST010$ST01012');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203879.ST010$ST01013');
		if(!judgeRadioChecked(item)){
			alert("指标[经营期限]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203879.ST009$ST00918');
		if(!judgeRadioChecked(item)){
			alert("指标[合作情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203879.ST002$ST00231');
		if(!judgeRadioChecked(item)){
			alert("指标[领导者素质]未选择，请选择后提交。");
			return false;
		}
	//检验组修正/调整项的指标
			item=document.getElementsByName('G2012203880.ST010$ST01014');
		if(!judgeRadioChecked(item)){
			alert("指标[行业地位]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203880.ST002$ST00237');
		if(!judgeRadioChecked(item)){
			alert("指标[是否多营业执照经营]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203880.ST002$ST00238');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203871" groupName="信用历史" seqno="1">
				<ind:IndItemRadio indexNo="ST010$ST01001" indexName="商业信用" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203873" groupName="规模实力" seqno="2">
    			<ind:IndItemText indexNo="ST010$ST01002" indexName="销售收入(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST010$ST01003" indexName="纳税总额(万元)" readonly="false" />
	

    			<ind:IndItemText indexNo="ST010$ST01004" indexName="实有净资产(万元)" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203875" groupName="偿债能力" seqno="3">
    			<ind:IndItemText indexNo="ST010$ST01005" indexName="速动比率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST010$ST01015" indexName="利息保障倍数" readonly="true" />
	

    			<ind:IndItemText indexNo="ST002$ST00210" indexName="流动比率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST001$ST00109" indexName="资产负债率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203876" groupName="盈利能力" seqno="5">
    			<ind:IndItemText indexNo="ST010$ST01006" indexName="总资产报酬率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST010$ST01007" indexName="销售利润率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST010$ST01008" indexName="净资产收益率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203877" groupName="发展能力" seqno="7">
    			<ind:IndItemText indexNo="ST010$ST01009" indexName="净资产增长率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST001$ST00122" indexName="销售收入增长率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST001$ST00123" indexName="净利润增长率" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2012203878" groupName="管理水平" seqno="8">
				<ind:IndItemRadio indexNo="ST010$ST01010" indexName="股东背景" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="中央级企业、上市公司、行业龙头企业"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="地市级以上（含）政府控投企业"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="民营企业及其他"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="主要股东有不良记录"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="不得分"/>
	    			</ind:IndItemRadio>
				...
				<ind:IndItemRadio indexNo="ST001$ST00129" indexName="公司员工情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="各项均表现良好"/>
	...
	<ind:IndGroup groupNo="G2012203879" groupName="综合评价" seqno="9">
				<ind:IndItemRadio indexNo="ST010$ST01011" indexName="我行行业信贷政策导向" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST010$ST01012" indexName="经营的厂房、土地、店铺情况" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST010$ST01013" indexName="经营期限" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203880" groupName="修正/调整项" seqno="10">
				<ind:IndItemRadio indexNo="ST010$ST01014" indexName="行业地位" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="省级（含）以上行业龙头企业"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="市级行业龙头企业"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="具有一定地区影响力，谈判地位主动、议价能力强"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="议价能力一般"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="无议价能力"/>
	    						<ind:IndItemRadioOption indValue="5" indDesc="不得分"/>
	    			</ind:IndItemRadio>
