...
//检验组信用历史的指标
	...
	//检验组规模实力的指标
							item=document.getElementsByName('G2012203919.ST002$ST00208');
		if(!judgeRadioChecked(item)){
	...
	//检验组现金流量的指标
		...
		//检验组盈利能力的指标
			//检验组营运能力的指标
			//检验组发展能力的指标
			item=document.getElementsByName('G2012203848.ST006$ST00603');
		if(!judgeRadioChecked(item)){
			alert("指标[销售收入增长率]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203848.ST006$ST00604');
		if(!judgeRadioChecked(item)){
			alert("指标[净利润增长率]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203848.ST006$ST00605');
		if(!judgeRadioChecked(item)){
			alert("指标[净资产增长率]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203848.ST006$ST00606');
		if(!judgeRadioChecked(item)){
			alert("指标[纳税增长率]未选择，请选择后提交。");
			return false;
		}
	//检验组管理水平的指标
			item=document.getElementsByName('G2012203920.ST021$ST02103');
		if(!judgeRadioChecked(item)){
			alert("指标[企业生产管理现场情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203920.ST002$ST00227');
		if(!judgeRadioChecked(item)){
			alert("指标[公司组织结构情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203920.ST002$ST00228');
		if(!judgeRadioChecked(item)){
			alert("指标[公司内部制度建设、制度实施情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203920.ST002$ST00229');
		if(!judgeRadioChecked(item)){
			alert("指标[公司员工情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203920.ST002$ST00230');
		if(!judgeRadioChecked(item)){
			alert("指标[技术装备情况]未选择，请选择后提交。");
			return false;
		}
	//检验组综合评价的指标
			item=document.getElementsByName('G2012203921.ST021$ST02104');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺面积情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203921.ST021$ST02105');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺产权情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203921.ST002$ST00231');
		if(!judgeRadioChecked(item)){
			alert("指标[领导者素质]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203921.ST002$ST00235');
		if(!judgeRadioChecked(item)){
			alert("指标[生产经营期限]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203921.ST006$ST00612');
		if(!judgeRadioChecked(item)){
			alert("指标[我行行业信贷政策导向]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203921.ST006$ST00611');
		if(!judgeRadioChecked(item)){
			alert("指标[合作情况]未选择，请选择后提交。");
			return false;
		}
	//检验组修正/调整项的指标
			item=document.getElementsByName('G2012203851.ST002$ST00236');
		if(!judgeRadioChecked(item)){
			alert("指标[品牌情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203851.ST002$ST00237');
		if(!judgeRadioChecked(item)){
			alert("指标[是否多营业执照经营]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203851.ST002$ST00238');
		if(!judgeRadioChecked(item)){
			alert("指标[财务报表是否经过会计事务所审计]未选择，请选择后提交。");
			return false;
		}
					item=document.getElementsByName('G2012203851.ST006$ST00610');
		if(!judgeRadioChecked(item)){
			alert("指标[授信总额度控制]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203851.ST006$ST00609');
		if(!judgeRadioChecked(item)){
			alert("指标[排污许可]未选择，请选择后提交。");
			return false;
		}
		return true;
}	
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203919" groupName="规模实力" seqno="2">
    			<ind:IndItemText indexNo="ST021$ST02102" indexName="纳税总额(万元)" readonly="false" />
	

    			<ind:IndItemText indexNo="ST021$ST02101" indexName="销售收入(万元)" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203848" groupName="发展能力" seqno="7">
				<ind:IndItemRadio indexNo="ST006$ST00603" indexName="销售收入增长率" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST006$ST00604" indexName="净利润增长率" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST006$ST00605" indexName="净资产增长率" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="高于20%（含）"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="15%（含）-20%"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="10%（含）-15%"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="5%（含）-10%"/>
				...
				<ind:IndItemRadio indexNo="ST006$ST00606" indexName="纳税增长率" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="高于15%（含）"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="12%（含）-15%"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="10%（含）-12%"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="7%（含）-10%"/>
	...
	<ind:IndGroup groupNo="G2012203920" groupName="管理水平" seqno="8">
				<ind:IndItemRadio indexNo="ST021$ST02103" indexName="企业生产管理现场情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="各项均表现良好"/>
	    						...
	    						<ind:IndItemRadioOption indValue="3" indDesc="鞋材生产企业开工率不足60%"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="不得分"/>
	    			</ind:IndItemRadio>
	...
	<ind:IndGroup groupNo="G2012203921" groupName="综合评价" seqno="9">
				<ind:IndItemRadio indexNo="ST021$ST02104" indexName="经营的厂房、土地、店铺面积情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="自有建筑面积在8000平方米（含）以上且产权完整"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="自有建筑面积在不足8000平方米或产权不完整"/>
	...
	<ind:IndGroup groupNo="G2012203851" groupName="修正/调整项" seqno="10">
				...
				<ind:IndItemRadio indexNo="ST006$ST00610" indexName="授信总额度控制" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="控制在60%（含）以下"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="控制在60%以上"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="不得分"/>
	    			</ind:IndItemRadio>


				<ind:IndItemRadio indexNo="ST006$ST00609" indexName="排污许可" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="有办理"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="未办理"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="不得分"/>
	    			</ind:IndItemRadio>
