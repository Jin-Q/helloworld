...
var item;
//检验组经营者素质与资信的指标
			item=document.getElementsByName('G2012203889.ST013$ST01301');
		if(!judgeRadioChecked(item)){
			alert("指标[从业经验]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203889.ST013$ST01302');
		if(!judgeRadioChecked(item)){
			alert("指标[经营者素质]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203889.ST013$ST01303');
		if(!judgeRadioChecked(item)){
			alert("指标[资产实力]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203889.ST013$ST01304');
		if(!judgeRadioChecked(item)){
			alert("指标[团队合作]未选择，请选择后提交。");
			return false;
		}
	//检验组经营发展状况的指标
				item=document.getElementsByName('G2012203890.ST013$ST01306');
		if(!judgeRadioChecked(item)){
			alert("指标[水/电/工资/纳税额增长率]未选择，请选择后提交。");
			return false;
		}
	//检验组生产经营情况的指标
			item=document.getElementsByName('G2012203894.ST018$ST01701');
		if(!judgeRadioChecked(item)){
			alert("指标[商品与品牌]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203894.ST018$ST01702');
		if(!judgeRadioChecked(item)){
			alert("指标[资金周转]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203894.ST018$ST01703');
		if(!judgeRadioChecked(item)){
			alert("指标[购销渠道]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203894.ST018$ST01704');
		if(!judgeRadioChecked(item)){
			alert("指标[经营场所]未选择，请选择后提交。");
			return false;
		}
	//检验组企业财务状况 的指标
					item=document.getElementsByName('G2012203892.ST013$ST01313');
		if(!judgeRadioChecked(item)){
			alert("指标[短期融资余额与销售收入比]未选择，请选择后提交。");
			return false;
		}
	//检验组信用状况的指标
			item=document.getElementsByName('G2012203893.ST013$ST01317');
		if(!judgeRadioChecked(item)){
			alert("指标[小微企业业主（或主要股东）信用]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203893.ST013$ST01318');
		if(!judgeRadioChecked(item)){
			alert("指标[企业银行信用]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203893.ST013$ST01319');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203889" groupName="经营者素质与资信" seqno="1">
				<ind:IndItemRadio indexNo="ST013$ST01301" indexName="从业经验" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01302" indexName="经营者素质" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01303" indexName="资产实力" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01304" indexName="团队合作" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203890" groupName="经营发展状况" seqno="2">
    			<ind:IndItemText indexNo="ST013$ST01305" indexName="销售收入增长率" readonly="true" />
	

				<ind:IndItemRadio indexNo="ST013$ST01306" indexName="水/电/工资/纳税额增长率" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203894" groupName="生产经营情况" seqno="3">
				<ind:IndItemRadio indexNo="ST018$ST01701" indexName="商品与品牌" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST018$ST01702" indexName="资金周转" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST018$ST01703" indexName="购销渠道" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST018$ST01704" indexName="经营场所" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="市经营服务设施先进齐备，地处同类商品服务集散地，客流量大"/>
	...
	<ind:IndGroup groupNo="G2012203892" groupName="企业财务状况 " seqno="4">
    			<ind:IndItemText indexNo="ST013$ST01311" indexName="资产负债率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST013$ST01312" indexName="利息保障倍数" readonly="true" />
	

				<ind:IndItemRadio indexNo="ST013$ST01313" indexName="短期融资余额与销售收入比" readonly="false">
	...
	<ind:IndGroup groupNo="G2012203893" groupName="信用状况" seqno="5">
				<ind:IndItemRadio indexNo="ST013$ST01317" indexName="小微企业业主（或主要股东）信用" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01318" indexName="企业银行信用" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01319" indexName="信用环境" readonly="false">
