...
//检验组经营者素质与资信的指标
	...
	//检验组生产经营情况的指标
			item=document.getElementsByName('G2012203891.ST013$ST01307');
		if(!judgeRadioChecked(item)){
			alert("指标[产品及技术]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203891.ST013$ST01308');
		if(!judgeRadioChecked(item)){
			alert("指标[生产管理]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203891.ST013$ST01209');
		if(!judgeRadioChecked(item)){
			alert("指标[购销渠道]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203891.ST013$ST01310');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203891" groupName="生产经营情况" seqno="3">
				<ind:IndItemRadio indexNo="ST013$ST01307" indexName="产品及技术" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01308" indexName="生产管理" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01209" indexName="购销渠道" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST013$ST01310" indexName="市场竞争度" readonly="false">
