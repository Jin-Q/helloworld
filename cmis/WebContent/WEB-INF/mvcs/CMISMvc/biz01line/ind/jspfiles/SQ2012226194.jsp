...
//检验组信用历史的指标
	...
	//检验组规模实力的指标
							item=document.getElementsByName('G2013203963.ST001$ST00138');
		if(!judgeRadioChecked(item)){
			alert("指标[净利润纳税比率]未选择，请选择后提交。");
			return false;
		}
	//检验组偿债能力的指标
						item=document.getElementsByName('G2012203836.ST001$ST00110');
		if(!judgeRadioChecked(item)){
	...
	//检验组盈利能力的指标
			//检验组营运能力的指标
			//检验组发展能力的指标
			item=document.getElementsByName('G2013203965.ST004$ST00419');
		if(!judgeRadioChecked(item)){
			alert("指标[纳税增长率]未选择，请选择后提交。");
			return false;
		}
				//检验组管理水平的指标
			item=document.getElementsByName('G2012203838.ST004$ST00401');
		if(!judgeRadioChecked(item)){
			alert("指标[房地产：地理位置情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203838.ST001$ST00126');
		if(!judgeRadioChecked(item)){
			alert("指标[企业生产管理现场情况]未选择，请选择后提交。");
			return false;
		}
	//检验组综合评价的指标
			item=document.getElementsByName('G2012203840.ST009$ST00918');
		if(!judgeRadioChecked(item)){
			alert("指标[合作情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203840.ST004$ST00402');
		if(!judgeRadioChecked(item)){
			alert("指标[国家行业政策]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203840.ST002$ST00231');
		if(!judgeRadioChecked(item)){
			alert("指标[领导者素质]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203840.ST002$ST00234');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺产权情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203840.ST001$ST00135');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2013203963" groupName="规模实力" seqno="2">
    			<ind:IndItemText indexNo="ST004$ST00408" indexName="销售收入(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00409" indexName="利润总额(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00410" indexName="纳税总额(万元)" readonly="false" />
	

    			<ind:IndItemText indexNo="ST004$ST00411" indexName="实有净资产(万元)" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203836" groupName="偿债能力" seqno="3">
    			<ind:IndItemText indexNo="ST004$ST00403" indexName="资产负债率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00404" indexName="流动比率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00405" indexName="速动比率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2013203964" groupName="盈利能力" seqno="5">
    			<ind:IndItemText indexNo="ST004$ST00413" indexName="总资产报酬率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00414" indexName="净资产收益率" readonly="true" />
	...
	<ind:IndGroup groupNo="G2012203837" groupName="营运能力" seqno="6">
    			<ind:IndItemText indexNo="ST004$ST00406" indexName="存货周转率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00407" indexName="应收账款周转率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00415" indexName="总资产周转率" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2013203965" groupName="发展能力" seqno="7">
				<ind:IndItemRadio indexNo="ST004$ST00419" indexName="纳税增长率" readonly="false">
    			...
    			<ind:IndItemText indexNo="ST004$ST00418" indexName="净资产增长率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00416" indexName="销售收入增长率" readonly="true" />
	

    			<ind:IndItemText indexNo="ST004$ST00417" indexName="净利润增长率" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2012203838" groupName="管理水平" seqno="8">
				<ind:IndItemRadio indexNo="ST004$ST00401" indexName="房地产：地理位置情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="地理环境稀缺、居住舒适且位于繁华商业区"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="地理位置一般，但居住环境舒适或在商业区"/>
	...
	<ind:IndGroup groupNo="G2012203840" groupName="综合评价" seqno="9">
				...
				<ind:IndItemRadio indexNo="ST004$ST00402" indexName="国家行业政策" readonly="false">
