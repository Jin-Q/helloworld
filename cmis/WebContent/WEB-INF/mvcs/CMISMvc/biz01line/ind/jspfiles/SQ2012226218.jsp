...
//检验组股东的指标
	...
	//检验组发展前景的指标
			item=document.getElementsByName('G2012203901.ST011$ST01108');
		if(!judgeRadioChecked(item)){
			alert("指标[行业投向]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203901.ST011$ST01109');
		if(!judgeRadioChecked(item)){
			alert("指标[产品市场]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203901.ST011$ST01110');
		if(!judgeRadioChecked(item)){
			alert("指标[产品技术成熟度]未选择，请选择后提交。");
			return false;
		}
	//检验组实际资产的指标
		//检验组其它可加减分因素的指标
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203901" groupName="发展前景" seqno="4">
				...
				<ind:IndItemRadio indexNo="ST011$ST01109" indexName="产品市场" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="依托行业强势企业或垄断企业提供配套生产的，或产品极具市场竞争力"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="产品具有良好成长性，市场需求旺盛"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="供求基本平衡，但产品仍有利润空间"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="产品积压、市场滞销"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="不得分"/>
	    			</ind:IndItemRadio>


				<ind:IndItemRadio indexNo="ST011$ST01110" indexName="产品技术成熟度" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="产品成熟度高，专业技术高"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="产品具有良好创新力水平，专业技术高"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="产品创新力一般，专业技术一般"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="产品模仿生产，但具一定差异和优势"/>
	    						<ind:IndItemRadioOption indValue="4" indDesc="产品模仿度高，专业技术低"/>
