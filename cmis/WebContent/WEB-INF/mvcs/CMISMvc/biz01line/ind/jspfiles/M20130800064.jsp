...
//检验组信用状况的指标
	...
	//检验组修正/调整项的指标
			item=document.getElementsByName('G2013203955.ST024$ST02422');
		if(!judgeRadioChecked(item)){
			alert("指标[医院等级情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2013203955.ST024$ST02423');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2013203955" groupName="修正/调整项" seqno="8">
				<ind:IndItemRadio indexNo="ST024$ST02422" indexName="医院等级情况" readonly="false">
							<ind:IndItemRadioOption indValue="0" indDesc="三级医院"/>
	    						<ind:IndItemRadioOption indValue="1" indDesc="二级医院"/>
	    						<ind:IndItemRadioOption indValue="2" indDesc="一级医院"/>
	    						<ind:IndItemRadioOption indValue="3" indDesc="不得分"/>
	    			</ind:IndItemRadio>
