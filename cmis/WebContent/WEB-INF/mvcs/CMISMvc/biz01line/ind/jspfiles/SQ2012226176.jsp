...
//检验组信用历史的指标
	...
	//检验组规模实力的指标
							item=document.getElementsByName('G2012203819.ST001$ST00138');
		if(!judgeRadioChecked(item)){
			alert("指标[净利润纳税比率]未选择，请选择后提交。");
			return false;
		}
	//检验组偿债能力的指标
						item=document.getElementsByName('G2012203821.ST001$ST00110');
		if(!judgeRadioChecked(item)){
	...
	//检验组盈利能力的指标
			//检验组营运能力的指标
			//检验组发展能力的指标
					item=document.getElementsByName('G2012203823.ST001$ST00125');
		if(!judgeRadioChecked(item)){
			alert("指标[纳税增长率]未选择，请选择后提交。");
			return false;
		}
		//检验组管理水平的指标
			item=document.getElementsByName('G2012203824.ST002$ST00227');
		if(!judgeRadioChecked(item)){
			alert("指标[公司组织结构情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203824.ST002$ST00228');
		if(!judgeRadioChecked(item)){
			alert("指标[公司内部制度建设、制度实施情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203824.ST002$ST00230');
		if(!judgeRadioChecked(item)){
			alert("指标[技术装备情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203824.ST001$ST00126');
		if(!judgeRadioChecked(item)){
			alert("指标[企业生产管理现场情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203824.ST001$ST00129');
		if(!judgeRadioChecked(item)){
			alert("指标[公司员工情况]未选择，请选择后提交。");
			return false;
		}
	//检验组综合评价的指标
			item=document.getElementsByName('G2012203825.ST002$ST00231');
		if(!judgeRadioChecked(item)){
		...
		if(!judgeRadioChecked(item)){
			...
			return false;
				...
				item=document.getElementsByName('G2012203825.ST002$ST00233');
		if(!judgeRadioChecked(item)){
			alert("指标[我行行业信贷政策导向]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203825.ST001$ST00134');
		if(!judgeRadioChecked(item)){
			alert("指标[经营的厂房、土地、店铺情况]未选择，请选择后提交。");
			return false;
		}
				item=document.getElementsByName('G2012203825.ST001$ST00135');
		if(!judgeRadioChecked(item)){
...
<ind:IndTableLayout>
	...
	<ind:IndGroup groupNo="G2012203819" groupName="规模实力" seqno="2">
    			<ind:IndItemText indexNo="ST002$ST00205" indexName="利润总额(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST001$ST00104" indexName="销售收入(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST001$ST00107" indexName="实有净资产(万元)" readonly="true" />
	

    			<ind:IndItemText indexNo="ST001$ST00106" indexName="纳税总额(万元)" readonly="false" />
	...
	<ind:IndGroup groupNo="G2012203821" groupName="偿债能力" seqno="3">
	...
	<ind:IndGroup groupNo="G2012203823" groupName="发展能力" seqno="7">
    			...
    			<ind:IndItemText indexNo="ST001$ST00124" indexName="净资产增长率" readonly="true" />
	

	</ind:IndGroup>

	<ind:IndGroup groupNo="G2012203824" groupName="管理水平" seqno="8">
	...
	<ind:IndGroup groupNo="G2012203825" groupName="综合评价" seqno="9">
				...
				<ind:IndItemRadio indexNo="ST002$ST00231" indexName="合作情况" readonly="false">
				...
				<ind:IndItemRadio indexNo="ST001$ST00134" indexName="经营的厂房、土地、店铺情况" readonly="false">
