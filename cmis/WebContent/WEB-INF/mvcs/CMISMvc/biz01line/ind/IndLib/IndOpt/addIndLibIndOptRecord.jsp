...
<body class="page_content">
	<emp:form id="submitForm" action="addIndLibIndOptRecord.do" method="POST">
		<emp:gridLayout id="IndOptGroup" title="指标选项值配置" maxColumn="2">
			...
			<emp:text id="IndOpt.index_value" label="指标选项值" maxlength="10" required="true" />
		...
		<div align="center">
			<br>
			<emp:button id="submit" label="保存" op="add_IndOpt"/>
