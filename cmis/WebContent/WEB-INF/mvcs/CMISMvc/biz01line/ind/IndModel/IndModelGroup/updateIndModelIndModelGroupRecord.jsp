...
<body class="page_content">
	<emp:form id="submitForm" action="updateIndModelIndModelGroupRecord.do" method="POST">
		<emp:gridLayout id="IndModelGroupGroup" title="模型指标组关联设置" maxColumn="2">
			...
			<emp:text id="IndModelGroup.weight" label="权重" maxlength="9" required="false" hidden="true" />
			<emp:text id="IndModelGroup.seqno" label="顺序号" maxlength="38" required="true" />
		</emp:gridLayout>
		
		<div align="center">
			<br>
			<emp:button id="submit" label="保存" op="update_IndModelGroup"/>
