...
<script type="text/javascript">
	...
	function refreshIndGroupIndex() {
		IndGroup_tabs.tabs.IndGroupIndex_tab.refresh();
	};
...
<body class="page_content" onload="doload()">
	<emp:form id="submitForm" action="updateIndGroupRecord.do" method="POST">
		<emp:gridLayout id="IndGroupGroup" title="指标组别信息" maxColumn="2">
			...
			<emp:pop id="IndGroup.trans_id" label="规则交易" url="querySfTransPopList.do" required="true" />
