...
<body class="page_content" >
	<emp:form id="submitForm" action="addIndGroupIndGroupIndexRecord.do" method="POST">
		<emp:gridLayout id="IndGroupIndexGroup" title="设置指标组与指标关联" maxColumn="2">
			...
			<emp:select id="IndGroupIndex.dis_property" label="显示属性"  required="false" dictname="STD_ZB_DISPLAY_PROP" defvalue="4"/>
			<emp:select id="IndGroupIndex.ind_dis_type" label="指标显示类型"  required="false" dictname="STD_ZB_PARA_DISP_TYP" defvalue="1"/>
		...
		<div align="center">
			<br>
			<emp:button id="submit" label="保存" op="add_IndGroupIndex"/>
