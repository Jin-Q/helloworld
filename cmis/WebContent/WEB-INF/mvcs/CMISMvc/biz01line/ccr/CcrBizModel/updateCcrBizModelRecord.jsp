...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateCcrBizModelRecord.do" method="POST">
		<emp:gridLayout id="CcrBizModelGroup" maxColumn="2" title="行业数据模型">
			<emp:select id="CcrBizModel.com_cll_typ" label="行业类型" readonly="true" dictname="STD_ZB_ASS_CREDIT"/>
			<emp:text id="CcrBizModel.index_no" label="指标编号" readonly="true"/>
			<emp:text id="CcrBizModel.index_name" label="指标名称" maxlength="60" required="false" readonly="true"/>
