...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateAccLoan1Record.do" method="POST">
		<emp:gridLayout id="AccLoan1Group" maxColumn="2" title="ACC_LOAN">
			<emp:text id="AccLoan1.bill_no" label="BILL_NO" maxlength="30" required="true" readonly="true" />
