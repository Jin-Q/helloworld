...
<body class="page_content" onload="doload()">
  ...
  <emp:tab label="申请信息" id="appinf"  needFlush="true" initial="true" >
		...
		<emp:gridLayout id="CcrAppInfoGroup" maxColumn="2" title="信用评级基本信息">
			...
			<emp:date id="CcrAppInfo.expiring_date" label="到期日期" required="false" readonly="true" colSpan="2" hidden="false"/>
		...
		<emp:gridLayout id="CusComGroup" maxColumn="2" title="信用评级评级信息">
			...
			<emp:text id="CcrAppDetail.o_rating_unit" label="外部评级单位" maxlength="100" required="false"  readonly="true" hidden="false"/>
		    <emp:select id="CcrAppDetail.o_rating_result" label="外部评级结果" required="false"  readonly="true"  dictname="STD_ZB_FINA_GRADE"/>
			<emp:date id="CcrAppDetail.o_rating_date" label="外部评级日期" required="false"  readonly="true" hidden="false"/>
			<emp:text id="CcrAppDetail.lat_app_end_date" label="上次评级日期" maxlength="10" required="true"  readonly="true" hidden="true"/>
		...
		<emp:gridLayout id="RegGroup" maxColumn="2" title="登记信息">
			<emp:pop id="CcrAppInfo.manager_id_displayname" label="主管客户经理" required="true" readonly="true" hidden="false" url="getValueQuerySUserPopListOp.do?restrictUsed=false" returnMethod="setconId"/>
			<emp:pop id="CcrAppInfo.manager_br_id_displayname" label="主管机构" url="querySOrgPop.do?restrictUsed=false" returnMethod="getOrgID" required="true" readonly="true"/>
			...
			<emp:text id="CcrAppInfo.manager_id" label="主管客户经理" required="false" readonly="true" hidden="true" />
			<emp:text id="CcrAppInfo.manager_br_id" label="主管机构" readonly="true" hidden="true"/>
  ...
  <emp:tab label="信用等级评估表" id="ratingtab"  needFlush="true" initial="true">
		...
		<emp:gridLayout id="scorePanel" maxColumn="2" title="信用评级得分">
			...
			<emp:select id="CcrAppDetail.adjusted_grade" label="客户经理调整等级" readonly="true" required="true" colSpan="2"  dictname="STD_ZB_FINA_GRADE" onblur="saveChange()"/>
