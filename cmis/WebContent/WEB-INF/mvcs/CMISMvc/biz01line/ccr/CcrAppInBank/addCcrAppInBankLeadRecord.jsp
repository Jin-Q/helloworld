...
<script type="text/javascript">
	...
	function doload(){
		...
		if(cus_type == null || cus_type == ""){
			CcrAddInf.cus_type._obj._renderReadonly(false);
		}
	}
	//查看客户详细信息
	function viewCusInfo(){
		var url = "";
		url= "<emp:url action='getCusSameOrgViewPage.do'/>&type=cusSame&cus_id="+CcrAddInf.cus_id._getValue()+"&op=view&restrict_tab=Y"; 
      	url=encodeURI(url); 
...
<body class="page_content" onload="doload()">
	...
	<emp:form id="submitForm" action="addCcrAppInBankRecord.do" method="POST">
		...
		<emp:gridLayout id="CcrAddInfGroup" maxColumn="2" title="信用评级申请主表">
			...
			<emp:select id="CcrAddInf.cus_type" label="客户类型 " required="true"  dictname="STD_ZB_INTER_BANK_ORG" defvalue="${context.cus_type}" readonly="true"/>
