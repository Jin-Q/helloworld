...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addPvpAuthorizeRecord.do" method="POST">
		<emp:gridLayout id="PvpAuthorizeGroup" title="授权信息主表" maxColumn="2">
			<emp:text id="PvpAuthorize.serno" label="业务编号" maxlength="40" required="true" />
