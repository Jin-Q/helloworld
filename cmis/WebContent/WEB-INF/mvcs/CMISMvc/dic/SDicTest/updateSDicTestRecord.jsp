...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateSDicTestRecord.do" method="POST">
		<emp:gridLayout id="SDicTestGroup" maxColumn="2" title="单表维护测试">
			<emp:text id="SDicTest.enname" label="ENNAME" maxlength="50" required="true" readonly="true" />
			<emp:text id="SDicTest.cnname" label="CNNAME" maxlength="200" required="true" />
			<emp:text id="SDicTest.opttype" label="OPTTYPE" maxlength="50" required="true" readonly="true" />
