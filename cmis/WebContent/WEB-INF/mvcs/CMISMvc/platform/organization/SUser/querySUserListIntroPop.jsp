...
<script type="text/javascript">
	...
	function doQuery(){
		...
		var url = '<emp:url action="pageSUserIntroQuery.do"/>&returnMethod=getTeamMem&team_no=${context.team_no}';
...
<body class="page_content">
	...
	<emp:gridLayout id="SUserGroup" title="输入查询条件" maxColumn="2">
			...
			<emp:text id="SUser.orgid" label="组织号" defvalue="${context.SUser.orgid}" hidden="true"/>
	</emp:gridLayout>
	
	<jsp:include page="/queryInclude.jsp" flush="true" />
	<emp:returnButton id="s1" label="引入"/>
	<emp:table icollName="SUserList" pageMode="true" url="pageSUserIntroQuery.do"  reqParams="returnMethod=getTeamMem&team_no=${context.team_no}" selectType="2" >
