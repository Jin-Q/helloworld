...
<script type="text/javascript">
	...
	function doReset(){
		page.dataGroups.SUserOrgGroup.reset();
	};
	/*--user code end--*/
...
<body class="page_content">
	...
	<emp:gridLayout id="SUserOrgGroup" title="输入查询条件" maxColumn="3">
		<emp:text id="SUserOrg.actorno" label="用户码" />
		<emp:text id="SUserOrg.actorname" label="姓名" />
		<emp:pop id="SUserOrg.orgid_displayname" label="所属机构" url="querySOrgPop.do?restrictUsed=false" returnMethod="getOrgID" 
		...
		<emp:text id="SUserOrg.orgid" label="所属机构" hidden="true"/>
		
	</emp:gridLayout>
	<jsp:include page="/queryInclude.jsp" flush="true" />
	
	<emp:table icollName="SUserList" pageMode="true" url="pageAllSUserPopQuery.do"  reqParams="cusTypCondition=${context.cusTypCondition}&restrictUsed=${context.restrictUsed}&receiveOrg=${context.receiveOrg}&flag=${context.flag}" >
