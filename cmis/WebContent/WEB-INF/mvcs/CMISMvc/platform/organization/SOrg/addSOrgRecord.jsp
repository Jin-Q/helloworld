...
<body class="page_content">
	...
	<emp:form id="submitForm" action="addSOrgRecord.do" method="POST">
		
		<emp:gridLayout id="SOrgGroup" title="机构表" maxColumn="2" >
			<emp:text id="SOrg.organno" label="机构码" maxlength="16" required="true" colSpan="2"  dataType="CodeNo" />
			...
			<emp:text id="SOrg.fincode" label="金融代码" maxlength="21" required="false" colSpan="1" cssElementClass="emp_field_text_t" />
			<emp:text id="SOrg.bsins_lic" label="营业执照" maxlength="32" required="false" cssElementClass="emp_field_text_t" />
			<emp:text id="SOrg.organchief" label="机构负责人" maxlength="32" required="false" colSpan="1" cssElementClass="emp_field_text_t" />
			<emp:select id="SOrg.organlevel" label="机构级别" required="false" dictname="STD_ZB_ORG_LEVEL" colSpan="1" cssElementClass="emp_field_text_t" />
			<emp:select id="SOrg.org_lvl" label="机构等级" required="true" dictname="STD_ZB_ORG_LVL" cssElementClass="emp_field_text_t" />
			<emp:text id="SOrg.telnum" label="联系电话" maxlength="20" required="false" dataType="Phone" colSpan="1" cssElementClass="emp_field_text_t" />
			...
			<emp:select id="SOrg.state" label="状态" required="true" dictname="STD_ZB_ORG_STATUS" cssElementClass="emp_field_text_t" colSpan="1"/>
			<emp:select id="SOrg.area_dev_cate_type" label="地区发展分类" required="false" dictname="ZB_CFG_AREA_DEV"  colSpan="1" cssElementClass="emp_field_text_t" />
