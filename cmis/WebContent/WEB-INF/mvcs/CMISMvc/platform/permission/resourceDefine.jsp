...
<script>
	...
	*/
	...
	function selectDiv(itemId){
		...
		//刷新detailsframe的内容
		url = "<emp:url action='resourceDetails.do'/>&resourceid="+curMenuId;
		detailsframe.location = encodeURI(url);	
			
		//刷新actionframe的内容
		var url = "<emp:url action='resourceActList.do'/>&s_resourceaction.resourceid="+curMenuId;
...
<table width="98%"  bgcolor='#E8F2FE'><tr><td bgcolor='#E8F2FE'>
