...
<script type="text/javascript">
	function doSubmit(){
		var url = "<emp:url action='editActionSubmit.do'/>";
	...
	*/
	function addBackFun(){
	  //
	   ...
	   window.parent.rightTree.getRootNode().reload();
	   doClose();
	}
...
<body class="page_content">
	<form id="submitForm" action="<emp:url action='editActionSubmit.do'/>" method="POST">
	</form>
	<emp:gridLayout id="s_resourceactionGroup" maxColumn="2" title="资源操作表">
		<emp:text id="s_resourceaction.resourceid" label="资源ID" maxlength="32" required="true" readonly="true"/>
		<emp:text id="s_resourceaction.actid" label="操作ID" maxlength="32" required="true" readonly="true"/>
