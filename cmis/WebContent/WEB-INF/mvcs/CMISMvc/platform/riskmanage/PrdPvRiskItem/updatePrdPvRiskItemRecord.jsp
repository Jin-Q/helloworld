...
<body class="page_content" onload="doOnLoad();">
	...
	<emp:form id="submitForm" action="updatePrdPvRiskItemRecord.do" method="POST">
		<emp:gridLayout id="PrdPvRiskItemGroup" maxColumn="2" title="风险拦截项目">
			...
			<emp:text id="PrdPvRiskItem.input_id" label="登记人" maxlength="20" hidden="true" />
			<emp:text id="PrdPvRiskItem.input_br_id" label="登记机构" maxlength="20" hidden="true" />
			<emp:text id="PrdPvRiskItem.input_date" label="登记日期" maxlength="10" hidden="true" />
		</emp:gridLayout>
