...
<script type="text/javascript">
	...
	function doReturn() {
		var url = '<emp:url action="queryPrdPvRiskItemList.do"/>';
...
<body class="page_content" onload="doOnLoad();">
	...
	<emp:gridLayout id="PrdPvRiskItemGroup" title="风险拦截项目" maxColumn="2">
			...
			<emp:text id="PrdPvRiskItem.item_name" label="项目名称" maxlength="80" required="true" cssElementClass="emp_field_text_long_readonly"/>
			...
			<emp:text id="PrdPvRiskItem.input_id" label="登记人" maxlength="20" required="true" />
			<emp:text id="PrdPvRiskItem.input_br_id" label="登记机构" maxlength="20" required="true" />
			<emp:text id="PrdPvRiskItem.input_date" label="登记日期" maxlength="10" required="true" />
	</emp:gridLayout>
