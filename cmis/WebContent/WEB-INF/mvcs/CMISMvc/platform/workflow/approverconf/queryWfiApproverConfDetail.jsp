...
<body class="page_content">
	<emp:form id="submitForm" action="updateWfiApproverConfRecord.do" method="POST">
		...
		<%-- <div align="center">
			<emp:button id="mysubmit" label="修改" op="update"/>
			<emp:button id="reset" label="重置"/>
		</div> --%>
	</emp:form>
	
	<emp:tabGroup mainTab="usersTab" id="theTabGroup">
		<emp:tab label="用户列表" id="usersTab" url="queryWfiApproverUserList.do?confid=${context.WfiApproverConf.confid }&opType=view" needFlush="true"/>
