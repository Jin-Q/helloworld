...
<body class="page_content">
	...
	<emp:form id="submitForm" action="updateWfTaskpoolRecord.do" method="POST">
		<emp:gridLayout id="WfTaskpoolGroup" maxColumn="2" title="项目池">
			<emp:text id="WfTaskpool.tpid" label="项目池编号" maxlength="32" required="true" readonly="true" />
		...
		<div align="center">
			<br>
			<emp:button id="submit" label="修改" op=""/>
