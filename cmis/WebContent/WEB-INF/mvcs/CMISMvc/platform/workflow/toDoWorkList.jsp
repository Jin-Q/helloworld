...
<script type="text/javascript">
	...
	function doSel(){
		...
		var url = "<emp:url action='getInstanceInfo.do'/>"+
			"?instanceId="+instanceid+"&nodeId="+nodeid+"&applType="+applType+"&cus_id="+cusId;
...
<body class="page_content" onload="doOnLoad()">
	...
	<emp:table icollName="WfiWorklistTodoList" pageMode="true" url="pageToDoWorkQuery.do" >
		...
		<emp:text id="cus_crd_grade" label="信用等级" dictname="STD_ZB_CREDIT_GRADE"/>
