...
<body class="page_content" onload="doLoad()">
	...
	<emp:form id="submitForm" action="updateWfiBpRightRecord.do" method="POST">
		...
		<div align="center">
			<br>
<!--			<emp:button id="updBpRight" label="修改" op="update"/>-->
     		<input type="button" class="button80" id="btReturn1" onclick="doUpdBpRight()" value="修改">
			<input type="button" class="button100" id="btReturn" onclick="window.close()" value="返回">
