...
<body class="page_content" onload="onLoad()">
		...
		<emp:gridLayout id="WfiLvOverdrawnRightGroup" maxColumn="2" title="初始化机构透支额度信息">
			...
			<emp:select id="WfiLvOverdrawnRight.is_inuse" label="是否控制透支额度"  required="true" dictname="STD_ZX_YES_NO" />
		...
		<emp:gridLayout id="WfiLvOverdrawnRightGroup" title="初始化单户限额信息" maxColumn="2">
			<emp:select id="WfiLvOverdrawnRight.is_ctrl" label="是否控制单户限额"  required="true" dictname="STD_ZX_YES_NO" colSpan="2"  />
