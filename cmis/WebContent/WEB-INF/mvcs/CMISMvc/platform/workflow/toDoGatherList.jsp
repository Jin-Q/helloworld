...
<script type="text/javascript">
	...
	function doQuery(){
		...
		WfInstanceGatherProperty._toForm(form);
		WfInstanceGatherPropertyList._obj.ajaxQuery(null,form);
	};
	
	function doSel(){
		var selObj = WfInstanceGatherPropertyList._obj.getSelectedData()[0];
		...
		var url = "<emp:url action='getGatherInstanceInfo.do'/>"+
			"?instanceId="+instanceid+"&mainNodeId="+mainnodeid+"&mainInstandeId="+maininstanceid+'&rd='+Math.random();
	...
	function doReset() {
		page.dataGroups.WfInstanceGatherPropertyGroup.reset();
	}
...
<body class="page_content" onload="doOnLoad()">
	...
	<emp:gridLayout id="WfInstanceGatherPropertyGroup" title="输入查询条件" maxColumn="2">
		<emp:text id="WfInstanceGatherProperty.bizseqno" label="申请流水号" />
		<emp:text id="WfInstanceGatherProperty.gathertitle" label="会办主题" />
	</emp:gridLayout>
	<jsp:include page="/queryInclude.jsp" flush="true" />
	
	<emp:table icollName="WfInstanceGatherPropertyList" pageMode="true" url="pageToDoGatherQuery.do" >
