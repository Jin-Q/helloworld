...
<body class="page_content" onload="doOnLoad()">
	...
	<emp:gridLayout id="WfiWorklistEndGroup" title="输入查询条件" maxColumn="2">
	...
	<emp:table icollName="WfiWorklistEndList" pageMode="true" url="pageMyInitWorkQuery.do" reqParams="type=end">
		...
		<emp:link id="lastuser" label="最后办理人" operation="sel" hidden="true"/>
		<emp:link id="lastuser_displayname" label="最后办理人" operation="sel"/>
