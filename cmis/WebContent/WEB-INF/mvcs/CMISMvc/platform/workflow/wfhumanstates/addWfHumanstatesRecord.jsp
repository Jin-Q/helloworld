...
<body class="page_content">
	<emp:form id="dateForm" action="queryWfHumanstatsByTime.do" method="post">
		<emp:text id="optype" label="操作类型" hidden="true" defvalue="add"/>
	</emp:form>
	<emp:form id="submitForm" action="addWfHumanstatesRecord.do" method="POST">
		...
		<div align="center">
			<br>
			<emp:button id="submit1" label="确 定" op="add"/>
