...
<li><img src="images/ico_18.gif" />用户名：
  <label>
  <input type="text" id="user_id"  name="currentUserId" value=''  onkeydown="if(event.keyCode==13){event.keyCode=9;}" style="width:150px"/>
  </label>
</li>
<li><img src="images/ico_19.gif" />密　码：
  <label>
  <input type="password" id="user_key" name="password" value='' onkeydown="if(event.keyCode==13){ doSubmit();}" style="width:150px"/>
  </label></li>
</div>
