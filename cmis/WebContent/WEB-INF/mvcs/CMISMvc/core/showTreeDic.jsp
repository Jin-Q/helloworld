...
<script type="text/javascript">
	...
	function getOneFormTwo(key){
         ...
         if(Number(key)>=6&&Number(key)<=12) return "B";
         if(Number(key)>=13&&Number(key)<=43) return "C";
         if(Number(key)>=44&&Number(key)<=46) return "D";
         if(Number(key)>=47&&Number(key)<=50) return "E";
         if(Number(key)>=51&&Number(key)<=52) return "F";
         if(Number(key)>=53&&Number(key)<=60) return "G";
         if(Number(key)>=61&&Number(key)<=62) return "H";
         if(Number(key)>=63&&Number(key)<=65) return "I";
         if(Number(key)>=66&&Number(key)<=69) return "J";
         if(Number(key)>=70&&Number(key)<=70) return "K";
         if(Number(key)>=71&&Number(key)<=72) return "L";
         if(Number(key)>=73&&Number(key)<=75) return "M";
         if(Number(key)>=76&&Number(key)<=78) return "N";
         if(Number(key)>=79&&Number(key)<=81) return "O";
         if(Number(key)>=82&&Number(key)<=82) return "P";
         if(Number(key)>=83&&Number(key)<=84) return "Q";
         if(Number(key)>=85&&Number(key)<=89) return "R";
         if(Number(key)>=90&&Number(key)<=95) return "S";
         if(Number(key)>=96) return "T";
	};
