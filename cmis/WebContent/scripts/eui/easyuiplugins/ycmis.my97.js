...
* ycmis.my97.js
* 1. panelWidth,panelHeight的值改为1，移动可编辑表格的部分到ycmis.easyui.ext.js中
*/
(function ($, undefined) {
                    ...
                    var box = t.combo("textbox"),
                        wopts = $.extend({}, opts, {
                            ...
                            onpicking: function (dp) {
                                ...
                                EMPTools.exec(function () { t.combo("hidePanel"); });
                            },
                            onpicked: function (dp) {
                                if ($.isFunction(opts.onSelect)) {
                                    opts.onSelect.call(this, dp.cal.getNewDateStr()); 
                                }
                            },
    ...
    function setValues(target, values) {
        var t = $(target), opts = t.my97("options"),
            array = EMPTools.likeArrayNotString(values) ? values : [values],
    ...
    $.fn.my97.methods = {
        ...
        setValue: function (jq, value) { 
        	return jq.each(function () { setValues(this, [value]); }); 
        ...
        $.extend($.fn.datagrid.defaults.editors, {
            my97: {
                ...
                setValue: function (target, value) {
                    ...
                    if (value) {
                        if (opts.multiple) {
                            if (EMPTools.likeArrayNotString(value)) {
