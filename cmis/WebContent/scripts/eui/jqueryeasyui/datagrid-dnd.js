/**
 * 1.去掉对td.css('border','')的操作，避免影响表格样式。
 * add by wangbin 2014.03.04
 */
(function($){
			...
			return jq.each(function(){
				...
				trs.draggable({
					...
					onDrop: function(e, source) {
						...
						if (opts.onBeforeDrop.call(target, destIndex, sourceIndex, point) == false){
							return;
						}
						insert();
						if(opts.onDrop.call(target, dRow, sRow, point)==false){
							return;
						}
