...
EMP.widget.EMPMenu.prototype = {
	...
	contentDivID:null,           //工作区ID	
	contentDiv:null,              //工作区DIV节点

	relativeDivID:null,            //关联区ID
	relativeDiv:null,               //关联区DIV节点
	
	helpDivID:null,                //帮助区ID
	helpDiv:null,                    //帮助区DIV节点

	advertDivID:null,             //广告区ID
	advertDiv:null,                //广告区DIV节点
    ...
    */
	 ...
	 */
	registContentDiv:function(divId )
	{
	...
	registRelativeDiv:function( divId )
	{
		this.relativeDivID = divId;
		this.relativeDiv = document.getElementById( divId );
	},
	
	registHelpDiv:function( divId )
	{
		this.helpDivID = divId;
		this.helpDiv = document.getElementById( divId );
		
	},

	registAdvertDiv:function( divId )
	{
		this.advertDivID = divId;
		this.advertDiv = document.getElementById( divId );
	},
		...
		*/
		if( this.contentDiv != null )
		{
			...
			if( this.EMPWorkBench != null )
				...
				updateDivContent(activeNode.href, this.contentDivID, "" );
		}
		...
		if( this.relativeDivID != null )
		{
			...
			//alert( relHtml );
			this.relativeDiv.innerHTML = relHtml;	
		}
		
		if( this.helpDivID != null )
		{
			var helpHtml = activeNode.getHelpItemHtml(this.id);
			
		//	alert( helpHtml );
			this.helpDiv.innerHTML = helpHtml;
		}
			
		if( this.advertDiv != null && activeNode.advertData != null  )
		{
			//alert(activeNode.advertData.href);
			updateDivContent(activeNode.advertData.href, this.advertDivID, '');
		}
