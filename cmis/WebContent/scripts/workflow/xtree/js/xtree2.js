...
_p.getLabelHtml = function () {
	...
	return "<a href='#' style='color:#163c61' onclick=\"" + webFXTreeHandler.textToHtml(this._getHref()) +  //guoxin for IE6 showModalDialog  pop-up program error problem
...
_p._getHref = function () {
	if (typeof this.action == "string")
		...
		return "return false;"; //guoxin for IE6 showModalDialog  pop-up program error problem
};
...
_p._onclick = function (e) {
	...
	if (typeof this.action == "function") {
		...
		//window.open(this.action, this.target || "_self");  guoxin for IE6 showModalDialog  pop-up program error problem
	}
	return true;
};
