...
<%
Map varMap=(Map)new ServerFactory().getConstant().getObj();
%>
<html>
<head>
...
.tablemain tr,.tablemain td{border-right:1px solid #b7b7b7;border-bottom:1px solid #b7b7b7;padding:5px;}
...
<body>
<p class="QZ_Ptitle">全局常量>></p>
<table class=tablemain cellspacing=1 cellpadding=0>
<tr class=trtitle>
<td width="20%">常量ID</td><td width="20%">常量名称</td><td width="15%">常量类型</td><td>常量值</td><td width="10%">操作</td>
</tr>
<%
if(varMap==null||varMap.isEmpty()){
%>
<tr class=trclass><td colspan='5'>没有全局常量信息</td></tr>
<%
}else{
	...
	while(it.hasNext()){
		...
		out.print("<td align=center><a href='"+request.getContextPath()+"/shuffle/shufflemanage/constantEdit.jsp?varid="+(String)hm.get("varid")+"'>修改</a></td>");
		out.print("</tr>");
		tr=!tr;
	}
}
