...
public class QueryIqpAssetProListDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			appkcoll.put("agent_asset_acct", kColl.getDataValue("agent_asset_acct"));
			appkcoll.setName(modelId);
			/*从台账中获取到期日期    2014-08-20  王青 start*/
			String conditionAcc = "WHERE BILL_NO='"+bill_no_value+"'";
			KeyedCollection kCollIqpAsset = dao.queryFirst("AccLoan", null, conditionAcc, connection);
			String end_date = (String)kCollIqpAsset.getDataValue("end_date");
			appkcoll.put("end_date", end_date);
			/*从台账中获取到期日期    2014-08-20  王青 end*/
		    ...
		    SInfoUtils.addSOrgName(appkcoll, new String[]{"manager_br_id","fina_br_id"});
