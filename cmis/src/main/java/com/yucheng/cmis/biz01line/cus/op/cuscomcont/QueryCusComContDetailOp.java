package com.yucheng.cmis.biz01line.cus.op.cuscomcont;
...
public class QueryCusComContDetailOp  extends CMISOperation {
	private final String modelId = "CusComCont";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			map.put("com_addr", "STD_GB_AREA_ALL");
			//树形菜单服务
