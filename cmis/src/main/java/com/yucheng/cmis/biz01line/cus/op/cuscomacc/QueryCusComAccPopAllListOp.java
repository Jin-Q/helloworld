...
public class QueryCusComAccPopAllListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			if(conditionStr !=null && !(conditionStr.equals(""))){
				conditionStr = conditionStr+" order by cus_id desc,acc_no desc";
			}else{
				conditionStr = " where 1=1 order by cus_id desc,acc_no desc";
			}
