...
import com.yucheng.cmis.pub.CMISDomain;
  /**
 *@Classname	FncAccPay.java
 *@Version 1.0	
 *@Since   1.0 	Oct 7, 2008 2:01:30 PM  
 ...
 *@Author
 */
public class FncAccPayable implements CMISDomain{
	...
	private	double	fncSumAmt;	      //应付款余额合计
	private	double	fncImmTrmAmt;	  //即期应付款
	private	double	fncShortTrmAmt;	  //短期应付款
	private	double	fncInterTrmAmt;	  //中期应付款
	private	double	fncLongTrmAmt;	  //长期应付款
