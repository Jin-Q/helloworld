	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			if (status_value.equals("00")) {
				...
				// 审批操作
			} else if (status_value.equals("10")) {
				// 同意还是否决的标志
				...
				// 同意操作
			} else if (status_value.equals("20")) {
				...
				CusHandoverLstComponent cushandoverlstcomponent = (CusHandoverLstComponent) CMISComponentFactory
						.getComponentFactoryInstance().getComponentInstance(
								"CusHandoverLst", context, connection);
				...
				CusHandoverCfgComponent cushandovercfgcomponent = (CusHandoverCfgComponent) CMISComponentFactory
						.getComponentFactoryInstance().getComponentInstance(
								"CusHandoverCfg", context, connection);
			...
			if (status_value.equals("10")
					&& strReturnMessage.equals(CMISMessage.SUCCESS)) {
				String flag = "提交成功";
				context.addDataField("flag", flag);
			} else if (status_value.equals("00")
