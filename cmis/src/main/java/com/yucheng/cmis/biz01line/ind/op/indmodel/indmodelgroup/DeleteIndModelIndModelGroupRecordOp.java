...
public class DeleteIndModelIndModelGroupRecordOp extends CMISOperation {
	
	private static final Logger logger = Logger.getLogger(DeleteIndModelIndModelGroupRecordOp.class);
