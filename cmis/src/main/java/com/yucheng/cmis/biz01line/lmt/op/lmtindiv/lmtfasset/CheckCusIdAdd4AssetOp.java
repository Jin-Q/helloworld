 ...
 * @author ZYF
 */
public class CheckCusIdAdd4AssetOp extends CMISOperation{
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			KeyedCollection kc = dao.queryFirst("LmtFasset", null, "where cus_id='"+cus_id+"' and serno ='"+serno+"'", connection);
