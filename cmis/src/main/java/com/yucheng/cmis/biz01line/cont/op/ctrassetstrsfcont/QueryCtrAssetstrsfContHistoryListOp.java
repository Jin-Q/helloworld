...
public class QueryCtrAssetstrsfContHistoryListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr.equals("")){
				conditionStr = " where cont_status!='100' order by serno desc,cont_no desc,asset_no desc,input_date desc";
			}else{
				conditionStr = conditionStr+ " and cont_status!='100' order by serno desc,cont_no desc,asset_no desc,input_date desc";
			}
