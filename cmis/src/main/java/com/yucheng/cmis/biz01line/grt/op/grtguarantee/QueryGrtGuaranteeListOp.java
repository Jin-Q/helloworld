...
public class QueryGrtGuaranteeListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
		    ...
		    //拼接where条件对担保人信息进行过滤
			String conditionStr = "where guar_id in (select guaranty_id from grt_guaranty_re where guar_cont_no ='"+ guarContNo+"')";
