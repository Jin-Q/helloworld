...
public class CollPoolDpoDrfpoManaListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			/**查询已托收状态的汇票信息*/
			IndexedCollection iColl = dpoComponent.getPorderListByDrfpoNo(drfpo_no, "'02'");
		
			/**查询已在池状态的汇票信息*/
			IndexedCollection iCollIn = dpoComponent.getPorderListByDrfpoNo(drfpo_no,"'01','05'");
