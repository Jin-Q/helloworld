...
public class QueryGrtGuarContListByAgrNoOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(agr_no==null||"".equals(agr_no))
				throw new EMPException("协议编号agr_no值为空！");
			...
			int size = 15;
			conditionStr += " AND AGR_NO='"+agr_no+"' AND GUAR_CONT_TYPE='01'";
		    //conditionStr +="order by guar_cont_no desc";
