...
public class QueryIndGroupIndGroupIndexDetailOp  extends CMISOperation {
	
	 private static final Logger logger = Logger.getLogger(QueryIndGroupIndGroupIndexDetailOp.class);
