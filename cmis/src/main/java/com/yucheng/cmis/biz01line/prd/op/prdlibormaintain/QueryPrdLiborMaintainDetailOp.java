...
public class QueryPrdLiborMaintainDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			//翻译信息
			SInfoUtils.addSOrgName(kColl, new String[] { "organno" });
			SInfoUtils.addUSerName(kColl, new String[] { "maintain_id" });
			SInfoUtils.addUSerName(kColl, new String[] { "check_id" });
