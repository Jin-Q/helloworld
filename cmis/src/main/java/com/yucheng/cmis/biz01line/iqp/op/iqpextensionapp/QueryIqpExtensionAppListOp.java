...
public class QueryIqpExtensionAppListOp extends CMISOperation {


	private final String modelId = "IqpExtensionApp";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String[] args=new String[] { "cus_id","cont_no","bill_no","prd_id"};
