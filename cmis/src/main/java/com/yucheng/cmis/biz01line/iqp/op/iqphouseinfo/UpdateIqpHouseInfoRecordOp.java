package com.yucheng.cmis.biz01line.iqp.op.iqphouseinfo;
...
public class UpdateIqpHouseInfoRecordOp extends CMISOperation {
	

	private final String modelId = "IqpHouseInfo";
