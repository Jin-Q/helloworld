...
public class QueryIqpRpddscntHistoryListOp extends CMISOperation {
...
//			}else{
//				conditionStr = conditionStr+" and approve_status!='000' order by serno desc";
//			}
			...
			list.add("toorg_name");
			list.add("bill_type");
			list.add("rpddscnt_rate");
			list.add("bill_total_amt");
			list.add("rpddscnt_date");
			list.add("input_id");
