...
public class QueryAccDrftListOp extends CMISOperation {


	private final String modelId = "AccDrft";
	private final String modelId1 = "IqpBillDetail";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
		    ...
		    conditionStr = conditionStr+"order by dscnt_date desc,porder_no desc";
			int size = 15;
			...
			for(Object obj:iColl){
				...
				KeyedCollection kColl4d = dao.queryDetail(modelId1, (String)kColl.getDataValue("porder_no"), connection);
