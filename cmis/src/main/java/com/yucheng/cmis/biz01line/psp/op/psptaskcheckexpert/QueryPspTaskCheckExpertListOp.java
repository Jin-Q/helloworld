...
public class QueryPspTaskCheckExpertListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			SInfoUtils.addSOrgName(iColl, new String[] { "belg_branch" });
			SInfoUtils.addUSerName(iColl, new String[] { "belg_manager_id" });
