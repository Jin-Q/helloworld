...
public class DeleteArpLawLawsuitAppRecordOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			//同时删除诉讼名单和诉讼明细
			cmisComponent.deleteByField("ArpLawMemberInfo",refFields);
			cmisComponent.deleteByField("ArpLawLawsuitDetail",refFields);
