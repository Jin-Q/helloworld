...
public class QueryIsConfPvpOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			String condition = " where cont_no = '"+cont_no+"' and approve_status!='998' and cont_no not in(select a.cont_no from pvp_authorize a where a.cont_no='"+cont_no+"' and a.status='03')";
