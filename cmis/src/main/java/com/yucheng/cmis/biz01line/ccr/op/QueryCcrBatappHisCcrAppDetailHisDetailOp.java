...
public class QueryCcrBatappHisCcrAppDetailHisDetailOp  extends CMISOperation {

	private final String modelId = "CcrBatappHis";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			IndexedCollection iColl_CcrAppDetail = dao.queryList("CcrAppDetail",condition, connection);
			this.putDataElement2Context(iColl_CcrAppDetail, context);
			...
			CcrAppAll ccrAppAll = ccrComponent.loadScoreHis(serno_value, cusId,model_no);
