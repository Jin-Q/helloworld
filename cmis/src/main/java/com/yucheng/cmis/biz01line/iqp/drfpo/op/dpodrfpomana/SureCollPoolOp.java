...
public class SureCollPoolOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			try{
				...
				context.addDataField("flag", "票据池托收授权发送失败!");
				throw new EMPException("票据池托收授权发送失败!");
			}
