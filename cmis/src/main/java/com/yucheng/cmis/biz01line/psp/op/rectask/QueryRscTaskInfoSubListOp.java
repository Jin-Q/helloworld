...
public class QueryRscTaskInfoSubListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			for(int i=0;i<iColl.size();i++){
				KeyedCollection r = (KeyedCollection)iColl.get(i);
				
				KeyedCollection duty = dao.queryDetail("SDuty", (String)r.getDataValue("identy_duty"),connection);
				if(duty!=null){
