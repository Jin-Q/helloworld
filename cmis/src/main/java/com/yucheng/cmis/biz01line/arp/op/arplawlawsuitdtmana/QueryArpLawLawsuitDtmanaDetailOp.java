...
public class QueryArpLawLawsuitDtmanaDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			cmisOp.delKcollCurType(kColl, "cur_type", "rec_int_accum", context);	//应收
			cmisOp.delKcollCurType(kColl, "cur_type", "recv_int_accum", context);	//实收
			/*** 外币翻译end ***/
