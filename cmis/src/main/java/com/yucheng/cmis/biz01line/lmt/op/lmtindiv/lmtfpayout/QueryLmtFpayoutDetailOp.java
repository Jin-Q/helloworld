...
public class QueryLmtFpayoutDetailOp  extends CMISOperation {
	
	private final String modelId = "LmtFpayout";
	private final String modelIdTemp = "CusBase";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			KeyedCollection kc = dao.queryDetail(modelIdTemp, incomeMap, connection);
			String cert_type = kc.getDataValue("cert_type").toString();
			String cert_code = kc.getDataValue("cert_code").toString();
