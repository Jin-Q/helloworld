...
public class QueryIqpOverseeAgrListMainOp extends CMISOperation {
...
//					conditionStr = "where net_agr_no='"+net_agr_no+"' and mortgagor_id='"+mem_cus_id+"'";
//				}else{
...
//				conditionStr = "where net_agr_no='"+net_agr_no+"' "; 
//			}
			conditionStr = TableModelUtil.getQueryCondition_bak(modelId, queryData, context, false, false, false);
