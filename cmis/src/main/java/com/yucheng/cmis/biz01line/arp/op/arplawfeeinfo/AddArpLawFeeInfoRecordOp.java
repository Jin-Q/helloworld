package com.yucheng.cmis.biz01line.arp.op.arplawfeeinfo;
...
public class AddArpLawFeeInfoRecordOp extends CMISOperation {
	
	//operation TableModel
	private final String modelId = "ArpLawFeeInfo";
