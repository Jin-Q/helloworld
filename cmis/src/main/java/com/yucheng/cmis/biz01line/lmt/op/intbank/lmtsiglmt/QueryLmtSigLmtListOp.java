...
public class QueryLmtSigLmtListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		//展示申请为单笔授信和申请状态为待发起、打回、退回的记录
			...
			for(int i=0;i<iColl.size();i++)
			{
				...
				String cus_id_displayname = (String)kColl_cus.getDataValue("same_org_cnname");
