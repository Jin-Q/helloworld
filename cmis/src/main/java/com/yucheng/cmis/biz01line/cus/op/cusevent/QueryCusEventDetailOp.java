...
public class QueryCusEventDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			kColl.setDataValue("logout_id", context.getDataValue("currentUserId"));
			kColl.setDataValue("logout_br_id", context.getDataValue("organNo"));
			SInfoUtils.addSOrgName(kColl, new String[] { "logout_br_id" });
			SInfoUtils.addUSerName(kColl, new String[] { "logout_id" });
