...
public class AddArpDbtBizRelRecordOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String[] modelIds=new String[]{"ArpDbtCongnizApp"};
	...
	public void setDbtCongniz(KeyedCollection kColl , Connection connection,Context context) throws EMPException {
		...
		cmisComponent.delExecuteSql("updateDbtCongniz", trans_kcoll);
	}
}
