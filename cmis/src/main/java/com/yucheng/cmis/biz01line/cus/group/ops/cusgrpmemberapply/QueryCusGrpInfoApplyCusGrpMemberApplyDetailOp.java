...
public class QueryCusGrpInfoApplyCusGrpMemberApplyDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			CusBase cusBase = cbc.getCusBase(cus_id_value);
			kColl.addDataField("cus_name", cusBase.getCusName());
			kColl.addDataField("cus_type", cusBase.getCusType());
			kColl.addDataField("manager_id", cusBase.getCustMgr());
			kColl.addDataField("manager_br_id", cusBase.getMainBrId());
