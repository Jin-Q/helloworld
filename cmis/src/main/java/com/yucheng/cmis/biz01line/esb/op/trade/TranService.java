 ...
 * @author Pansq
 */
public abstract class TranService implements TradeInterface {
	/**
	 * 业务逻辑处理入口
	 * @param CD 请求报文结构体
	 ...
	 * </KColl>
	 */
	public abstract KeyedCollection doExecute(CompositeData CD, Connection connection) throws Exception;
