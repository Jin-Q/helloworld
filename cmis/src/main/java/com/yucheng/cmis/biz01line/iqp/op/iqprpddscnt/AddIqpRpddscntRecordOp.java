...
public class AddIqpRpddscntRecordOp extends CMISOperation {
...
//			recordRestrict.judgeUpdateRestrict(this.modelId, context, connection);
			...
			//将业务的业务编号更新到批次的业务编号，建立关联关系。
			KeyedCollection batchKcoll = dao.queryAllDetail(batchModel, batch_no, connection);
			batchKcoll.setDataValue("serno", serno);
			batchKcoll.setDataValue("status", "02");//已引用
			...
			String bill_type = (String) batchKcoll.getDataValue("bill_type");//票据类型
