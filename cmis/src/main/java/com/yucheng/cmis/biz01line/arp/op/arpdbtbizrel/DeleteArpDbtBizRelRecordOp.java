package com.yucheng.cmis.biz01line.arp.op.arpdbtbizrel;
...
public class DeleteArpDbtBizRelRecordOp extends CMISOperation {

	private final String modelId = "ArpDbtBizRel";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			AddArpDbtBizRelRecordOp cmisOp = new  AddArpDbtBizRelRecordOp();
			cmisOp.setDbtCongniz(kColl, connection, context);
