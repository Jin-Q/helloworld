...
/**
 * @author lisj
 * @time 2014年11月24日11:57:58
 * @description 需求编号：【XD141107075】
 * 				对公客户管理一键查询功能Op
 * @version v1.0
 */
public class QueryCusComByOneKeyOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(cus_id_value == null || cus_id_value.length() == 0)
				throw new EMPJDBCException("主键["+cus_id_name+"]的值不能为null！");
			...
			kCollCom.put("ceo_name", ceoName);//法人代表
			//资本构成
			...
			/**modified by lisj 2015-3-3 修复授信额度信息已用金额取数问题，于2015-3-5上线 begin**/
			//授信额度信息（授信额度台账信息）
			...
			for(Iterator<KeyedCollection> iterator = iCollSelect4LmtAgrInfoList.iterator();iterator.hasNext();){
				...
				temp.addDataField("used_amt",  kCollTemp.getDataValue("lmt_amt").toString());
			}
			iCollSelect4LmtAgrInfoList.setName("LmtAgrInfoList");
			/**modified by lisj 2015-3-3 修复授信额度信息已用金额取数问题，于2015-3-5上线 end**/
			//台账信息
			...
			cusRelTree.setNodeId(cus_id_value);
