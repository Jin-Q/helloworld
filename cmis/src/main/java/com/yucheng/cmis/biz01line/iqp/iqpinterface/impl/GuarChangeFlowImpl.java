...
public class GuarChangeFlowImpl extends CMISComponent implements
		BIZProcessInterface {

	private static final String IQPMAINMODELID = "IqpGuarChangeApp";//业务申请主表模型
		...
		try {
			...
			if(status.equals("997")){//流程审批通过 
				...
				IqpCreditChangeFlowComponent iqpCreditChangeFlowComponent = (IqpCreditChangeFlowComponent)CMISComponentFactory.getComponentFactoryInstance()
					...
					iqpCreditChangeFlowComponent.doWfAgreeForGuarChange(serno); 
