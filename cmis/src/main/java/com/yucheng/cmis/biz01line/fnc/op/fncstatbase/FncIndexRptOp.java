...
/**
 *@Classname FncIndexRptOp.java
 *@Version 1.0
 *@Since 1.0 2008-10-14 上午09:43:51
 *@Copyright 2008 yucheng Co. Ltd.
 *@Author biwq
 *@Description：企业财务报表-财务指标表 
 *                           操作OP类,可获得财报的对象FncStatBase以及标签样式对象(带数据的)的对象FncConfStyles
 *                           ,并且把两个对象放入context中
 *@Lastmodified
 *@Author
 */

public class FncIndexRptOp extends CMISOperation {
    ...
    public String doExecute(Context context) throws EMPException {
        ...
        try {
            ...
            String styleId = pfncStatBase.getStatFiStyleId();
            /**
