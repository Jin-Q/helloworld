...
public class DeleteLmtAppJointCoop_jointRecordOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			lmtComponent.deleteByField(modelIdNameList, map);
			//删除该联保小组保证金信息
			map.clear();
			map.put("serno", serno_value);
			lmtComponent.deleteByField(modelIdBailInfo, map);
