 ...
 * @author ZYF
 */
public class CheckCusIdAdd4payoutOp extends CMISOperation{
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			KeyedCollection kc = dao.queryFirst("LmtFpayout", null, "where cus_id='"+cus_id+"' and serno ='"+serno+"'", connection);
