...
/**
 *@Classname UpdateFncStatCommon.java
 *@Version 1.0
 *@Since 1.0 Oct 15, 2008 11:03:09 AM
 ...
 *@Author
 */
public class UpdateFncStatCommonOp extends CMISOperation {
    ...
    public String doExecute(Context context) throws EMPException {
        ...
        try {
            ...
            // 更新一张报表数据
            flagInfo = fsCommonComponent.updateFncStat(pfncConfStyles,
                    pfncStatBase, true);
