...
public class QueryCtrLimitContListPopOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr.toLowerCase().indexOf("where") != -1){
				conditionStr += " and cus_id='"+cus_id+"' and cont_status='200' ";
			}else {
				conditionStr += " where cus_id='"+cus_id+"' and cont_status='200' ";
			}
