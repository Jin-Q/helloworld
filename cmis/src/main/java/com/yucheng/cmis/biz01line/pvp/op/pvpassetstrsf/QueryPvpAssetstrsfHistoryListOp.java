...
public class QueryPvpAssetstrsfHistoryListOp extends CMISOperation {
...
//			if(queryData!=null){
//				conditionStr = " where approve_status in('111','997') and prd_id ='600020' order by serno desc";
//			}else{
//				conditionStr = conditionStr +" and approve_status in('111','997') and prd_id ='600020' order by serno desc";
//			}
