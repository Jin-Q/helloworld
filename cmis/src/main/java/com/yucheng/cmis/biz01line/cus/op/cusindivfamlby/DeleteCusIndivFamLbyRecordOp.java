...
public class DeleteCusIndivFamLbyRecordOp extends CMISOperation {

	private final String modelId = "CusIndivFamLby";
	
	private final String cus_id_name = "cus_id";
	private final String indiv_debt_id_name = "indiv_debt_id";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String indiv_debt_id_value = null;
			try {
				indiv_debt_id_value = (String)context.getDataValue(indiv_debt_id_name);
			} catch (Exception e) {}
			if(indiv_debt_id_value == null || indiv_debt_id_value.length() == 0)
				throw new EMPJDBCException("The value of pk["+indiv_debt_id_name+"] cannot be null!");
				
			TableModelDAO dao = this.getTableModelDAO(context);
			Map<String,String> pkMap = new HashMap<String,String>();
			pkMap.put("cus_id",cus_id_value);
			pkMap.put("indiv_debt_id",indiv_debt_id_value);
