...
public class QueryLmtAppFrozeUnfrozeDetailListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr!=null&&!"".equals(conditionStr)){
				conditionStr = conditionStr+ " and 1=1 ";
			}else{
				conditionStr = " where 1=1 ";
			}
			String limit_code = "";
			if(context.containsKey("limit_code")&&context.getDataValue("limit_code")!=null){
				limit_code = (String) context.getDataValue("limit_code");
			}
			conditionStr = conditionStr + "and limit_code = '"+limit_code+"' ";
