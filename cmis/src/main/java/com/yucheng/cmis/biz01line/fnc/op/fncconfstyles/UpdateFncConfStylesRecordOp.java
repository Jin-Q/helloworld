...
public class UpdateFncConfStylesRecordOp extends CMISOperation {
        ...
        try {
            ...
            FncConfStylesComponent thisComponent = (FncConfStylesComponent) CMISComponentFactory
                    .getComponentFactoryInstance().getComponentInstance(
                            PUBConstant.FNCCONFSTYLES, context, connection);
            ...
            try {
                kColl = (KeyedCollection) context
                        .getDataElement(PUBConstant.FNCCONFSTYLES);
            } catch (Exception e) {
            }
            if (kColl == null || kColl.size() == 0)
                throw new CMISException(CMISMessage.MESSAGEDEFAULT,
                        "The values to update[" + PUBConstant.FNCCONFSTYLES
                                + "] cannot be empty!");
            ...
            // �޸���Ϣ
            flagInfo = thisComponent.modifyFncConfStyles(domain);
