 ...
 *
 */
public class TradeYcczsq extends TranClient {
...
//				/** 核算与信贷业务品种映射 END */
				...
				bodyArrCD.addField("OD_INT_RATE", TagUtil.getEMPField(TagUtil.replaceNull4Double(reflectKColl.getDataValue("OD_INT_RATE")), FieldType.FIELD_DOUBLE, 20, 7));
				bodyArrCD.addField("ACCP_ISSUE_DT", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("ACCP_ISSUE_DT")), FieldType.FIELD_STRING, 8, 0));
				bodyArrCD.addField("ACCP_DUE_DT", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("ACCP_DUE_DT")), FieldType.FIELD_STRING, 8, 0));
				bodyArrCD.addField("OPAC_TYPE", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("OPAC_TYPE")), FieldType.FIELD_STRING, 1, 0));
				bodyArrCD.addField("OPAC_ORG", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("OPAC_ORG")), FieldType.FIELD_STRING, 12, 0));
				bodyArrCD.addField("OPAC_ORG_NAME", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("OPAC_ORG_NAME")), FieldType.FIELD_STRING, 60, 0));
				bodyArrCD.addField("PAORG_PERSON", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("PAORG_PERSON")), FieldType.FIELD_STRING, 40, 0));
				bodyArrCD.addField("PAORG_ACCT_NO", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("PAORG_ACCT_NO")), FieldType.FIELD_STRING, 40, 0));
				bodyArrCD.addField("PAORG_NO", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("PAORG_NO")), FieldType.FIELD_STRING, 12, 0));
				bodyArrCD.addField("PAORG_NAME", TagUtil.getEMPField(TagUtil.replaceNull4String(reflectKColl.getDataValue("PAORG_NAME")), FieldType.FIELD_STRING, 60, 0));
			...
			/** 保证金信息 */
			IndexedCollection bzIColl = dao.queryList(PVPSUBMODEL, " where auth_no ='"+authorize_no+"' and busi_cls ='"+TradeConstance.BUSI_TYPE_BZ+"' ", connection);
...
//					feeCD.addField("OWN_BRANCH_FLAG", TagUtil.getEMPField(reflectSubKColl.getDataValue("IS_THIS_ORG_ACCT"), FieldType.FIELD_STRING, 1, 0));
			...
			APP_HEAD.addField("FILE_NAME",TagUtil.getEMPField(FTPUtil.getFileName(serviceCode, TradeConstance.SERVICE_SCENE_YCFFSQ, authorize_no), FieldType.FIELD_STRING, 100, 0));
			...
			FTPUtil.send2FTP(serviceCode, TradeConstance.SERVICE_SCENE_YCFFSQ, authorize_no, fileCD);
			}
		}catch (Exception e) {
