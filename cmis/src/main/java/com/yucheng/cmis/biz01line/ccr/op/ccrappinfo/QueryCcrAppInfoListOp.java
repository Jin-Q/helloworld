...
public class QueryCcrAppInfoListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr==null||"".equals(conditionStr.trim())){
				conditionStr += " where flag = '1' "+temp+" order by serno desc";
				
			}else{
				conditionStr += " and flag = '1' "+temp+" order by serno desc";
			}
