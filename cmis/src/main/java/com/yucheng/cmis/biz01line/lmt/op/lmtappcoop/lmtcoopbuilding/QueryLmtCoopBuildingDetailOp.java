...
public class QueryLmtCoopBuildingDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(null == kColl || null == kColl.getDataValue("pro_no") ||"".equals(kColl.getDataValue("pro_no"))){
				...
				context.addDataField("action", "addLmtCoopBuildingRecord.do");
			}else{
				context.addDataField("action", "updateLmtCoopBuildingRecord.do");
				
				Map<String, String> map = new HashMap<String, String>();
				map.put("geogra_place", "STD_GB_AREA_ALL");
