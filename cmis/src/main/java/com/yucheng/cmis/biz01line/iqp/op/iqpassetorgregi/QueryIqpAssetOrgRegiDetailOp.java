...
public class QueryIqpAssetOrgRegiDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String[] args=new String[] {"asset_org_id" };
			String[] modelIds=new String[]{"IqpAssetOrg"};
			String[]modelForeign=new String[]{"asset_org_id"};
			String[] fieldName=new String[]{"asset_org_name"};
		    //详细信息翻译时调用			
