...
public class GetCusHoldFundRecordOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
		    ...
		    String serno = CMISSequenceService4JXXD.querySequenceFromDB("HOLDFUND", "fromDate", 
	        		connection, context);
			
		    String cusid = (String)context.getDataValue("CusHoldFund.cus_id");
