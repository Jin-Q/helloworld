...
public class QueryCusGrpInfoApplyModLsListOp extends CMISOperation{
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr==null||"".equals(conditionStr.trim())){
				conditionStr += " where is_change='1' and APPROVE_STATUS in('997','998','990','111') order by serno desc";
			}else{
				conditionStr += " and is_change='1' and APPROVE_STATUS in('997','998','990','111') order by serno desc";
			}
