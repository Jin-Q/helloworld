...
public class DeleteIndGroupRecordOp extends CMISOperation {
	
	 private static final Logger logger = Logger.getLogger(DeleteIndGroupRecordOp.class);
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			int count=dao.deleteByPk(modelId, group_no_value, connection);
			if(count!=1){
