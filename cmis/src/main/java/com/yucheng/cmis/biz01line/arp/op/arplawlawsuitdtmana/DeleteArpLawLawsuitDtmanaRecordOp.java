...
public class DeleteArpLawLawsuitDtmanaRecordOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			KeyedCollection kColl = dao.queryDetail("ArpLawLawsuitDtmana", pk_serno_value, connection);
