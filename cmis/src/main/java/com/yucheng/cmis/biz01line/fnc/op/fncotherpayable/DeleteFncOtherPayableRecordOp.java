package com.yucheng.cmis.biz01line.fnc.op.fncotherpayable;
...
public class DeleteFncOtherPayableRecordOp extends CMISOperation {

	private final String modelId = "FncOtherPayable";
