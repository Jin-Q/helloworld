...
public class DeleteCusGoverFinTerRecordOp extends CMISOperation {

	private final String modelId = "CusGoverFinTer";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
            ...
            refFields.put("cus_id", (String) context.getDataValue("cus_id"));
            ...
            cusComponent.deleteByField("CusGoverFinTerBill", refFields);
