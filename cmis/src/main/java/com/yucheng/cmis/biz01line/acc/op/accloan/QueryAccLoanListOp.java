...
public class QueryAccLoanListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		/*	if(context.containsKey("biz_type")){
			...
			if("".equals(conditionStr)){
				conditionStr +=" where cont_no in (select b.cont_no from ctr_loan_cont b where b.biz_type='"+biz_type+"') order by bill_no desc";
			}else{
				conditionStr +=" and cont_no in (select b.cont_no from ctr_loan_cont b where b.biz_type='"+biz_type+"') order by bill_no desc";
			}
		*/	
			...
			String[] args=new String[] { "cus_id","cus_id","cont_no","prd_id"};
			...
			String[] resultName = new String[] { "cus_id_displayname","belg_line","fount_serno","prd_id_displayname"};
