...
public class QueryCusJsonByCertOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			cusBase=cusBaseComponent.getCusBaseByCert(cert_code_value,cert_type_value);
			kColl=componetHelper.domain2kcol(cusBase, modelId);
