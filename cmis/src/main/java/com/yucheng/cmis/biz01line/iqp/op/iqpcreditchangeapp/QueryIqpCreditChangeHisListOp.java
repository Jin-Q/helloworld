...
public class QueryIqpCreditChangeHisListOp extends CMISOperation {
...
//				conditionStr += " and approve_status in('997','111') order by serno desc";
//			}else{
//				conditionStr = "where approve_status in('997','111') order by serno desc"; 
//			}  
