package com.yucheng.cmis.biz01line.psp.op.pspbankcontacc;
...
*
 */
public class QueryPspBankContaccDetailForAddOp  extends CMISOperation {
	
	//private final String modelId = "PspBankContaccDetail";
