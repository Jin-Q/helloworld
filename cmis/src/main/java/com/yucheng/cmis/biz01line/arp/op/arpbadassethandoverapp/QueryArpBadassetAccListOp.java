...
public class QueryArpBadassetAccListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			iColl = service.getAccByCondition(conditionStr, context,pageInfo, connection, "1");
			...
			String[] condition=new String[]{"",""," order by input_br_id ,serno desc "};
		    //详细信息翻译时调用
			SystemTransUtils.dealPointNameByCondition(iColl, args,
					SystemTransUtils.ADD, context, modelIds, modelForeign,fieldName, resultName,condition);
