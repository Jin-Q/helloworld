package com.yucheng.cmis.biz01line.arp.op.arplawexecuterecover;
...
public class AddArpLawExecuteRecoverRecordOp extends CMISOperation {
	
	//operation TableModel
	private final String modelId = "ArpLawExecuteRecover";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String[] args=new String[] { "case_no" };
			String[] modelIds=new String[]{"ArpLawLawsuitInfo"};
			String[] modelForeign=new String[]{"case_no"};
