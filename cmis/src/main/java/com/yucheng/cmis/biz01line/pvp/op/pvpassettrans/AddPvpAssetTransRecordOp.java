...
public class AddPvpAssetTransRecordOp extends CMISOperation {
...
//			recordRestrict.judgeUpdateRestrict(contModelId, context, connection);
            ...
            //在出账pvpKColl中放入相关信息
			String trans_amt=(String) contKColl.getDataValue("trans_amt");
			String toorg_no=(String) contKColl.getDataValue("toorg_no");
			pvpKColl.addDataField("cont_amt", trans_amt);
			pvpKColl.addDataField("pvp_amt", trans_amt);
			pvpKColl.addDataField("cont_balance", trans_amt);
