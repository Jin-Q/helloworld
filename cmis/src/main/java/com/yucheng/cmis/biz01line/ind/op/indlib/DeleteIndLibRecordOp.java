...
public class DeleteIndLibRecordOp extends CMISOperation {
	
	private static final Logger logger = Logger.getLogger(DeleteIndLibRecordOp.class);
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			int count=dao.deleteByPk(modelId, index_no_value, connection);
			if(count!=1){
