...
public class QueryLmtIndusListApplyListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr.indexOf("WHERE") != -1){				
				conditionStr = conditionStr + " and serno = '"+serno+"' "  + " order by cus_id desc";
			}else{
				conditionStr = "where 1=1 " + " and serno = '"+serno+"' "  + " order by cus_id desc";
			}
