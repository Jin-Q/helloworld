...
public class QueryLmtIndusListManaListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr.indexOf("WHERE") != -1){				
				conditionStr = conditionStr + " and agr_no = '"+agr_no+"' "  + " order by cus_id desc";
			}else{
				conditionStr = "where 1=1 " + " and agr_no = '"+agr_no+"' "  + " order by cus_id desc";
			}
