...
public class DeleteMortCargoReplRecordOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			mortCom.updateStatusBatch("05","02",guaranty_no,context);//将入库待记账状态的货物还原为新增待登记状态
			mortCom.updateStatusBatch("04","01",guaranty_no,context);//将出库待记账状态的货物还原为入库状态
			//设置更新操作时主键
			...
			map1.put("re_serno", serno_value);
			mortCom.deleteByField("MortDelivList",map1);
