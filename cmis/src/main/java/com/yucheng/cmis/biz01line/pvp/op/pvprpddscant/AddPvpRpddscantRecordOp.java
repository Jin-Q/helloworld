...
public class AddPvpRpddscantRecordOp extends CMISOperation {
...
//			recordRestrict.judgeUpdateRestrict(this.contModelId, context, connection);
...
//			pvpKColl.addDataField("bill_no", billNo);
            ...
            //在出账pvpKColl中放入相关信息
			String rpay_amt=(String) contKColl.getDataValue("rpay_amt");
			String toorg_no=(String) contKColl.getDataValue("toorg_no");
			String toorg_name=(String) contKColl.getDataValue("toorg_name");
			pvpKColl.addDataField("cont_amt", rpay_amt);
			pvpKColl.addDataField("pvp_amt", rpay_amt);
			pvpKColl.addDataField("cont_balance", rpay_amt);
			pvpKColl.addDataField("cus_id", toorg_no); 
			pvpKColl.addDataField("toorg_name", toorg_name); 
			pvpKColl.addDataField("cur_type", contKColl.getDataValue("bill_curr")); 
