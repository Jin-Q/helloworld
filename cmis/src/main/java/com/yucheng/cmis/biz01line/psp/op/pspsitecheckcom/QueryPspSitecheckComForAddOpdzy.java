...
//贷后管理系统改造（常规检查）    XD141222090     add by zhaoxp  2015-01-22 
public class QueryPspSitecheckComForAddOpdzy  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String condition = " where cus_id = '"+cus_id+"'"+" and task_id = '"+task_id+"'";
