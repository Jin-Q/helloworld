...
public class QueryPvpAssetstrsfListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr.equals("")){
				conditionStr = " where approve_status not in('997','111') and prd_id ='600020'  order by input_date desc,serno desc";
			}else{
				conditionStr = conditionStr+" and approve_status not in('997','111') and prd_id ='600020'  order by input_date desc,serno desc";
			}
			...
			modelIds=new String[]{"CtrAssetstrsfCont"};
