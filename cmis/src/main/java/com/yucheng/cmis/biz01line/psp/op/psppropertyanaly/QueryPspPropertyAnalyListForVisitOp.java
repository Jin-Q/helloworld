...
public class QueryPspPropertyAnalyListForVisitOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			//现场检查
			String conditionStr = " where task_id = '" + task_id + "' and visit_type in ('01','04')" + " order by task_id desc ";
