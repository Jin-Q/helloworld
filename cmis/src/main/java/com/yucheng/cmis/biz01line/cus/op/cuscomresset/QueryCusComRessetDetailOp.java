package com.yucheng.cmis.biz01line.cus.op.cuscomresset;
...
public class QueryCusComRessetDetailOp  extends CMISOperation {
	
	private final String modelId = "CusComResset";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			map.put("com_ass_addr", "STD_GB_AREA_ALL");
			//树形菜单服务
