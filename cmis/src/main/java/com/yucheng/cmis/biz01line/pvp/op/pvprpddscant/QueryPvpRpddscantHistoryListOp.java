...
public class QueryPvpRpddscantHistoryListOp extends CMISOperation {
...
//				conditionStr = " where approve_status in('111','997') and prd_id in ('300024','300023','300022') order by serno desc";
//			}else{
//				conditionStr = conditionStr + " and approve_status in('111','997') and prd_id in ('300024','300023','300022') order by serno desc";
//			}
