...
public class DeleteCusIndivInsurancesRecordOp extends CMISOperation {

	private final String modelId = "CusIndivInsu";
	
	private final String cus_id_name = "cus_id";
	private final String indiv_ins_id_name = "indiv_ins_id";
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String indiv_ins_id_value = null;
			try {
				indiv_ins_id_value = (String)context.getDataValue(indiv_ins_id_name);
			} catch (Exception e) {}
			if(indiv_ins_id_value == null || indiv_ins_id_value.length() == 0)
				throw new EMPJDBCException("The value of pk["+indiv_ins_id_name+"] cannot be null!");
				
			TableModelDAO dao = this.getTableModelDAO(context);
			Map<String,String> pkMap = new HashMap<String,String>();
			pkMap.put("cus_id",cus_id_value);
			pkMap.put("indiv_ins_id",indiv_ins_id_value);
