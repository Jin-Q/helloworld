 ...
 * @date 20130924
 */
public class GetLmtAgrIndivSelfPageOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			KeyedCollection kColl = dao.queryDetail("LmtAgrIndiv", agr_no, connection);
