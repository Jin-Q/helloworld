package com.yucheng.cmis.biz01line.arp.op.arplawexecuteinfo;
...
public class AddArpLawExecuteInfoRecordOp extends CMISOperation {
	
	//operation TableModel
	private final String modelId = "ArpLawExecuteInfo";
