package com.yucheng.cmis.biz01line.psp.op.psporderanaly;
...
*
 */
public class QueryPspOrderAnalyDetailForAddOp  extends CMISOperation {
	
	//private final String modelId = "PspOrderAnaly";
