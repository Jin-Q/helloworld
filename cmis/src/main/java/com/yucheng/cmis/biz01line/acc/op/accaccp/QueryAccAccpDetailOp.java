...
public class QueryAccAccpDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String[] args=new String[] {"cont_no"};
			String[] modelIds=new String[]{"CtrLoanCont"};
			String[] modelForeign=new String[]{"cont_no"};
			String[] fieldName=new String[]{"serno"};
