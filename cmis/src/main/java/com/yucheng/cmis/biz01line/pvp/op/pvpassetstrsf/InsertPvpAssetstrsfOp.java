...
public class InsertPvpAssetstrsfOp extends CMISOperation {

	private final String modelId = "AccLoan";                        //贷款台账表模型
	private final String modelIdPvp = "PvpLoanApp";                  //贷款出账表模型
	private final String modelIdCont = "CtrAssetstrsfCont";            //转贴现合同表模型
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String Assetstrsf_rate = (String)ContkColl.getDataValue("Assetstrsf_rate");//从合同中获取转贴现利息
            ...
            for(int i=0;i<iCollBillRel.size();i++){
            	...
            	pvpkColl.addDataField("dscnt_int",Assetstrsf_rate);//贴现利息
