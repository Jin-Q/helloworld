package com.yucheng.cmis.biz01line.fnc.op.fncinventory;
...
public class DeleteFncInventoryRecordOp extends CMISOperation {

	private final String modelId = "FncInventory";
