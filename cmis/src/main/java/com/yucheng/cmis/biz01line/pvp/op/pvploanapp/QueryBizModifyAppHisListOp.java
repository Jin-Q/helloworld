...
*
 */
public class QueryBizModifyAppHisListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{  
			...
			if("".equals(conditionStr)){
				conditionStr +=" where approve_status <>'000'";
			}else{
				conditionStr +=" and approve_status <> '000'";
			}
			IndexedCollection iColl = TableModelUtil.buildPageData(pageInfo, dataSource, conditionSelect+conditionStr);
			iColl.setName("BizModifyAppHisList");
