...
public class QueryFncConfItemsListByOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
		    ...
		    //获得查询的过滤数据
			String fncConfTyp = (String)context.getDataValue("fnc_conf_typ");
		
			KeyedCollection queryData = new KeyedCollection();
			queryData.setId(this.modelId);
			queryData.addDataField("fnc_conf_typ", fncConfTyp);
