...
public class QueryLmtQuotaManagerDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(menuId.equals("OrgLmtQuota")){
				SInfoUtils.addSOrgName(kColl, new String[] { "manager_br_id" ,"code_id"});
				SInfoUtils.addUSerName(kColl, new String[] { "manager_id" });
			}else{
				SInfoUtils.addSOrgName(kColl, new String[] { "manager_br_id" });
				SInfoUtils.addUSerName(kColl, new String[] { "manager_id","code_id" });
			}
