package com.yucheng.cmis.biz01line.psp.op.pspwagecontacc;
...
*
 */
public class QueryPspWageContaccDetailForAddOp  extends CMISOperation {
	
	//private final String modelId = "PspWageContacc";
