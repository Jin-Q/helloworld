...
public class QueryMortStorExwaInfoListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr==null||"".equals(conditionStr)){
				conditionStr = "where stor_exwa_mode != '04'";
			}else{
				conditionStr += "and stor_exwa_mode != '04'";
			}
