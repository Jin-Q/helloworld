...
public class QueryIqpOverseeUnderstorePopForChkListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			if(conditionStr==null||"".equals(conditionStr.trim())){
				conditionStr = "where oversee_org_id='"+oversee_org_id+"'"+" order by store_id desc";
			}else{
				conditionStr +="and oversee_org_id='"+oversee_org_id+"'"+" order by store_id desc";
			}
