...
public class QueryArpLawDefendantInfoListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			KeyedCollection kColl = dao.queryDetail("ArpLawLawsuitApp", serno, connection);
			this.putDataElement2Context(kColl, context);
			
			/*** 2.取所有被告客户，翻译其条线 ***/					
			String conditionStr = " where member_type = '001' and  serno = '"+serno+"' ";
			...
			for(i=0;i<iColl.size();i++){
				...
				String belg_line = list_kColl.getDataValue("belg_line") + "";

				if(belg_line.equals("BL300")){	//处理成个人列表
