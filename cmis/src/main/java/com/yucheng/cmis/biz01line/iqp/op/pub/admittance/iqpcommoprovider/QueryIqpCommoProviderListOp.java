...
public class QueryIqpCommoProviderListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			String catalog_no = context.getDataValue("catalog_no").toString();
			if (conditionStr == null || conditionStr.trim().equals("")){
				conditionStr = "where 1=1 order by mort_catalog_no desc";
			}else{
				conditionStr += "and mort_catalog_no='"+catalog_no+"'"+"order by mort_catalog_no desc";
			}
