package com.yucheng.cmis.biz01line.fnc.op.fncaccpayable;
...
public class DeleteFncAccPayableRecordOp extends CMISOperation {

	private final String modelId = "FncAccPayable";
