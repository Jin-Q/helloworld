package com.yucheng.cmis.biz01line.iqp.op.btproinfo;
...
public class UpdateBtProInfoRecordOp extends CMISOperation {
	

	private final String modelId = "IqpBtProInfo";
