...
public class SRowright  implements com.yucheng.cmis.pub.CMISDomain{
	...
	/**
	 * @return the actorright
	 */
	public String getActorright() {
		return actorright;
	}
	/**
	 * @param actorright the actorright to set
	 */
	public void setActorright(String actorright) {
		this.actorright = actorright;
	}
	/**
 	 * @return ���� memo
 	 */
