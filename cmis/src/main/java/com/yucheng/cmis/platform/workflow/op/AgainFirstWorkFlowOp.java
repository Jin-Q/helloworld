 ...
 *
 */
public class AgainFirstWorkFlowOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			WFIVO wfiVo = wfi.wfTakeBackFirst(instanceId, nodeId, currentUserId, paramMap, connection);
			...
			EMPLog.log("AgainWorkFlowOp", EMPLog.ERROR, EMPLog.ERROR, "发起人追回流程出错！异常信息："+e.getMessage(), e);
