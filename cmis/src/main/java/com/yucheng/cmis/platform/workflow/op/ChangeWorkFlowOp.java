 ...
 *
 */
public class ChangeWorkFlowOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
        ...
        try {
            ...
            WFIVO wfiVO = wfi.wfChange(instanceId, nodeId, userId, nextNodeUser, paramMap, connection);
            context.put(WorkFlowConstance.WFVO_RET_NAME, wfiVO);
            
        } catch (Exception e) {
			EMPLog.log("ChangeWorkFlowOp", EMPLog.ERROR, EMPLog.ERROR, "流程转办出错；实例号：【"+instanceId+"】，当前用户【"+userId+"】。异常信息："+e.getMessage());
