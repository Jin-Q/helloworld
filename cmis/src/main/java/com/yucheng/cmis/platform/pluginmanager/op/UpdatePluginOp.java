 ...
 *
 */
public class UpdatePluginOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			//安装插件
			PluginRegVO vo = plugLoad.updatePlugin(connection);
			
			context.addDataField("flag", "success");
			context.addDataField("message", "插件"+vo.getPluginModualName()+"更新成功");
