 ...
 *
 */
public class GetEndGatherListOp extends CMISOperation {

	private final static String modelId = "WfGatherRecordend";
	@Override
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			String condition2 = "( CURRENTGATHERPROCESSORS LIKE '%"+currentUserId+";%' OR GATHERENDUSERID='"+currentUserId+"' OR GATHERSTARTUSERID='"+currentUserId+"' )";
			...
			EMPLog.log("GetEndGatherListOp", EMPLog.ERROR, EMPLog.ERROR, "获取会办办结事项出错！异常信息："+e.getMessage(), e);
