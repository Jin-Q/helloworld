 ...
 *
 */
public class WakeWorkFlowOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			WFIVO wfiVo = wfi.wfWake(instanceId, currentUserId, paramMap, connection);
			...
			EMPLog.log("WakeWorkFlowOp", EMPLog.ERROR, EMPLog.ERROR, "唤醒实例出错！异常信息："+e.getMessage(), e);
