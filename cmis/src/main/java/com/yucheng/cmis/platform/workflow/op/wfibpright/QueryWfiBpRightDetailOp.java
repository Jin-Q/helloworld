...
public class QueryWfiBpRightDetailOp  extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try{
			...
			SInfoUtils.addSOrgName(kColl, new String[] { "approve_org" });
			SInfoUtils.addUSerName(kColl, new String[] { "approver" });
			SInfoUtils.addDutyName(kColl, new String[] { "approve_duty" });
