 ...
 *
 */
public class GetDoneGatherListOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			String condition2 = "(GATHERSTARTUSERID='"+currentUserId+"' OR CURRENTGATHERPROCESSORS LIKE '%"+currentUserId+";%' )";
			...
			EMPLog.log("GetDoneGatherListOp", EMPLog.ERROR, EMPLog.ERROR, "获取会办已办事项出错！异常信息："+e.getMessage(), e);
