 ...
 *
 */
public class JumpWorkFlowOp extends CMISOperation {
	...
	public String doExecute(Context context) throws EMPException {
		...
		try {
			...
			WFIVO wfiVo = wfi.wfJump(instanceId, nodeId, currentUserId, nextNodeId, nextNodeUser, paramMap, connection);
			context.put(WorkFlowConstance.WFVO_RET_NAME, wfiVo);
			
		} catch (Exception e) {
			EMPLog.log("JumpWorkFlowOp", EMPLog.ERROR, EMPLog.ERROR, "流程跳转出错！异常信息："+e.getMessage(), e);
