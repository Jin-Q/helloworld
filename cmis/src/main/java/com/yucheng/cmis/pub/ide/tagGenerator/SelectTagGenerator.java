...
public class SelectTagGenerator implements JspTagGenerator{
	
	private String tagName = "emp:select";

	public SelectTagGenerator() {
	...
	public String generateTag(FieldWrapper fieldWra) {
		...
		try {
			...
			tagbuf.append(Decide.decideNull("defvalue", (String)fieldWra.extAttrMap.get("defvalue")));
