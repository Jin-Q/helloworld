 ...
 */
public class NewStringUtils extends StringUtils{
    ...
    public static int indexOfAny(String str, char[] searchChars) {
        if (isEmpty(str) || NewArrayUtils.isEmpty(searchChars)) {
            return -1;
        }
     ...
     *
     * <p>If <code>start</code> is not strictly to the 
      of <code>end</code>, ""
     * is returned.</p>
     *
     * <pre>
    ...
    public static String chomp(String str) {
        ...
        if (str.length() == 1) {
            ...
            if (ch == NewCharUtils.CR || ch == NewCharUtils.LF) {
                return EMPTY;
            }
            return str;
        }
        ...
        if (last == NewCharUtils.LF) {
            if (str.charAt(lastIdx - 1) == NewCharUtils.CR) {
                lastIdx--;
            }
        } else if (last != NewCharUtils.CR) {
            lastIdx++;
        }
    ...
    public static String chop(String str) {
        ...
        char last = str.charAt(lastIdx);
        if (last == NewCharUtils.LF) {
            if (ret.charAt(lastIdx - 1) == NewCharUtils.CR) {
