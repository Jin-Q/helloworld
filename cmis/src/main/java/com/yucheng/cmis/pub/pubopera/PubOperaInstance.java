...
public class PubOperaInstance extends CMISComponent implements PubOperaInterface {
	/**
	...
	public CMISDomain getCMISDomainByKeyword(CMISDomain domain,String keyword) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.getCMISDomainByKeyword(domain,keyword);
	}
	...
	public CMISDomain getCMISDomainByKeywords(CMISDomain domain,Map<String,String> keywords) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.getCMISDomainByKeywords(domain,keywords);
	}
	...
	public List<CMISDomain> getCMISDomainByCondition(Class<? extends CMISDomain> domainClass, String condition)throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.getCMISDomainByCondition(domainClass,condition);
	}
	...
	public String updateCMISDomain(CMISDomain domain) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.updateCMISDomain(domain);
	}
	...
	public String insertCMISDomain(CMISDomain domain) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.insertCMISDomain(domain);
	}
	...
	public int deleteDateByTableAndCondition(String tableName,String condition) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
	    return lipc.deleteDateByTableAndCondition(tableName,condition);
	}
	...
	public int deleteDateByTableAndConditionMap(String tableName,Map<String,String> conditionMap) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.deleteDateByTableAndConditionMap(tableName,conditionMap);
	}
	...
	public int updateDateByTableAndValueAndCondition(String tableName,HashMap<String,String> valueMap,
		...
		PubOperaComponent lipc = (PubOperaComponent) this
			.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.updateDateByTableAndValueAndCondition(tableName,valueMap,conditionMap);
	}
	...
	public IndexedCollection selectValuesByTableAndCondition(String tableName,String retValues,
			HashMap<String,String> conditionMap) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.selectValuesByTableAndCondition(tableName,retValues,conditionMap);
	}
	...
	public KeyedCollection selectValuesByTableAndKeyWords(String tableName,String retValues,
			HashMap<String,String> conditionMap) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.selectValuesByTableAndKeyWords(tableName, retValues, conditionMap);
	}
	...
	public IndexedCollection selectValuesByCondition(String tableName, String colName,
		...
		PubOperaComponent lipc = (PubOperaComponent) this.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.selectValuesByCondition(tableName,colName,condition,connection);
	}
	...
	public String selectSingleValueByCondition(String tableName,String retValues,String condition) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.selectSingleValueByCondition(tableName,retValues,condition);
	}
	...
	public IndexedCollection queryByPageInfo(Connection connection,String conditionStr,PageInfo pageInfo) throws EMPException{
		PubOperaComponent lipc = (PubOperaComponent) this.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.queryByPageInfo(connection,conditionStr,pageInfo);
	}
	...
	public boolean insertValuesByTableAndFieldMap(String tableName,
		...
		PubOperaComponent lipc = (PubOperaComponent) this.getOtherComponentInstance(PUBConstant.PUBOPERA);
		return lipc.insertValuesByTableAndFieldMap(tableName,valueMap);
	}
